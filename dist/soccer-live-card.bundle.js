      ...
      <ha-card class="${o?"live":""}">
        ...
        ${u.length||v||m||i.has_stats||i.has_commentary?R`
          <div class="extras-row">
            ...
            ${i.has_stats?R`<div class="extra-chip info ${i.links&&i.links.stats?"clickable":""}" @click="${i.links&&i.links.stats?()=>window.open(i.links.stats,"_blank"):null}" title="${i.links&&i.links.stats?"Bekijk statistieken op ESPN":"Statistieken beschikbaar"}">📊 <span>${this._t("card.stats")}</span></div>`:""}
            ${i.has_commentary?R`<div class="extra-chip info ${i.links&&i.links.commentary?"clickable":""}" @click="${i.links&&i.links.commentary?()=>window.open(i.links.commentary,"_blank"):null}" title="${i.links&&i.links.commentary?"Open ESPN commentary":this._t("card.commentary")}">💬 <span>${this._t("card.commentary")}</span></div>`:""}
          </div>
        `:""}
