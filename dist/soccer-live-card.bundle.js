    ...
    `}}),customElements.define("soccer-live-competition-schedule",class extends oe{static get properties(){return{hass:{},_config:{},_round:{type:Number}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,me(this,e),this._round=null}getCardSize(){return 6}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-competition-schedule-editor")}static getStubConfig(){return{entity:"sensor.soccer_live_all_",my_team:""}}_groupByRound(e){const t=new Map,a=e.some((e=>null!=e.week_number));for(const i of e){const e=a?i.week_number:this._weekFromDate(i.date);t.has(e)||t.set(e,[]),t.get(e).push(i)}const i=[...t.entries()].sort(((e,t)=>e[0]-t[0]));return a?new Map(i):new Map(i.map(((e,t)=>{let[,a]=e;return[t+1,a]})))}_weekFromDate(e){if(!e)return 0;try{const t=e.split(" ")[0].split(/[-\/]/),[a,i,n]=3===t.length?t.map(Number):[1,1,2e3],s=new Date(n,i-1,a),o=new Date(n,0,1);return Math.ceil(((s-o)/864e5+o.getDay()+1)/7)}catch{return 0}}_currentRoundKey(e,t){for(const[t,a]of e)if(a.some((e=>"in"===e.state)))return t;for(const[t,a]of e)if(a.some((e=>"pre"===e.state)))return t;const a=[...e.keys()];return a[a.length-1]??1}_formatDate(e){if(!e)return"";try{const[t]=e.split(" "),a=t.split(/[-\/]/).map(Number);if(3!==a.length)return t;const[i,n,s]=a,o=new Date(s,n-1,i);return`${o.toLocaleDateString(de(this.hass,this._config),{weekday:"short"})} ${o.toLocaleDateString(de(this.hass,this._config),{day:"numeric",month:"short"})}`}catch{return e}}_formatTime(e){return e&&e.split(" ")[1]||""}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return Ae("⚠️",this._t("ui.unknown_entity"),this._config.entity,this._t("ui.wrong_entity_type_hint"));if("unavailable"===e.state)return Ae("📡",this._t("ui.sensor_unavailable"),"",this._t("ui.check_integration"));const t=e.attributes,a=t.matches||[];if(!a.length)return Ae("📅",this._t("ui.off_season"),this._t("ui.off_season_hint"));const i=(t.league_info||[])[0]||{},n=i.name||i.abbreviation||e.state,s=i.logo_href&&"N/A"!==i.logo_href?i.logo_href:null,o=this._groupByRound(a),r=[...o.keys()],l=this._round??this._currentRoundKey(o,a),c=r.indexOf(l),d=-1===c?r.length-1:c,p=r[d],h=o.get(p)||[],g=(this._config.my_team||"").toLowerCase(),u=d>0,m=d<r.length-1;return R`
      <ha-card>
        ...
        <div class="match-list">
          ${h.map((e=>{const t=g&&e.home_team&&e.home_team.toLowerCase().includes(g),a=g&&e.away_team&&e.away_team.toLowerCase().includes(g),i=t||a,n="in"===e.state||"post"===e.state?`${e.home_score??"-"} - ${e.away_score??"-"}`:"-",s="in"===e.state;return R`
