        ...
        <table>
          ...
          ${r.map((e=>{const t=s&&e.team_name&&e.team_name.toLowerCase().includes(s),a=(parseInt(e.wins)||0)+(parseInt(e.draws)||0)+(parseInt(e.losses)||0),i=parseInt(e.goal_difference)||0,n=i>0?`+${i}`:`${i}`;return U`
              <tr class="${t?"hl":""}">
                ...
                <td>${a||""}</td>
                ${this._config.hide_stats?"":U`<td>${e.wins??""}</td><td>${e.draws??""}</td><td>${e.losses??""}</td><td>${null!=e.goal_difference?n:""}</td>`}
        ...
        <div class="teams">
          ...
          <div class="center">
            ...
            `:s?U`
              ...
              <div class="countdown">
                ${s.days>0?U`
                  <div class="cd-block"><span class="cd-num">${s.days}</span><span class="cd-label">days</span></div>
                  <span class="cd-sep">:</span>
                `:""}
                <div class="cd-block"><span class="cd-num">${String(s.hours).padStart(2,"0")}</span><span class="cd-label">hrs</span></div>
                <span class="cd-sep">:</span>
                <div class="cd-block"><span class="cd-num">${String(s.mins).padStart(2,"0")}</span><span class="cd-label">min</span></div>
                <span class="cd-sep">:</span>
                <div class="cd-block"><span class="cd-num">${String(s.secs).padStart(2,"0")}</span><span class="cd-label">sec</span></div>
              </div>
            `:U`
              ${t.date?U`<div class="sched-date">${t.date}</div>`:""}
