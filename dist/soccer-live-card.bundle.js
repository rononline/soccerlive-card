        ...
        <select class="type-picker" @change=${e=>this._typeChanged(e)}>
          ...
          ${ra.map(([e,a])=>i.qy`
            <optgroup label=${this._t(e)}>
              ${a.map(e=>{const a=ca.find(t=>t.value===e);return a?i.qy`<option value=${e} ?selected=${e===t}>${a.label}</option>`:""})}
            </optgroup>
          `)}
        </select>
