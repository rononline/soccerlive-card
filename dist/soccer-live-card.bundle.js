...
`,ge=["dark","light","red-white","classic","neon","gold"];function ue(e,t){const i=function(e){const t=e&&"string"==typeof e.skin?e.skin.toLowerCase():"dark";return ge.includes(t)?t:"dark"}(t);return e&&e.setAttribute&&e.setAttribute("data-skin",i),i}const me=(e,t)=>Array.from({length:t-e+1},((t,i)=>e+i)),fe={serie_a:{match:(e,t)=>"ita.1"===e||t.includes("italian_serie_a"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},premier_league:{match:(e,t)=>"eng.1"===e||t.includes("english_premier"),champions:[1,2,3,4,5],europa:[6],conference:[7],relegation:"bottom3"},laliga:{match:(e,t)=>"esp.1"===e||t.includes("spanish_la_liga")||t.includes("spanish_laliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},bundesliga:{match:(e,t)=>"ger.1"===e||t.includes("german_bundesliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:[17,18]},ligue_1:{match:(e,t)=>"fra.1"===e||t.includes("french_ligue_1"),champions:[1,2,3],europa:[4],conference:[5],relegation:[17,18]},eredivisie:{match:(e,t)=>"ned.1"===e||t.includes("dutch_eredivisie"),champions:[1,2],europa:[3],conference:[4,5],relegation:[17,18]},primeira_liga:{match:(e,t)=>"por.1"===e||t.includes("portuguese_primeira"),champions:[1,2],europa:[3],conference:[4],relegation:[17,18]},ucl_league_phase:{match:(e,t)=>"uefa.champions"===e||t.includes("uefa_champions_league"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},uel_league_phase:{match:(e,t)=>"uefa.europa"===e||t.includes("uefa_europa_league"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},uecl_league_phase:{match:(e,t)=>"uefa.europa.conf"===e||t.includes("uefa_conference"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},world_cup:{match:(e,t)=>"fifa.world"===e||t.includes("fifa_world_cup")||t.includes("world_cup"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"🏆",accent:"world_cup"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},uefa_euro:{match:(e,t)=>"uefa.euro"===e||t.includes("uefa_euro")||t.includes("european_championship"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"⭐",accent:"uefa_euro"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},copa_america:{match:(e,t)=>"conmebol.america"===e||t.includes("copa_america")||t.includes("conmebol_america"),champions:[1,2],europa:[],conference:[],relegation:"bottom2",kind:"cup_group",hero:{icon:"🏆",accent:"copa_america"},labels:{champions:"zone.qualified",europa:null,conference:null,relegation:"zone.eliminated"}}};customElements.define("soccer-live-classifica",class extends oe{static get properties(){return{hass:{},_config:{},maxTeamsVisible:{type:Number},hideHeader:{type:Boolean},selectedGroup:{type:String},_eventSubscriptions:{type:Array},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.maxTeamsVisible=e.max_teams_visible?e.max_teams_visible:10,this.hideHeader=e.hide_header||!1,this.selectedGroup=e.selected_group||"",this.showEventToasts=!0===e.show_event_toasts,this.highlightTeam=(e.highlight_team||e.my_team||"").toLowerCase(),this.showStats=!1!==e.show_stats,this.showGoalsFor=!0===e.show_goals_for,this.compactMode=!0===e.compact_mode,this.compactTop=parseInt(e.compact_top)||5,this.compactBottom=parseInt(e.compact_bottom)||3,this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null}_t(e,t){return pe(e,de(this.hass,this._config),t)}connectedCallback(){super.connectedCallback(),this._subscribeToEvents()}disconnectedCallback(){super.disconnectedCallback(),this._toastTimer&&clearTimeout(this._toastTimer),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass&&this.hass.connection&&(this._eventSubscriptions=[],["soccer_live_goal","soccer_live_yellow_card","soccer_live_red_card"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleCalcioLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this._config.entity||"",i=e.competition_code;if(!i)return!1;const a=i.replace(/\./g,"_").toLowerCase();return t.toLowerCase().includes(a)}_handleCalcioLiveEvent(e){const t=e.event_type,i=e.data;this._eventBelongsToThisCard(i)&&this.showEventToasts&&this._showEventToast(t,i)}_showEventToast(e,t){let i="",a="goal";"soccer_live_goal"===e?(i=`<strong>${this._t("event.goal").toUpperCase()}!</strong> ${t.player} · ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,a="goal"):"soccer_live_yellow_card"===e?(i=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,a="yellow"):"soccer_live_red_card"===e?(i=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,a="red"):"soccer_live_match_finished"===e&&(i=`<strong>${this._t("status.finished")}!</strong> ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,a="finished"),i&&(this._toastMessage=i,this._toastVariant=a,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}getCardSize(){return 5}static getConfigElement(){return document.createElement("soccer-live-classifica-editor")}static getStubConfig(){return{entity:"sensor.soccerlive",max_teams_visible:10,hide_header:!1,selected_group:"",show_event_toasts:!1}}_getZoneConfig(){if(this._config.zone_config)return this._config.zone_config;if(this._config.zone_preset&&fe[this._config.zone_preset])return fe[this._config.zone_preset];return this._inferPresetFromEntity()||{champions:[],europa:[],conference:[],relegation:null}}_getZoneLabels(){const e=this._getZoneConfig().labels||{};return{champions:void 0!==e.champions?e.champions:"zone.champions",europa:void 0!==e.europa?e.europa:"zone.europa",conference:void 0!==e.conference?e.conference:"zone.conference",relegation:void 0!==e.relegation?e.relegation:"zone.relegation"}}_hasZonePositions(e){return!!e&&(Array.isArray(e)?e.length>0:"string"==typeof e&&/^bottom\d+$/.test(e))}_inferPresetFromEntity(){const e=(this._config.entity||"").toLowerCase(),t=this.hass&&this._config.entity?this.hass.states[this._config.entity]:null,i=t&&t.attributes?String(t.attributes.competition_code||"").toLowerCase():"";for(const[,t]of Object.entries(fe))if(t.match&&t.match(i,e))return t;return null}_positionInZone(e,t,i){if(!i)return!1;const a=String(i).match(/^bottom(\d+)$/);if(a){const i=parseInt(a[1],10);return t&&e>t-i}return!!Array.isArray(i)&&i.includes(Number(e))}_translatePhase(e){return e?{"regular-season":this._t("phase.regular_season"),"regular season":this._t("phase.regular_season"),"group-stage":this._t("phase.group_stage"),"group stage":this._t("phase.group_stage"),playoffs:this._t("phase.playoffs")}[String(e).toLowerCase()]||e:""}_shouldShowPhase(e){return!!e&&("regular-season"!==String(e).toLowerCase()&&!/\d{4}/.test(e))}_isCupGroupStage(){const e=this._getZoneConfig();return e&&"cup_group"===e.kind}_groupHasNoMatches(e){if(!e||!e.length)return!1;const t=e=>{if(null==e||""===e)return 0;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?0:t};return e.every((e=>t(e.wins)+t(e.draws)+t(e.losses)===0))}_zoneClass(e,t){const i=this._getZoneConfig();return this._positionInZone(e,t,i.champions)?1!==e||this._isCupGroupStage()?"zone-cl":"zone-cl rank-first":this._positionInZone(e,t,i.europa)?"zone-el":this._positionInZone(e,t,i.conference)?"zone-conf":this._positionInZone(e,t,i.relegation)?"zone-rel":"zone-default"}_sortStandings(e,t){let i=(e||[]).filter((e=>null!=e.rank));return t.includes("MLS")?(i=i.slice().sort(((e,t)=>t.points!==e.points?t.points-e.points:t.goal_difference!==e.goal_difference?t.goal_difference-e.goal_difference:t.goals_for-e.goals_for)),i.forEach(((e,t)=>{e.rank=t+1}))):i=i.slice().sort(((e,t)=>e.rank-t.rank)),i}_currentGroup(e){return e.find((e=>e.name===this.selectedGroup))||e[0]}render(){if(!this.hass||!this._config)return R``;const e=this._config.entity,t=this.hass.states[e];if(!t)return R`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;const i=t.attributes.season||"",a=t.attributes.league_abbreviation&&"N/A"!==t.attributes.league_abbreviation?t.attributes.league_abbreviation:null,n=a&&t.attributes.league_name?i.replace(t.attributes.league_name,a).trim():i,s=t.attributes.standings_groups||[],o=!this.selectedGroup&&s.length>1,r=this._currentGroup(s),l=this._sortStandings(r?r.standings:[],n),c=l.length,d=48*Math.min(this.maxTeamsVisible,c)+50,p=this.highlightTeam?(l.find((e=>e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam)))||{}).rank:null,h=Math.round(l.reduce(((e,t)=>e+(parseInt(t.games_played)||0)),0)/2),g=l.reduce(((e,t)=>e+(parseInt(t.goals_for)||0)),0),u=(t.attributes.standings_groups||[]).some((e=>(e.standings||[]).some((e=>(parseInt(e.games_played)||0)>0)))),m=!u&&c>0&&l.every((e=>0===parseInt(e.wins??"0")&&0===parseInt(e.draws??"0")&&0===parseInt(e.losses??"0")));return R`
    ...
    `}_renderFullTable(e,t){let i=e,a=null;if(this.compactMode&&t>this.compactTop+this.compactBottom){const n=e.slice(0,this.compactTop),s=e.slice(t-this.compactBottom),o=t-this.compactTop-this.compactBottom,r=this.highlightTeam?e.slice(this.compactTop,t-this.compactBottom).find((e=>e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam))):null;i=[...n,...r?[r]:[],{_separator:!0,hiddenCount:o},...s],a=!0}return R`
      <table class="standings-table">
        ...
        <tbody>
          ${i.map((e=>{if(e._separator)return R`
              <tr class="separator-row">
                <td colspan="8">
                  <span class="separator-dots">· · · ${e.hiddenCount} ${this._t("standings.compact_hidden")} · · ·</span>
                </td>
              </tr>`;const i=this.highlightTeam&&e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam),a=e=>{if(null==e||""===e)return null;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?null:t},n=a(e.wins),s=a(e.draws),o=a(e.losses),r=a(e.goal_difference),l=null!==n&&null!==s&&null!==o?n+s+o:null,c=null===r?"":r>0?"gd-pos":r<0?"gd-neg":"",d=null===r?"-":r>0?`+${r}`:`${r}`;return R`
              <tr class="${this._zoneClass(e.rank,t)} ${i?"highlighted-team":""}">
    ...
    `}_renderCompactTable(e,t){return R`
      <table class="standings-table compact">
        ...
        <tbody>
          ${e.map((e=>{const i=(e=>{if(null==e||""===e)return null;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?null:t})(e.goal_difference),a=null===i?"":i>0?"gd-pos":i<0?"gd-neg":"",n=null===i?"-":i>0?`+${i}`:`${i}`;return R`
    ...
    `}_renderHeader(e,t,i,a,n,s){const o=this._getZoneConfig(),r=this._isCupGroupStage(),l=o&&o.hero?o.hero:null,c=e.attributes.league_abbreviation&&"N/A"!==e.attributes.league_abbreviation?e.attributes.league_abbreviation:null,d=c&&t?t.replace(c,"").trim():t&&"n/a"!==t.toLowerCase()?t:"",p=n?this._t("phase.group_stage"):this._shouldShowPhase(i&&i.name)?this._translatePhase(i.name):"",h=[];c&&h.push(this._t("card.standings")),d&&h.push(d),p&&h.push(p);let g=0;if(n)for(const e of a)g+=(e.standings||[]).filter((e=>null!=e.rank)).length;return R`
    ...
    `:""}_renderGroupsGrid(e,t){const i=this._isCupGroupStage();return R`
      <div class="groups-grid ${i?"groups-grid-cup":""}">
        ${e.map((e=>{const i=this._sortStandings(e.standings||[],t),a=this._groupHasNoMatches(i);return R`
            <div class="group-cell ${a?"group-cell-pending":""}">
              <div class="group-title">
                <span>${e.name}</span>
                ${a?R`<span class="group-pending-badge">${this._t("hero.not_started")}</span>`:""}
              </div>
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-classifica",name:"Soccer Live Standings Card",description:"Shows the standings for a league or cup competition"});const ve=s`
...
`;customElements.define("soccer-live-classifica-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array},groups:{type:Array}}}constructor(){super(),this.entities=[],this.groups=[]}static get styles(){return[ve,s`
      .card-config {
        display: flex;
        flex-direction: column;
        gap: 16px;
      ...
      <ha-card>
        ...
        ${this.hideHeader?"":R`
          <div class="matches-header">
            ${a&&a.logo_href?R`<img class="league-logo" src="${a.logo_href}" alt="${a.abbreviation||""}" />`:n?R`<img class="league-logo" src="${n}" alt="" />`:""}
            <div class="league-info">
              <div class="league-name">${a&&a.abbreviation||t.state||"Soccer Live"}</div>
              <div class="league-dates">
                ${(()=>{const e=t.attributes.total_matches||t.attributes.matches?.length||0,i=t.attributes.finished_matches_count??(t.attributes.matches||[]).filter((e=>"post"===e.state)).length;return e>0&&i>=0?`${i} / ${e} gespeeld`:a&&a.startDate?`${a.startDate} → ${a.endDate}`:this._t("generic.matches_count",{n:s.length})})()}
              </div>
            </div>
        ...
        <div class="scroll-content" style="max-height: ${p}px;">
          ${c.map((e=>R`
            ...
            ${e.matches.map((e=>{const t=`${e.home_team}_${e.away_team}`,i="in"===e.state,a=this._recentEventMatches.get(t),n=this._isWinner(e,"home"),s=this._isWinner(e,"away"),o=e.broadcast&&""!==e.broadcast&&"N/A"!==e.broadcast?e.broadcast:"",r="pre"===e.state,c=this.myTeam&&e.home_team&&e.home_team.toLowerCase().includes(this.myTeam),d=this.myTeam&&e.away_team&&e.away_team.toLowerCase().includes(this.myTeam);return R`
    ...
    `}updated(e){(e.has("showPopup")||e.has("activeMatch"))&&this.renderPopupToBody()}renderPopupToBody(){if(!this.showPopup||!this.activeMatch){const e=document.getElementById("soccer-live-matches-popup");return void(e&&e.remove())}let e=document.getElementById("soccer-live-matches-popup");e||(e=document.createElement("div"),e.id="soccer-live-matches-popup",e.style.cssText="\n        position: fixed; inset: 0;\n        display: flex; justify-content: center; align-items: center;\n        z-index: 999999;\n        background: rgba(0,0,0,0.7);\n        backdrop-filter: blur(8px);\n        overflow: auto;\n      ",e.addEventListener("click",(t=>{t.target===e&&(this.showPopup=!1)})),document.body.appendChild(e));const t=this.activeMatch,i=e=>this._t(e),a=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),n=getComputedStyle(this),s=n.getPropertyValue("--cl-bg").trim()||"#1a1f2e",o=n.getPropertyValue("--cl-text").trim()||"#f8fafc",r=n.getPropertyValue("--cl-text-2").trim()||"#94a3b8",l=n.getPropertyValue("--cl-accent").trim()||"#6366f1",c=n.getPropertyValue("--cl-accent-2").trim()||"#ec4899",d=n.getPropertyValue("--cl-divider").trim()||"rgba(255,255,255,0.08)";e.innerHTML=`\n      <div style="background:${s}; padding:24px; border-radius:20px; width:90%; max-width:560px; max-height:85vh; overflow-y:auto; border:1px solid ${d}; box-shadow:0 24px 64px rgba(0,0,0,0.6); margin:auto; color:${o}; font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display',sans-serif;">\n        <h3 style="margin:0 0 20px; font-size:22px; font-weight:800; letter-spacing:-0.02em; background:linear-gradient(135deg,${l},${c}); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color:transparent;">${i("popup.match_details")}</h3>\n        <div style="display:flex; justify-content:center; align-items:center; gap:18px; margin-bottom:24px;">\n          <img style="width:64px; height:64px; object-fit:contain;" src="${a(t.home_logo)}" alt="${a(t.home_team)}" />\n          <div style="text-align:center;">\n            <div style="font-size:38px; font-weight:900; letter-spacing:-0.04em; line-height:1;">${a(t.home_score&&"N/A"!==t.home_score?t.home_score:"-")} <span style="opacity:0.4;">-</span> ${a(t.away_score&&"N/A"!==t.away_score?t.away_score:"-")}</div>\n            <div style="font-size:12px; color:${r}; margin-top:8px; font-weight:600;">${a(t.clock&&"N/A"!==t.clock?t.clock:t.status&&"N/A"!==t.status?t.status:"")}</div>\n          </div>\n          <img style="width:64px; height:64px; object-fit:contain;" src="${a(t.away_logo)}" alt="${a(t.away_team)}" />\n        </div>\n        <p style="text-align:center; color:${r}; font-size:14px; margin:0 0 20px;"><strong>${a(t.home_team)}</strong> tegen <strong>${a(t.away_team)}</strong></p>\n        <div id="matches-events-container"></div>\n        <button id="popup-close-btn" style="background:linear-gradient(135deg,${l},${c}); color:white; padding:12px 20px; border:none; border-radius:12px; cursor:pointer; margin-top:20px; font-weight:800; width:100%; font-size:14px;">${i("generic.close")}</button>\n      </div>\n    `;const p=e.querySelector("#popup-close-btn");p&&p.addEventListener("click",(()=>{this.showPopup=!1}));const h=e.querySelector("#matches-events-container"),{goals:g,yellowCards:u,redCards:m}=this.separateEvents(t.match_details||[]),f=(e,t,i)=>t.length?`<div style="margin-bottom:14px; padding:14px; background:${i.bg}; border-left:3px solid ${i.border}; border-radius:10px;">\n        <h5 style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:${i.border}; font-weight:800;">${e}</h5>\n        <ul style="margin:0; padding-left:18px; font-size:13px; color:#cbd5e1;">${t.map((e=>`<li style="margin:4px 0;">${a(e)}</li>`)).join("")}</ul>\n      </div>`:"";let v="";v+=f(i("event.goal"),g,{bg:`rgba(${l.replace("#","")},0.1)`,border:l}),v+=f(i("event.yellow_card"),u,{bg:"rgba(245,158,11,0.1)",border:"#f59e0b"}),v+=f(i("event.red_card"),m,{bg:"rgba(239,68,68,0.1)",border:"#ef4444"}),h.innerHTML=v||`<p style="text-align:center; color:#94a3b8; font-size:13px;">${i("popup.no_events")}</p>`}static get styles(){return[he,s`
      :host {
        --cl-accent: #6366f1;
        --cl-accent-2: #ec4899;
        --cl-live: #ef4444;
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-matches",name:"Soccer Live Matches Card",description:"Shows all matches for a competition or team"}),customElements.define("soccer-live-matches-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s`
      .card-config {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;async function Ce(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,n=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null;if(!e||"N/A"===e)return R``;try{let s=null;if(s=null!==a&&null!==n?{lat:a,lon:n}:await function(e){if(!e||"N/A"===e)return null;if(_e.has(e))return _e.get(e);const t=ye[e]||null;return t&&(we(_e),_e.set(e,t)),t}(e),!s)return R``;const o=await async function(e,t){const i=`${e},${t}`;if(be.has(i)){const e=be.get(i);if(Date.now()-e.timestamp<36e5)return e.data}try{const s=await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${e}&longitude=${t}&current=temperature_2m,weather_code,wind_speed_10m&timezone=auto`),o=await s.json();if(o.current){const e={temp:Math.round(o.current.temperature_2m),code:o.current.weather_code,wind:(n=o.current.wind_speed_10m,n<1?0:n<6?1:n<12?2:n<20?3:n<29?4:n<39?5:n<50?6:n<62?7:n<75?8:n<89?9:n<103?10:n<118?11:12),wind_unit:"BFT",icon:(a=o.current.weather_code,a&&0!==a&&1!==a?2===a?"⛅":3===a?"☁️":45===a||48===a?"🌫️":a>=51&&a<=55?"🌦️":a>=61&&a<=65?"🌧️":a>=71&&a<=77?"🌨️":a>=80&&a<=82?"🌧️":85===a||86===a?"🌨️":95===a||96===a||99===a?"⛈️":"🌤️":"☀️"),description:$e(o.current.weather_code),timestamp:Date.now()};return we(be),be.set(i,{data:e,timestamp:Date.now()}),e}}catch(e){console.warn("Weather fetch failed:",e)}var a,n;return null}(s.lat,s.lon);if(!o)return R``;const r=t?pe("weather.wind",de(t,i)):"Wind speed (Beaufort)";return R`
    ...
    `}catch(e){return console.warn("Weather badge error:",e),R``}}const ze=s`
  .spinner-container {
    display: flex;
    align-items: center;
    justify-content: center;
...
`,function(e,t,i){let a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return R`
  <ha-card style="padding: 16px; text-align: center; color: var(--error-color, #ef5350);">
    ...
    <div style="font-size: 12px; color: var(--secondary-text-color); margin-bottom: 8px;">${i}</div>
    ${a?R`<div style="font-size: 11px; color: var(--text-primary-color); background: rgba(0,0,0,0.1); padding: 8px; border-radius: 4px; margin-top: 8px;">${a}</div>`:""}
  </ha-card>
`}),Ae=function(e,t,i){let a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return R`
...
`},Te="soccerlive_cache_",Le=new Map;class Ne{static set(e,t){try{const i=JSON.stringify(t);if(Le.get(e)===i)return;Le.size>=50&&Le.delete(Le.keys().next().value),Le.set(e,i),localStorage.setItem(Te+e,JSON.stringify({timestamp:Date.now(),data:t}))}catch(e){console.warn("Failed to cache:",e)}}static get(e){try{const t=localStorage.getItem(Te+e);if(!t)return null;const{timestamp:i,data:a}=JSON.parse(t),n=Date.now()-i;return n<864e5?{data:a,age:n,isCached:!0}:(this.clear(e),null)}catch(e){return console.warn("Failed to read cache:",e),null}}static clear(e){try{localStorage.removeItem(Te+e)}catch(e){console.warn("Failed to clear cache:",e)}}static clearAll(){try{Object.keys(localStorage).forEach((e=>{e.startsWith(Te)&&localStorage.removeItem(e)}))}catch(e){console.warn("Failed to clear all cache:",e)}}static getAge(e){const t=localStorage.getItem(Te+e);if(!t)return null;try{const{timestamp:e}=JSON.parse(t),i=Date.now()-e,a=Math.floor(i/6e4);if(a<60)return`${a}m ago`;const n=Math.floor(a/60);return n<24?`${n}h ago`:`${Math.floor(n/24)}d ago`}catch(e){return null}}}customElements.define("soccer-live-team",class extends oe{static get properties(){return{hass:{},_config:{},_isLoading:{type:Boolean},showPopup:{type:Boolean},activeMatch:{type:Object},_eventSubscriptions:{type:Array},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String},_weatherBadge:{type:Object},_cachedData:{type:Object}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e);const t=["big","huge"].includes(e.score_size)?e.score_size:"normal";this.setAttribute("data-score",t),this._isLoading=!0,this._loadingStarted=Date.now(),this._lastWeatherVenue=null,this.showPopup=!1,this.activeMatch=null,this.showEventToasts=!0===e.show_event_toasts,this.myTeam=(e.my_team||"").toLowerCase(),this.showPreviousMatches=!0===e.show_previous_matches,this.showFormTrend=!0===e.show_form_trend,this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null}_t(e,t){return pe(e,de(this.hass,this._config),t)}_translatePhase(e){return e?{"regular-season":this._t("phase.regular_season"),"regular season":this._t("phase.regular_season"),"group-stage":this._t("phase.group_stage"),"group stage":this._t("phase.group_stage"),playoffs:this._t("phase.playoffs")}[String(e).toLowerCase()]||e:""}_shouldShowPhase(e){return!!e&&"regular-season"!==String(e).toLowerCase()}connectedCallback(){super.connectedCallback(),this._subscribeToEvents(),this._countdownInterval=setInterval((()=>this.requestUpdate()),3e4),this._loadingTimer=setTimeout((()=>this.requestUpdate()),1e4)}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this._countdownInterval),this._countdownInterval=null,clearTimeout(this._loadingTimer),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass&&this.hass.connection&&(this._eventSubscriptions=[],["soccer_live_goal","soccer_live_yellow_card","soccer_live_red_card"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleCalcioLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this.hass.states[this._config.entity];if(!t)return!1;const i=t.attributes.matches||[];if(0===i.length)return!1;const a=i[0];return a.home_team===e.home_team&&a.away_team===e.away_team}_handleCalcioLiveEvent(e){const t=e.event_type,i=e.data;if(this._eventBelongsToThisCard(i)&&this.showEventToasts)if("soccer_live_goal"===t){const e=i.team===i.home_team?"home":"away";requestAnimationFrame((()=>this._triggerGoalCelebration(e,i)))}else this._showEventToast(t,i)}_showEventToast(e,t){let i="",a="goal";"soccer_live_goal"===e?(i=`<strong>${this._t("event.goal").toUpperCase()}!</strong> ${t.player} · ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,a="goal"):"soccer_live_yellow_card"===e?(i=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,a="yellow"):"soccer_live_red_card"===e&&(i=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,a="red"),i&&(this._toastMessage=i,this._toastVariant=a,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}_triggerGoalCelebration(e,t){const i=this.shadowRoot&&this.shadowRoot.querySelector("ha-card");if(!i)return;i.querySelectorAll(".confetti, .goal-banner, .goal-flash-overlay").forEach((e=>e.remove())),i.classList.remove("goal-flash"),i.offsetWidth,i.classList.add("goal-flash"),setTimeout((()=>i.classList.remove("goal-flash")),1700);const a=document.createElement("div");a.className="goal-flash-overlay",i.appendChild(a),setTimeout((()=>a.remove()),1e3);const n=document.createElement("div");n.className="goal-banner",n.innerHTML='<div class="goal-banner-text">GOAL!</div>',i.appendChild(n),setTimeout((()=>n.remove()),1700);const s=i.querySelector(".score-numbers");s&&(s.classList.remove("goal-scored"),s.offsetWidth,s.classList.add("goal-scored"),setTimeout((()=>s.classList.remove("goal-scored")),1300));const o=i.querySelectorAll(".team-side .team-logo-big"),r="away"===e?o[1]:o[0];r&&(r.classList.remove("scorer-bounce"),r.offsetWidth,r.classList.add("scorer-bounce"),setTimeout((()=>r.classList.remove("scorer-bounce")),1300)),navigator.vibrate&&navigator.vibrate([180,80,180,80,280]),setTimeout((()=>this._showEventToast("soccer_live_goal",t)),600);const l=["#ec4899","#6366f1","#06b6d4","#fbbf24","#10b981","#ef4444"],c=["⚽","🎉","✨","🔥","⭐"];for(let e=0;e<36;e++){const e=document.createElement("div");e.className="confetti",Math.random()>.55?(e.textContent=c[Math.floor(Math.random()*c.length)],e.style.fontSize=14+10*Math.random()+"px",e.style.background="transparent"):(e.style.background=l[Math.floor(Math.random()*l.length)],e.style.borderRadius=Math.random()>.5?"50%":"2px");const t=380*(Math.random()-.5)+"px",a=240*Math.random()+100+"px";e.style.setProperty("--dx",t),e.style.setProperty("--dy",a),e.style.animationDelay=.3*Math.random()+"s",i.appendChild(e),setTimeout((()=>e.remove()),2e3)}}_parseMatchDate(e){if(!e||"N/A"===e)return null;try{const[t,i]=e.split(" "),[a,n,s]=t.split(/[-\/]/).map(Number),[o,r]=(i||"00:00").split(":").map(Number);return new Date(s,n-1,a,o,r)}catch(e){return null}}_liveCountdown(e){if(!e||"pre"!==e.state)return null;const t=this._parseMatchDate(e.date);if(!t)return null;const i=t-new Date;if(i<=0||i>1728e5)return null;const a=Math.floor(i/6e4);if(a<1)return this._t("time.now");if(a<60)return this._t("time.in_n_min",{n:a});const n=Math.floor(a/60);return this._t("time.in_n_h",{n})}getCardSize(){return 4}static getConfigElement(){return document.createElement("soccer-live-team-editor")}static getStubConfig(){return{entity:"sensor.soccerlive",show_event_toasts:!1}}showDetails(e){this.activeMatch=e,this.showPopup=!0}closePopup(){this.showPopup=!1}separateEvents(e){const t=[],i=[],a=[];return e.forEach((e=>{const n=String(e||"");n.includes("Goal")||n.includes("Penalty - Scored")?t.push(this.formatMatchEvent(n)):n.includes("Yellow Card")?i.push(this.formatMatchEvent(n)):n.includes("Red Card")&&a.push(this.formatMatchEvent(n))})),{goals:t,yellowCards:i,redCards:a}}formatMatchEvent(e){const t=e=>this._t(e);let i=String(e||"").trim();i=i.replace(/^Goal\s*-\s*/i,"").replace(/^Yellow Card\s*-\s*/i,"").replace(/^Red Card\s*-\s*/i,"").replace(/^Penalty - Scored\s*-\s*/i,`${t("event.penalty")} - `).replace(/^Header\s*-\s*/i,`${t("event.header")} - `).replace(/^Shot\s*-\s*/i,`${t("event.shot")} - `).replace(/^Free-kick\s*-\s*/i,`${t("event.free_kick")} - `).replace(/^Penalty\s*-\s*/i,`${t("event.penalty")} - `),i=i.replace(/^([^:]+):\s*/,"$1 ");const a=[t("event.header"),t("event.shot"),t("event.penalty"),t("event.free_kick")].map((e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")));return i=i.replace(new RegExp(`^(${a.join("|")})\\s*-\\s*(.+)$`,"i"),((e,t,i)=>`${i} (${t.toLowerCase()})`)),i=i.replace(/\bN\/A\b/g,t("generic.unknown")),i}_renderStatusBadge(e){const t=e.state;return"in"===t?R`<span class="status-badge live"><span class="dot"></span>${this._t("status.live")}</span>`:"post"===t?R`<span class="status-badge finished">${this._t("status.finished")}</span>`:R`<span class="status-badge scheduled">${e.date||this._t("status.scheduled")}</span>`}_renderClock(e){const t=e.state;if("in"===t){const t=e.status_detail&&"N/A"!==e.status_detail?e.status_detail:"",i=(e.clock&&"N/A"!==e.clock?e.clock:"")||t||e.status||"";return R`<div class="clock"><span class="dot"></span>${i}</div>`}if("post"===t)return R`<div class="clock finished">${this._t("status.full_time")}</div>`;const i=this._liveCountdown(e);return R`<div class="clock upcoming">${i||e.date||""}</div>`}_renderRecord(e){if(!e||"N/A"===e)return"";const t=String(e).split("-");return 3===t.length?t.every((e=>0===parseInt(e)))?"":R`<div class="record">
      ...
      </div>`:R`<div class="record"><span class="rec">${e}</span></div>`}_hexToRgb(e){if(!e||"N/A"===e)return null;const t=String(e).replace("#","");return 6!==t.length?null:`${parseInt(t.slice(0,2),16)},${parseInt(t.slice(2,4),16)},${parseInt(t.slice(4,6),16)}`}_renderTopScorer(e){if(!e||!e.name)return"";const t=e.short_name||e.name,i=this._t("team.top_scorer");return R`
    ...
    `}_renderForm(e){if(!e||"N/A"===e)return"";const t=String(e).replace(/[^WLDwld]/g,"").toUpperCase();if(!t.length)return"";const i=t.slice(-5).split(""),a=e=>this._t("form."+e);return R`
      <div class="form-pills">
        ${i.map((e=>R`<div class="form-pill ${e}">${a(e)}</div>`))}
      </div>
    `}_renderStatsRow(e){const t=e.home_statistics||{},i=e.away_statistics||{},a=[],n=e=>{const t=parseFloat(e);return isNaN(t)?null:t},s=function(e,s,o){let r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"";const l=n(t[s]),c=n(i[o]);null!==l&&null!==c&&a.push({label:e,home:t[s],away:i[o],hNum:l,aNum:c,suffix:r})};return s(this._t("team.possession"),"possessionPct","possessionPct","%"),s(this._t("team.shots"),"totalShots","totalShots"),s(this._t("team.on_target"),"shotsOnTarget","shotsOnTarget"),0===a.length?"":R`
      <div class="stats-row">
        ${a.map((e=>{const t=e.hNum+e.aNum,i=t>0?e.hNum/t*100:50,a=100-i;return R`
            <div class="stat-bar">
    ...
    `}render(){if(!this.hass||!this._config)return Se("Loading...");const e=this._config.entity,t=this.hass.states[e];if(!t){const t=Ne.get(e);return t?Ee("⏱","Offline - showing cached data","Last update: "+new Date(t.data.timestamp||Date.now()).toLocaleTimeString(),"Waiting for integration to come online"):Ee("⚠️","Entity not found",`Unable to find: ${e}`,"Check the entity configuration")}if("unavailable"===t.state){const t=Ne.get(e);if(!t||!t.data.matches)return Ee("📡","Sensor unavailable","The integration may not be running","Restart Home Assistant or check the integration");this._cachedData=t.data}if(this._isLoading)return Date.now()-this._loadingStarted>1e4?Ee("⏱",this._t("ui.loading_timeout"),`${this._t("ui.entity_not_responding")}: ${this._config.entity}`,this._t("ui.check_integration")):Se(this._t("ui.loading"));const i=t&&"unavailable"!==t.state?t.attributes:this._cachedData;if(!i||!i.matches||0===i.matches.length){const e=this._config.entity||"";return e.includes("soccerlive_next_")||e.includes("soccerlive_all_mixed_")?Ae("📅",this._t("ui.off_season"),this._t("team.off_season")):Ee("⚠️",this._t("ui.wrong_entity_type"),e,this._t("ui.wrong_entity_type_hint"))}const a=i.matches[0],n=i.league_info?i.league_info[0]:null,s=n&&n.logo_href&&"N/A"!==n.logo_href?n.logo_href:null,o="in"===a.state,r="post"===a.state,l=o||r,c=n&&n.abbreviation&&"N/A"!==n.abbreviation?n.abbreviation:a.league_name&&"N/A"!==a.league_name?a.league_name:a.season_info&&"N/A"!==a.season_info&&this._shouldShowPhase(a.season_info)?this._translatePhase(a.season_info):"",d=a.venue&&"N/A"!==a.venue?a.venue:"",p=a.venue_city&&"N/A"!==a.venue_city?a.venue_city:"",h=d?p?`${d}, ${p}`:d:"—",g=a.broadcast&&""!==a.broadcast&&"N/A"!==a.broadcast?a.broadcast:"",u=parseInt(a.attendance,10),m=!isNaN(u)&&u>0,f=this._hexToRgb(a.home_color),v=this._hexToRgb(a.away_color),_=f||v?`background:\n      radial-gradient(ellipse at 0% 0%, rgba(${f||"99,102,241"},0.18), transparent 55%),\n      radial-gradient(ellipse at 100% 100%, rgba(${v||"236,72,153"},0.18), transparent 55%)`:"",b=this.myTeam||(i.team_name||"").toLowerCase(),x=b&&a.home_team&&a.home_team.toLowerCase().includes(b),y=b&&a.away_team&&a.away_team.toLowerCase().includes(b);return R`
      <ha-card class="${o?"live":""}">
        ...
        <div class="scoreboard">
          <div class="team-side home">
            ...
            ${o?"":this._renderTopScorer(a.home_top_scorer)}
          </div>

          <div class="score-center">
            ${l?R`<div class="score-numbers">${a.home_score} <span class="dash">-</span> ${a.away_score}</div>`:R`<div class="score-vs">tegen</div>`}
            ${this._renderClock(a)}
          </div>
          ...
          <div class="team-side away">
            ...
            <div class="team-name-big ${y?"my-team":""}">${a.away_team}</div>
            ${this._renderRecord(a.away_record)}
            ${this._renderForm(a.away_form)}
            ${o?"":this._renderTopScorer(a.away_top_scorer)}
          </div>
        </div>

        ${o?this._renderStatsRow(a):""}
        ...
        <div class="meta-row">
          ...
          ${l?R`<button class="info-btn" @click="${()=>this.showDetails(a)}">${this._t("team.details")} ›</button>`:R`
              <div class="meta-item">
    ...
    `}_relativeDate(e){if(!e)return"";const t=e.split(" "),[i,a,n]=(t[0]||"").split(/[-\/]/).map(Number);if(!i||!a||!n)return t[0]||"";const s=new Date(n,a-1,i),o=new Date;o.setHours(0,0,0,0);const r=Math.round((s-o)/864e5);if(1===r)return this._t("time.tomorrow");if(r<=6&&r>1)return this._t("time.in_n_d",{n:r});de(this.hass,this._config);const l=`month.${a}`;return`${i} ${this._t(l)}`}_teamBadge(e,t){const i=t&&"N/A"!==t?`#${t.replace("#","")}`:"rgba(var(--cl-accent-rgb),0.25)";return R`<span class="abbrev-badge" style="background:${i}">${e}</span>`}_renderFormTrend(e,t,i){const a=(i||"").toLowerCase(),n=e&&e.length>0?e:(t||[]).filter((e=>"post"===e.state)).slice(-10).reverse();if(0===n.length)return"";const s=n.map((e=>{const t=e.home_team&&e.home_team.toLowerCase().includes(a),i=parseInt(e.home_score),n=parseInt(e.away_score);return isNaN(i)||isNaN(n)?null:i===n?"D":t&&i>n||!t&&n>i?"W":"L"})).filter(Boolean).reverse();if(0===s.length)return"";const o=s.filter((e=>"W"===e)).length,r=s.filter((e=>"D"===e)).length,l=s.filter((e=>"L"===e)).length;return R`
    ...
    `}_renderPreviousMatches(e,t,i){const a=e&&e.length>0?e.filter((e=>"post"===e.state||!e.state)):t?t.filter((e=>"post"===e.state)).slice(-3).reverse():[];if(0===a.length)return"";const n=(i||"").toLowerCase();return R`
      <div class="upcoming-list">
        <div class="upcoming-list-title">${this._t("team.previous_matches")}</div>
        ${a.map((e=>{const t=n&&e.home_team&&e.home_team.toLowerCase().includes(n),i=n&&e.away_team&&e.away_team.toLowerCase().includes(n),a=parseInt(e.home_score),s=parseInt(e.away_score),o=!isNaN(a)&&!isNaN(s)&&a>s,r=!isNaN(a)&&!isNaN(s)&&s>a;return R`
            <div class="upcoming-row">
              ...
              <span class="upcoming-team away-side ${i?"tracked":""}">
    ...
    `}_renderUpcomingList(e,t,i){const a=e&&e.length>0?e:t&&t.length>1?t.slice(1).filter((e=>"pre"===e.state||"in"===e.state)).slice(0,4):[];if(0===a.length)return"";const n=(i||"").toLowerCase();return R`
      <div class="upcoming-list">
        <div class="upcoming-list-title">${this._t("team.upcoming_matches")}</div>
        ${a.map((e=>{const t=n&&e.home_team&&e.home_team.toLowerCase().includes(n),i=n&&e.away_team&&e.away_team.toLowerCase().includes(n),a="in"===e.state,s=e.head_to_head&&e.head_to_head.length>0;return R`
            <div class="upcoming-row ${s?"clickable":""}"
              ...
              ${a?R`<span class="upcoming-live-score">${e.home_score}<span class="live-dot">●</span>${e.away_score}</span>`:R`<span class="upcoming-vs">-</span>`}
              <span class="upcoming-team away-side ${i?"tracked":""}">
                ${this._teamBadge(e.away_abbrev||"?",e.away_color)}
                <img src="${e.away_logo}" alt="" />
              </span>
    ...
    `}_renderH2H(e){if(!e||0===e.length)return"";const t=e.slice(0,3);return R`
      <div class="h2h-section">
        <div class="upcoming-list-title">${this._t("team.h2h")}</div>
        ${t.map((e=>{const t=e.date?e.date.split("T")[0].split("-"):[],i=3===t.length?`${t[2]}/${t[1]}/${t[0].slice(2)}`:"",a=parseInt(e.home_score)>parseInt(e.away_score),n=parseInt(e.away_score)>parseInt(e.home_score);return R`
            <div class="h2h-row">
              <span class="h2h-date">${i}</span>
    ...
    `}updated(e){if((e.has("showPopup")||e.has("activeMatch"))&&this.renderPopupToBody(),e.has("activeMatch")&&this.activeMatch&&this._loadWeather(this.activeMatch.venue,this.activeMatch.venue_lat,this.activeMatch.venue_lon),e.has("hass")&&this.hass&&this._config){const e=this.hass.states[this._config.entity];if(e&&"unavailable"!==e.state&&(this._isLoading=!1,Ne.set(this._config.entity,e.attributes)),e&&e.attributes.matches&&e.attributes.matches[0]){const t=e.attributes.matches[0];t.venue!==this._lastWeatherVenue&&this._loadWeather(t.venue,t.venue_lat,t.venue_lon)}}}async _loadWeather(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;this._lastWeatherVenue=e;try{this._weatherBadge=await Ce(e,this.hass,this._config,t,i),this.requestUpdate()}catch(e){console.warn("Weather load failed:",e)}}renderPopupToBody(){if(!this.showPopup||!this.activeMatch){const e=document.getElementById("soccer-live-team-popup");return void(e&&e.remove())}let e=document.getElementById("soccer-live-team-popup");e||(e=document.createElement("div"),e.id="soccer-live-team-popup",e.style.cssText="\n        position: fixed; inset: 0;\n        display: flex; justify-content: center; align-items: center;\n        z-index: 999999;\n        background: rgba(0,0,0,0.7);\n        backdrop-filter: blur(8px);\n        overflow: auto;\n      ",e.addEventListener("click",(t=>{t.target===e&&(this.showPopup=!1)})),document.body.appendChild(e));const t=this.activeMatch,i=e=>this._t(e),a=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),n=getComputedStyle(this),s=n.getPropertyValue("--cl-bg").trim()||"#1a1f2e",o=n.getPropertyValue("--cl-text").trim()||"#f8fafc",r=n.getPropertyValue("--cl-text-2").trim()||"#94a3b8",l=n.getPropertyValue("--cl-accent").trim()||"#6366f1",c=n.getPropertyValue("--cl-accent-2").trim()||"#ec4899",d=n.getPropertyValue("--cl-divider").trim()||"rgba(255,255,255,0.08)",p=n.getPropertyValue("--cl-surface").trim()||"rgba(255,255,255,0.04)";e.innerHTML=`\n      <div style="background:${s}; padding: 24px; border-radius: 20px; width: 90%; max-width: 560px; max-height: 85vh; overflow-y: auto; border: 1px solid ${d}; box-shadow: 0 24px 64px rgba(0,0,0,0.6); margin: auto; color: ${o}; font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', sans-serif;">\n        <h3 style="margin:0 0 20px; font-size: 22px; font-weight: 800; letter-spacing:-0.02em; background: linear-gradient(135deg,${l},${c}); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color: transparent;">${i("popup.match_details")}</h3>\n        <div style="display:flex; justify-content:center; align-items:center; gap:18px; margin-bottom:24px;">\n          <img style="width:72px; height:72px; object-fit:contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.4));" src="${a(t.home_logo)}" alt="${a(t.home_team)}" />\n          <div style="text-align:center;">\n            <div style="font-size:42px; font-weight:900; letter-spacing:-0.04em; line-height:1;">${a(t.home_score??"-")} <span style="opacity:0.4;">-</span> ${a(t.away_score??"-")}</div>\n            <div style="font-size:12px; color:${r}; margin-top:8px; font-weight:600;">${a(t.clock??t.status??"")}</div>\n          </div>\n          <img style="width:72px; height:72px; object-fit:contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.4));" src="${a(t.away_logo)}" alt="${a(t.away_team)}" />\n        </div>\n        <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px; margin-bottom:18px;">\n          <div style="background:${p}; padding:14px; border-radius:14px;">\n            <div style="font-size:10px; text-transform:uppercase; letter-spacing:0.1em; color:${r}; font-weight:700; margin-bottom:6px;">${a(t.home_team)}</div>\n            <div style="font-size:13px;"><span style="color:${r};">${i("team.possession")}:</span> <strong>${a(t.home_statistics?.possessionPct??"—")}%</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${i("team.shots")}:</span> <strong>${a(t.home_statistics?.totalShots??"—")}</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${i("team.on_target")}:</span> <strong>${a(t.home_statistics?.shotsOnTarget??"—")}</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${i("team.fouls")}:</span> <strong>${a(t.home_statistics?.foulsCommitted??"—")}</strong></div>\n          </div>\n          <div style="background:${p}; padding:14px; border-radius:14px;">\n            <div style="font-size:10px; text-transform:uppercase; letter-spacing:0.1em; color:${r}; font-weight:700; margin-bottom:6px;">${a(t.away_team)}</div>\n            <div style="font-size:13px;"><span style="color:${r};">${i("team.possession")}:</span> <strong>${a(t.away_statistics?.possessionPct??"—")}%</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${i("team.shots")}:</span> <strong>${a(t.away_statistics?.totalShots??"—")}</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${i("team.on_target")}:</span> <strong>${a(t.away_statistics?.shotsOnTarget??"—")}</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${i("team.fouls")}:</span> <strong>${a(t.away_statistics?.foulsCommitted??"—")}</strong></div>\n          </div>\n        </div>\n        <div id="team-events-container"></div>\n        <button id="popup-close-btn" style="background:linear-gradient(135deg,${l},${c}); color:white; padding:12px 20px; border:none; border-radius:12px; cursor:pointer; margin-top:20px; font-weight:800; width:100%; font-size:14px;">${i("generic.close")}</button>\n      </div>\n    `;const h=e.querySelector("#popup-close-btn");h&&h.addEventListener("click",(()=>{this.showPopup=!1}));const g=e.querySelector("#team-events-container"),{goals:u,yellowCards:m,redCards:f}=this.separateEvents(t.match_details||[]),v=(e,t,i)=>t.length?`<div style="margin-bottom:14px; padding:14px; background:${i.bg}; border-left:3px solid ${i.border}; border-radius:10px;">\n        <h5 style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:${i.border}; font-weight:800;">${e}</h5>\n        <ul style="margin:0; padding-left:18px; font-size:13px; color:#cbd5e1;">${t.map((e=>`<li style="margin:4px 0;">${a(e)}</li>`)).join("")}</ul>\n      </div>`:"";let _="";_+=v(i("event.goal"),u,{bg:"rgba(99,102,241,0.1)",border:"#6366f1"}),_+=v(i("event.yellow_card"),m,{bg:"rgba(245,158,11,0.1)",border:"#f59e0b"}),_+=v(i("event.red_card"),f,{bg:"rgba(239,68,68,0.1)",border:"#ef4444"});const b=t.lineup_home||[],x=t.lineup_away||[];if(b.length||x.length){const e=t.formation_home||"",n=t.formation_away||"",s=(e,t,i)=>{const n=(e||[]).filter((e=>e.starter));return n.length?`<div style="margin-bottom:8px;">\n          <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:6px;">\n            <span style="font-size:12px; font-weight:800; color:#fff;">${a(i)}</span>\n            ${t?`<span style="font-size:10px; font-weight:700; color:#6366f1; letter-spacing:0.1em;">${a(t)}</span>`:""}\n          </div>\n          <div style="font-size:12px; color:#cbd5e1; line-height:1.7;">\n            ${n.map((e=>`<span style="display:inline-block; padding:2px 8px; background:rgba(255,255,255,0.05); border-radius:6px; margin:2px;">${e.jersey?`<strong style="color:#fbbf24;">${a(e.jersey)}</strong> `:""}${a(e.short_name||e.name)}</span>`)).join("")}\n          </div>\n        </div>`:""};_+=`<div style="margin-bottom:14px; padding:14px; background:rgba(16,185,129,0.08); border-left:3px solid #10b981; border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#10b981; font-weight:800;">${i("popup.lineups")}</h5>\n        ${s(b,e,t.home_team)}\n        ${s(x,n,t.away_team)}\n      </div>`}const y=t.key_events||[];if(y.length){const e=e=>{const t=(e.type||"").toLowerCase(),i=(e.type_text||"").toLowerCase();return"goal"===t||e.scoring_play?"⚽":i.includes("yellow")?"🟨":i.includes("red")?"🟥":"substitution"===t?"🔄":i.includes("halftime")?"⏸":i.includes("kickoff")?"▶":i.includes("end")?"🏁":"·"};_+=`<div style="margin-bottom:14px; padding:14px; background:rgba(251,191,36,0.08); border-left:3px solid #fbbf24; border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#fbbf24; font-weight:800;">${i("popup.timeline")}</h5>\n        <ul style="margin:0; padding:0; list-style:none;">\n          ${y.map((t=>`<li style="display:grid; grid-template-columns:36px 24px 1fr; gap:8px; align-items:start; padding:5px 0; border-bottom:1px solid rgba(255,255,255,0.04); font-size:12px; color:#cbd5e1;">\n            <span style="text-align:right; font-weight:700; color:#94a3b8; font-variant-numeric:tabular-nums;">${a(t.clock||"")}</span>\n            <span style="text-align:center;">${e(t)}</span>\n            <span><strong style="color:#fff;">${a((t.athletes||[]).filter(Boolean).join(", ")||t.type_text||"")}</strong>${t.team?`<br><span style="color:#94a3b8; font-size:11px;">${a(t.team)}</span>`:""}</span>\n          </li>`)).join("")}\n        </ul>\n      </div>`}const w=t.head_to_head||[];w.length&&(_+=`<div style="margin-bottom:14px; padding:14px; background:rgba(var(--cl-accent-rgb),0.08); border-left:3px solid var(--cl-accent); border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#6366f1; font-weight:800;">${i("popup.h2h")} (${w.length})</h5>\n        <ul style="margin:0; padding:0; list-style:none;">\n          ${w.slice(0,8).map((e=>{const t=e.date?new Date(e.date).toLocaleDateString(de(this.hass,this._config)):"";return`<li style="display:flex; justify-content:space-between; padding:5px 0; border-bottom:1px solid rgba(255,255,255,0.04); font-size:12px; color:#cbd5e1;">\n              <span>${a(e.home_team)} <strong>${a(e.home_score??"-")}</strong> - <strong>${a(e.away_score??"-")}</strong> ${a(e.away_team)}</span>\n              <span style="color:#94a3b8;">${a(t)}</span>\n            </li>`})).join("")}\n        </ul>\n      </div>`),g.innerHTML=_||`<p style="text-align:center; color:#94a3b8; font-size:13px;">${i("popup.no_events")}</p>`}static get styles(){return[he,ze,ke,s`
      :host {
        --cl-accent: #6366f1;
        --cl-accent-2: #ec4899;
        --cl-live: #ef4444;
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-team",name:"Soccer Live Team Card",description:"Shows the next or current match for your team"}),customElements.define("soccer-live-team-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s`
      .card-config {
        display: flex;
        flex-direction: column;
        gap: 16px;
    ...
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.target.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=t.checked;this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=t.value;this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_numberChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=parseInt(t.value,10);isNaN(a)||this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_news"))).sort())}render(){if(!this._config||!this.hass)return R``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return R`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
    ...
    `}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return R`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(0===t.length)return R`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const i=t[0],a=i.lineup_home||e.attributes.lineup_home||[],n=i.lineup_away||e.attributes.lineup_away||[],s=i.formation_home||e.attributes.formation_home||"",o=i.formation_away||e.attributes.formation_away||"";if(0===a.length&&0===n.length)return R`
      ...
      `;const r=this._starters(a),l=this._bench(a),c=this._starters(n),d=this._bench(n);return R`
      <ha-card>
        <div class="hero-bg"></div>
        ${this.hideHeader?"":R`
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-lineup",name:"Soccer Live Lineup Card",description:"Shows the lineups of both teams for the current or upcoming match"}),customElements.define("soccer-live-lineup-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s`
      .card-config { display: flex; flex-direction: column; gap: 16px; }
      .option { display: flex; align-items: center; justify-content: space-between; gap: 12px; }
      label { font-size: 14px; color: var(--primary-text-color); }
      .field-label { display: block; font-size: 12px; color: var(--secondary-text-color); margin-bottom: 4px; font-weight: 600; }
    ...
    `}}),customElements.define("soccer-live-timeline",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.reverseOrder=!0===e.reverse_order}_t(e,t){return pe(e,de(this.hass,this._config),t)}getCardSize(){return 5}static getConfigElement(){return document.createElement("soccer-live-timeline-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_next",hide_header:!1,reverse_order:!0}}_eventMeta(e){const t=(e.type||"").toLowerCase(),i=(e.type_text||"").toLowerCase();return i.includes("kickoff")||"kickoff"===t?{icon:"⚽",label:this._t("status.kickoff"),cls:"meta"}:i.includes("halftime")||i.includes("intervallo")?{icon:"⏸",label:this._t("status.halftime"),cls:"meta"}:i.includes("start 2nd")||i.includes("secondo tempo")?{icon:"▶",label:this._t("status.second_half"),cls:"meta"}:i.includes("end regular")||i.includes("full time")?{icon:"🏁",label:this._t("status.end"),cls:"meta"}:"goal"===t||e.scoring_play?{icon:"⚽",label:this._t("event.goal"),cls:"goal"}:i.includes("penalty")?{icon:"⚽",label:this._t("timeline.penalty"),cls:"goal"}:i.includes("yellow card")?{icon:"🟨",label:this._t("event.yellow_card"),cls:"yellow"}:i.includes("red card")?{icon:"🟥",label:this._t("event.red_card"),cls:"red"}:"substitution"===t||i.includes("substitution")?{icon:"🔄",label:this._t("event.substitution"),cls:"sub"}:i.includes("var")?{icon:"📺",label:this._t("event.var"),cls:"meta"}:{icon:"·",label:e.type_text||this._t("timeline.event"),cls:"meta"}}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return R`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(0===t.length)return R`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const i=t[0],a=i.key_events||e.attributes.key_events||[];if(0===a.length)return R`
      ...
      `;const n=this.reverseOrder?[...a].reverse():a;return R`
      <ha-card>
        <div class="hero-bg"></div>
        ${this.hideHeader?"":R`
          <div class="tl-header">
        ...
        <div class="tl-body">
          ${n.map((e=>{const t=this._eventMeta(e),a=i.home_team&&e.team===i.home_team,n=i.away_team&&e.team===i.away_team,s=a?"home":n?"away":"meta",o=(e.athletes||[]).filter(Boolean);return R`
    ...
    `}_aggregateFor(e,t){if(!t||!t.name)return null;const i=(e,t)=>e&&t&&t.name?e.home_team===t.name?e.home_score:e.away_team===t.name?e.away_score:null:null;if(e.single)return i(e.single,t);let a=0,n=!1;const s=i(e.leg1,t),o=i(e.leg2,t);return null!=s&&(a+=s,n=!0),null!=o&&(a+=o,n=!0),n?a:null}_renderMiniTie(e){const t=e.team_a||{},i=e.team_b||{},a=this._aggregateFor(e,t),n=this._aggregateFor(e,i),s=e.winner_team,o=s&&t.name&&s===t.name,r=s&&i.name&&s===i.name,l=e.leg1&&"in"===e.leg1.state||e.leg2&&"in"===e.leg2.state||e.single&&"in"===e.single.state,c=!e.leg1&&!e.single,d=t.abbrev||(t.name?t.name.substring(0,3).toUpperCase():"TBD"),p=i.abbrev||(i.name?i.name.substring(0,3).toUpperCase():"TBD");return R`
      <div class="mini-tie ${l?"live":""} ${e.completed?"done":""} ${c?"pending":""}">
        ...
        <div class="mini-team ${r?"winner":""} ${o?"loser":""}">
          ${i.logo?R`<img src="${i.logo}" alt="${i.name}" />`:R`<div class="logo-ph"></div>`}
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-bracket",name:"Soccer Live Bracket Card",description:"Knockout bracket for Champions League, Europa League, and other cup competitions"}),customElements.define("soccer-live-bracket-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return s`
      ...
      h3 { margin: 8px 0 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--secondary-text-color); }
      .hint { font-size: 12px; color: var(--secondary-text-color); }
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.target.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=t.checked;this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const i=t.dataset.configValue,a=t.value;this._config[i]!==a&&this._fireConfigChanged({...this._config,[i]:a})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_bracket"))).sort())}render(){if(!this._config||!this.hass)return R``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return R`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
    ...
    `}}),customElements.define("soccer-live-cannonieri",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.maxItems=e.max_items||10,this.hideHeader=e.hide_header||!1}getCardSize(){return 4}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-cannonieri-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_cannonieri_"}}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return R`
        <ha-card>
          <div class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</div>
        </ha-card>`;const t=(e.attributes.scorers||[]).slice(0,this.maxItems),i=e.attributes.league_name||"",a=e.attributes.league_logo||"";return R`
      <ha-card>
        ${this.hideHeader?"":R`
          <div class="header">
            ${a?R`<img class="league-logo" src="${a}" alt="${i}">`:""}
            <div class="header-text">
              <span class="title">${this._t("card.scorers")}</span>
              ${i?R`<span class="subtitle">${i}</span>`:""}
            </div>
          </div>
        `}
        ...
        `:R`
          <div class="list">
            ${t.map(((e,t)=>R`
              <div class="scorer-row ${t%2==0?"even":""}">
                <span class="rank">${e.rank||t+1}</span>
                ${e.headshot?R`<img class="headshot" src="${e.headshot}" alt="${e.player}" @error=${e=>e.target.style.display="none"}>`:R`<div class="headshot-placeholder"></div>`}
                <div class="player-info">
                  <span class="player-name">${e.player}</span>
                  <span class="team-name">${e.team_name}</span>
                </div>
                ${e.team_logo?R`<img class="team-logo" src="${e.team_logo}" alt="${e.team_name}" @error=${e=>e.target.style.display="none"}>`:R`<div class="team-logo-placeholder"></div>`}
                <div class="goals-block">
                  <span class="goals">${e.goals}</span>
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-cannonieri",name:"Calcio Live · Top Scorers",description:"Top scorers for a league",preview:!1});const Me=["dark","light","red-white","classic","neon","gold"],je=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-cannonieri-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return s`
      .card-config {
        display: flex;
        flex-direction: column;
        gap: 16px;
    ...
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_cannonieri"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){const t=e.target.value;t!==this._config.entity&&this._fire({...this._config,entity:t})}_selectChanged(e){const{configValue:t}=e.target.dataset;if(!t)return;const i=e.target.value;this._config[t]!==i&&this._fire({...this._config,[t]:i})}_numberChanged(e){const{configValue:t}=e.target.dataset;if(!t)return;const i=parseInt(e.target.value,10);isNaN(i)||this._config[t]===i||this._fire({...this._config,[t]:i})}_switchChanged(e){const{configValue:t}=e.target.dataset;if(!t)return;const i=e.target.checked;this._config[t]!==i&&this._fire({...this._config,[t]:i})}render(){if(!this._config||!this.hass)return R``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return R`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
          <label class="field-label">Entity</label>
    ...
    `}}),customElements.define("soccer-live-mini-standings",class extends oe{static get properties(){return{hass:{},_config:{},_selectedGroup:{type:String}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,this._selectedGroup=e.default_group||null,ue(this,e)}getCardSize(){return 3}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-mini-standings-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_classifica_",max_rows:5}}_selectGroup(e){this._selectedGroup=e,this.requestUpdate()}static get styles(){return[he,s`
      ha-card {
        background: var(--cl-bg);
        color: var(--cl-text);
        padding: 12px;
    ...
    `]}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return Ee("⚠️","Entity not found",`Unable to find: ${this._config.entity}`,"Check the entity configuration");const t=e.attributes.standings_groups||[];if(!t.length)return Ee("⚽","No standings data","Unable to fetch league standings","Check if the league has started");const i=t.find((e=>e.name===this._selectedGroup))||t[0];let a=i&&i.standings||[];a=a.sort(((e,t)=>{const i=parseInt(e.pts||e.points||0),a=parseInt(t.pts||t.points||0);if(i!==a)return a-i;const n=parseInt(e.W||e.wins||0),s=parseInt(t.W||t.wins||0);if(n!==s)return s-n;const o=parseInt(e.GD||e.goal_difference||0);return parseInt(t.GD||t.goal_difference||0)-o}));const n=this._config.max_rows||a.length,s=(this._config.highlight_team||"").toLowerCase(),o=e.attributes.league_name||e.attributes.league_abbreviation||"",r=e.attributes.league_logo||"",l=a.slice(0,n),c=t.length>1;return R`
      <ha-card>
        ${this._config.hide_header?"":R`
          <div class="header">
            ${r?R`<img class="league-logo" src="${r}" alt="">`:""}
            <span class="title">${i&&c?i.name:o}</span>
          </div>
        `}
        ...
        ${c?R`
          <div class="groups">
            ${t.map((e=>R`
              <span
                class="group-btn ${e.name===i.name?"active":""}"
        ...
        <table>
          ...
          ${l.map((e=>{const t=s&&e.team_name&&e.team_name.toLowerCase().includes(s),i=(parseInt(e.wins)||0)+(parseInt(e.draws)||0)+(parseInt(e.losses)||0),a=parseInt(e.goal_difference)||0,n=a>0?`+${a}`:`${a}`;return R`
              <tr class="${t?"hl":""}">
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-mini-standings",name:"Soccer Live Mini Standings",description:"Compact standings table with group selector"});const Pe=["dark","light","red-white","classic","neon","gold"],De=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-mini-standings-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s``]}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_classifica"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_numberChanged(e){const t=parseInt(e.target.value,10);isNaN(t)||this._fire({...this._config,[e.target.dataset.configValue]:t})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}_textChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}render(){if(!this._config||!this.hass)return R``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return R`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${Pe.map((e=>R`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${De.map((e=>R`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    `}}),customElements.define("soccer-live-countdown",class extends oe{static get properties(){return{hass:{},_config:{},_isLoading:{type:Boolean},_now:{},_weatherBadge:{},_cachedData:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this._isLoading=!0,this._loadingStarted=Date.now(),this._lastWeatherVenue=null}connectedCallback(){super.connectedCallback(),this._now=new Date,this._timer=setInterval((()=>{this._now=new Date,this.requestUpdate()}),1e3),this._loadWeather()}updated(e){if(e.has("hass")){const e=this.hass?.states[this._config?.entity];e&&"unavailable"!==e.state&&(this._isLoading=!1,Ne.set(this._config.entity,e.attributes))}if(e.has("hass")||e.has("_config")){const e=this.hass?.states[this._config?.entity],t=e?.attributes?.matches?.[0]?.venue;t&&t!==this._lastWeatherVenue&&this._loadWeather()}}async _loadWeather(){if(!this.hass||!this._config)return;const e=this.hass.states[this._config.entity];if(!e||!e.attributes.matches)return;const t=e.attributes.matches[0];if(t&&t.venue){this._lastWeatherVenue=t.venue;try{this._weatherBadge=await Ce(t.venue,this.hass,this._config,t.venue_lat,t.venue_lon),this.requestUpdate()}catch(e){console.warn("Weather load failed:",e)}}}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this._timer)}getCardSize(){return 3}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-countdown-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_next_"}}_parseDate(e){if(!e||"N/A"===e)return null;try{const[t,i]=e.split(" "),a=t.split(/[-\/]/).map(Number),[n,s]=(i||"00:00").split(":").map(Number);if(3===a.length){const[e,t,i]=a;return new Date(i,t-1,e,n,s)}}catch(e){}return null}_getNextMatch(e){const t=e.attributes.matches||[];return t.find((e=>"pre"===e.state))||t.find((e=>"in"===e.state))||t.find((e=>"post"===e.state))||t[0]||null}_countdown(e){const t=this._parseDate(e);if(!t)return null;const i=t-(this._now||new Date);return i<=0?null:{days:Math.floor(i/864e5),hours:Math.floor(i%864e5/36e5),mins:Math.floor(i%36e5/6e4),secs:Math.floor(i%6e4/1e3)}}static get styles(){return[he,ze,ke,s`
      ha-card {
        background: var(--cl-bg);
        color: var(--cl-text);
        padding: 16px;
    ...
    `]}render(){if(!this.hass||!this._config)return Se("Loading...");const e=this.hass.states[this._config.entity];if(!e)return Ne.get(this._config.entity)?Ee("⏱","Offline - showing cached data","Last update: "+(new Date).toLocaleTimeString(),"Waiting for integration to come online"):Ee("⚠️","Entity not found",`Unable to find: ${this._config.entity}`,"Check the entity configuration");if("unavailable"===e.state){const e=Ne.get(this._config.entity);if(!e)return Ee("📡","Sensor unavailable","The integration may not be running","Restart Home Assistant or check the integration");this._cachedData=e.data}if(this._isLoading)return Date.now()-this._loadingStarted>1e4?Ee("⏱",this._t("ui.loading_timeout"),`${this._t("ui.entity_not_responding")}: ${this._config.entity}`,this._t("ui.check_integration")):Se(this._t("ui.loading"));const t=e&&"unavailable"!==e.state?e.attributes:this._cachedData,i=this._getNextMatch({attributes:t});if(!i)return Ae("📅",this._t("ui.off_season"),this._t("ui.off_season_hint"));const a="in"===i.state,n="post"===i.state,s=a||n?null:this._countdown(i.date),o=i.competition_name||e.attributes.league_name||"",r=i.competition_logo||e.attributes.league_logo||"",l=i.venue&&"N/A"!==i.venue?i.venue:"",c=i.venue_city&&"N/A"!==i.venue_city?i.venue_city:"",d=this._t("cd.days")||"days",p=this._t("cd.hrs")||"hrs",h=this._t("cd.min")||"min",g=this._t("cd.sec")||"sec";return R`
      <ha-card>
        ...
        <div class="teams">
          ...
          <div class="center">
            ${a?R`
              ...
              <div class="score">${i.home_score??0} - ${i.away_score??0}</div>
              ${i.clock?R`<div class="minute">${i.clock}</div>`:""}
            `:n?R`
              <div class="ft-badge">FT</div>
              <div class="score">${i.home_score??0} - ${i.away_score??0}</div>
            `:s?R`
              ${i.date?R`<div class="sched-date">${i.date}</div>`:""}
              <div class="countdown">
                ${s.days>0?R`
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-countdown",name:"Soccer Live Match Countdown",description:"Countdown to next match with live score"});const Ve=["dark","light","red-white","classic","neon","gold"],Oe=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-countdown-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s`
      .card-config { display: flex; flex-direction: column; gap: 16px; }
      .option { display: flex; align-items: center; justify-content: space-between; gap: 12px; }
      label { font-size: 14px; color: var(--primary-text-color); }
      .field-label { display: block; font-size: 12px; color: var(--secondary-text-color); margin-bottom: 4px; font-weight: 600; }
    ...
    `]}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_next"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}render(){if(!this._config||!this.hass)return R``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return R`
      <div class="card-config">
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${Ve.map((e=>R`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${Oe.map((e=>R`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    `}}),customElements.define("soccer-live-live-match",class extends oe{static get properties(){return{hass:{},_config:{},_isLoading:{type:Boolean},_cachedData:{}}}constructor(){super(),this._isLoading=!0,this._loadingStarted=Date.now()}connectedCallback(){super.connectedCallback(),this._loadingTimer=setTimeout((()=>this.requestUpdate()),1e4)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._loadingTimer)}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e)}getCardSize(){return 5}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-live-match-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_next_"}}_getMatch(e){const t=e.attributes.matches||[];return t.find((e=>"in"===e.state||"live"===e.status))||t.find((e=>"pre"===e.state||"scheduled"===e.status))||t.find((e=>"post"===e.state))||t[0]||null}_eventIcon(e){if(!e)return"📋";const t=(e||"").toLowerCase();return t.includes("goal")||t.includes("score")?"⚽":t.includes("yellow")?"🟨":t.includes("red")?"🟥":t.includes("sub")||t.includes("substitut")?"🔄":t.includes("pen")?"⚽🎯":"📋"}static get styles(){return[he,ze,s`
    ...
    `]}updated(e){if(e.has("hass")){const e=this.hass?.states[this._config?.entity];e&&"unavailable"!==e.state&&(this._isLoading=!1,Ne.set(this._config.entity,e.attributes))}}render(){if(!this.hass||!this._config)return Se("Loading...");const e=this.hass.states[this._config.entity];if(!e)return Ne.get(this._config.entity)?Ee("⏱","Offline - showing cached data","Last update: "+(new Date).toLocaleTimeString(),"Waiting for integration"):Ee("⚠️","Entity not found",`Unable to find: ${this._config.entity}`,"Check the entity configuration");if("unavailable"===e.state){const e=Ne.get(this._config.entity);if(!e||!e.data.matches)return Ee("📡","Sensor unavailable","The integration may not be running","Restart Home Assistant or check the integration");this._cachedData=e.data}if(this._isLoading)return Date.now()-this._loadingStarted>1e4?Ee("⏱",this._t("ui.loading_timeout"),`${this._t("ui.entity_not_responding")}: ${this._config.entity}`,this._t("ui.check_integration")):Se(this._t("ui.loading"));const t=e&&"unavailable"!==e.state?e.attributes:this._cachedData,i=t?.matches||[],a=this._getMatch({attributes:t});if(!a)return i.length?Ae("⚽",this._t("ui.no_live_match"),this._t("ui.no_live_match_hint")):Ae("📅",this._t("ui.off_season"),this._t("ui.off_season_hint"));const n="in"===a.state||"live"===a.status,s="post"===a.state,o=("pre"===a.state||a.status,a.key_events||a.events||a.match_events||[]),r=a.competition_name||e.attributes.league_name||"",l=a.competition_logo||e.attributes.league_logo||"",c=a.venue&&"N/A"!==a.venue?a.venue:"",d=a.venue_city&&"N/A"!==a.venue_city?a.venue_city:"",p=a.stats||a.statistics||[];return R`
      <ha-card>
        <div class="hero">
          ${a.home_logo?R`<img class="bg-logo home" src="${a.home_logo}" alt="">`:""}
          ${a.away_logo?R`<img class="bg-logo away" src="${a.away_logo}" alt="">`:""}
          ...
          <div class="teams-row">
            ...
            <div class="score-center">
              ${n?R`<div class="live-badge">LIVE</div>`:s?R`<div class="sched-info">FT</div>`:R`<div class="sched-info">${a.date||this._t("match.vs")}</div>`}
              ${n||s?R`<div class="score">${a.home_score??0} - ${a.away_score??0}</div>`:R`<div class="vs-text">${this._t("match.vs")}</div>`}
              ${n&&a.clock?R`<div class="minute">${a.clock}</div>`:""}
            </div>
        ...
        ${p.length>0?R`
          <div class="divider"></div>
          ${p.slice(0,this._config.max_stats||4).map((e=>{const t=parseFloat(e.home??e.homeValue??0)||0,i=t+(parseFloat(e.away??e.awayValue??0)||0);return i>0&&Math.round(t/i*100),R`
              <div class="stats-row">
                <span class="stat-val">${e.home??e.homeValue??""}</span>
                <div class="stat-label">${e.label||e.name||e.type||""}</div>
                <span class="stat-val">${e.away??e.awayValue??""}</span>
              </div>
            `}))}
        `:""}
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-live-match",name:"Soccer Live Match Card",description:"Live match details with events and stats"});const He=["dark","light","red-white","classic","neon","gold"],Fe=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-live-match-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s``]}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_next")||e.includes("soccerlive_all"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_numberChanged(e){const t=parseInt(e.target.value,10);isNaN(t)||this._fire({...this._config,[e.target.dataset.configValue]:t})}render(){if(!this._config||!this.hass)return R``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return R`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${He.map((e=>R`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
    ...
    `}}),customElements.define("soccer-live-multi-team",class extends oe{static get properties(){return{hass:{},_config:{},_isLoading:{type:Boolean},_cachedData:{}}}setConfig(e){if(!e.entities||!e.entities.length)throw new Error("At least one entity required");this._config=e,ue(this,e),this._isLoading=!0,this._loadingStarted=Date.now(),this._lastWeatherVenue=null}connectedCallback(){super.connectedCallback(),this._loadingTimer=setTimeout((()=>this.requestUpdate()),1e4)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._loadingTimer)}updated(e){if(e.has("hass")){const e=this._config?.entities||[],t=e.every((e=>{const t=this.hass?.states[e];return t&&"unavailable"!==t.state}));t&&(this._isLoading=!1,e.forEach((e=>{const t=this.hass?.states[e];t&&Ne.set(e,t.attributes)})))}}getCardSize(){return Math.max(2,(this._config.entities||[]).length+1)}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-multi-team-editor")}static getStubConfig(){return{entities:[]}}_getMatch(e){const t=e.attributes.matches||[];return t.find((e=>"in"===e.state))||t.find((e=>"pre"===e.state))||t.find((e=>"post"===e.state))||t[0]||null}static get styles(){return[he,ze,s`
      ...
      .empty { padding: 16px; text-align: center; color: var(--cl-text-2); }
    `]}_renderMatch(e){const t=this.hass.states[e];if(!t)return R`<div class="match-row"><div class="no-match">${this._t("team.unknown_entity")}: ${e}</div></div>`;const i=this._getMatch(t);if(!i)return R`<div class="match-row"><div class="no-match">${this._t("team.no_match")} (${e})</div></div>`;const a="in"===i.state,n="post"===i.state,s=a||n,o=i.date||"";return R`
      <div class="match-row">
        <div class="team-block">
          ${i.home_logo?R`<img class="team-logo" src="${i.home_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
          <span class="team-name">${i.home_team||"?"}</span>
        ...
        <div class="score-block">
          ${a?R`<div><span class="live-dot"></span><span class="status">${i.clock||"LIVE"}</span></div>`:""}
          ${s?R`<div class="score">${i.home_score??0} - ${i.away_score??0}</div>`:R`<div class="status">${o||this._t("match.vs")}</div>`}
    ...
    `}render(){if(!this.hass||!this._config)return Se("Loading...");const e=this._config.entities||[];if(!e.length)return Ee("⚽","No entities","No entities configured","Add at least one team entity");if(this._isLoading)return Date.now()-this._loadingStarted>1e4?Ee("⏱",this._t("ui.loading_timeout"),this._t("ui.entity_not_responding"),this._t("ui.check_integration")):Se(this._t("ui.loading"));const t=e.filter((e=>!this.hass.states[e])),i=e.some((e=>"unavailable"===this.hass.states[e]?.state));return t.length>0&&!i?Ne.get(e[0])?Ee("⏱","Offline - showing cached data","Last update: "+(new Date).toLocaleTimeString(),"Waiting for integration"):Ee("⚠️","Entity not found",`Unable to find: ${t[0]}`,"Check your entity configuration"):R`
      <ha-card>
        ${this._config.hide_header?"":R`<div class="title">${this._config.title||this._t("card.my_teams")}</div>`}
        ${e.map((e=>this._renderMatch(e)))}
      </ha-card>
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-multi-team",name:"Soccer Live Multi Team",description:"Shows multiple teams' matches in one card"});const Ie=["dark","light","red-white","classic","neon","gold"],qe=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-multi-team-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},_allEntities:{type:Array}}}constructor(){super(),this._allEntities=[]}static get styles(){return[ve,s`
    ...
    `]}setConfig(e){this._config={...e,entities:[...e.entities||[]]}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this._allEntities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_next")||e.includes("all_mixed"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}_textChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_entityChanged(e,t){const i=[...this._config.entities||[]];i[t]=e.target.value,this._fire({...this._config,entities:i})}_removeEntity(e){const t=[...this._config.entities||[]];t.splice(e,1),this._fire({...this._config,entities:t})}_addEntity(){const e=[...this._config.entities||[],""];this._fire({...this._config,entities:e})}render(){if(!this._config||!this.hass)return R``;const e=this._config.entities||[];return R`
      <div class="card-config">
        <h3>Teams</h3>
        ...
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${qe.map((e=>R`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    `}}),customElements.define("soccer-live-team-competitions",class extends oe{static get properties(){return{hass:{},_config:{},_selectedComp:{type:String}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,this._selectedComp=e.default_comp||null,ue(this,e)}getCardSize(){return 4}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-team-competitions-editor")}static getStubConfig(){return{entity:"sensor.soccer_live_all_mixed_"}}_selectComp(e){this._selectedComp=e,this.requestUpdate()}_groupByCompetition(e){const t={};for(const i of e){const e=i.league_name||i.competition_name||"Other";t[e]||(t[e]={key:e,name:e,logo:i.league_logo||i.competition_logo||"",matches:[]}),t[e].matches.push(i)}return Object.values(t).map((e=>{const t=e.matches.find((e=>"in"===e.state)),i=e.matches.find((e=>"pre"===e.state)),a=[...e.matches].reverse().find((e=>"post"===e.state));return{...e,featured:t||i||a||e.matches[0]}})).filter((e=>e.featured)).sort(((e,t)=>("in"===e.featured.state?0:"pre"===e.featured.state?1:2)-("in"===t.featured.state?0:"pre"===t.featured.state?1:2)))}static get styles(){return[he,s`
      ha-card {
        background: var(--cl-bg);
        color: var(--cl-text);
        padding: 0;
    ...
    `]}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return Ee("⚠️","Entity not found",`Unable to find: ${this._config.entity}`,"Check the entity configuration");const t=e.attributes.matches||[];if(!t.length)return Ee("⚽","No match data","Unable to find matches","Check if the team has scheduled matches");const i=this._groupByCompetition(t),a=i.find((e=>e.key===this._selectedComp))||i[0],n=this._config.team_name||e.attributes.team_name||"",s=e.attributes.team_logo||"",o=a.featured;return R`
      <ha-card>
        ${this._config.hide_header?"":R`
        ...
        ${i.length>1?R`
          <div class="comp-tabs">
            ${i.map((e=>R`
              <span
                class="comp-tab ${e.key===a.key?"active":""}"
        ...
        ${a&&o?R`
          <div class="match-display">
            ${a.logo?R`<img class="comp-logo" src="${a.logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-team-competitions",name:"Soccer Live Team Competitions",description:"All team competitions with tab selector"});const Re=["dark","light","red-white","classic","neon","gold"],Be=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-team-competitions-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s`
      .hint { font-size: 11px; color: var(--secondary-text-color); }
    ...
    `}}),customElements.define("soccer-live-live-commentary",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e)}getCardSize(){return 5}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-live-commentary-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_commentary_"}}static get styles(){return[he,s`
      ...
      .empty { padding: 20px; text-align: center; color: var(--cl-text-2); }
    `]}_getEventIcon(e){if(!e)return"📋";const t=e.toLowerCase();return t.includes("goal")?"⚽":t.includes("yellow")?"🟨":t.includes("red")?"🟥":t.includes("substitut")||t.includes("sub")?"🔄":t.includes("penaalty")||t.includes("pen")?"⚽":t.includes("own goal")?"🔴":"📋"}render(){if(!this.hass||!this._config)return R``;const e=this.hass.states[this._config.entity];if(!e)return Ee("⚠️",this._t("ui.unknown_entity"),`${this._config.entity}`,this._t("ui.wrong_entity_type_hint"));if("unavailable"===e.state)return Ee("📡",this._t("ui.sensor_unavailable"),"",this._t("ui.check_integration"));const t=e.attributes.commentary||[],i=(e.attributes.matches||[]).find((e=>"in"===e.state));if(!i&&!t.length)return Ae("🎙️",this._t("ui.no_live_match"),this._t("ui.no_live_match_hint"));const a=i?.home_team||e.attributes.home_team||"?",n=i?.away_team||e.attributes.away_team||"?",s=i?.home_score??e.attributes.home_score??0,o=i?.away_score??e.attributes.away_score??0,r=e.attributes.match_status||"",l=(e.attributes.league_info||[{}])[0].abbreviation||"",c="in"===r||i&&"in"===i.state,d=i?i.clock:"",p=i?i.home_logo:"",h=i?i.away_logo:"";return R`
      <ha-card>
        <div class="header">
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-live-commentary",name:"Soccer Live Commentary",description:"Live match commentary and events"});const Ue=["dark","light","red-white","classic","neon","gold"],Ge=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-live-commentary-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s`
      .hint { font-size: 11px; color: var(--secondary-text-color); }
    `]}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_commentary"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}render(){if(!this._config||!this.hass)return R``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return R`
      <div class="card-config">
        <h3>Sensor</h3>
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${Ue.map((e=>R`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
