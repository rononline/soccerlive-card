...
`,ge=["dark","light","red-white","classic","neon","gold"];function ue(e,t){const a=function(e){const t=e&&"string"==typeof e.skin?e.skin.toLowerCase():"dark";return ge.includes(t)?t:"dark"}(t);return e&&e.setAttribute&&e.setAttribute("data-skin",a),a}const me=(e,t)=>Array.from({length:t-e+1},((t,a)=>e+a)),fe={serie_a:{match:(e,t)=>"ita.1"===e||t.includes("italian_serie_a"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},premier_league:{match:(e,t)=>"eng.1"===e||t.includes("english_premier"),champions:[1,2,3,4,5],europa:[6],conference:[7],relegation:"bottom3"},laliga:{match:(e,t)=>"esp.1"===e||t.includes("spanish_la_liga")||t.includes("spanish_laliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},bundesliga:{match:(e,t)=>"ger.1"===e||t.includes("german_bundesliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:[17,18]},ligue_1:{match:(e,t)=>"fra.1"===e||t.includes("french_ligue_1"),champions:[1,2,3],europa:[4],conference:[5],relegation:[17,18]},eredivisie:{match:(e,t)=>"ned.1"===e||t.includes("dutch_eredivisie"),champions:[1,2],europa:[3],conference:[4,5],relegation:[17,18]},primeira_liga:{match:(e,t)=>"por.1"===e||t.includes("portuguese_primeira"),champions:[1,2],europa:[3],conference:[4],relegation:[17,18]},ucl_league_phase:{match:(e,t)=>"uefa.champions"===e||t.includes("uefa_champions_league"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},uel_league_phase:{match:(e,t)=>"uefa.europa"===e||t.includes("uefa_europa_league"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},uecl_league_phase:{match:(e,t)=>"uefa.europa.conf"===e||t.includes("uefa_conference"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},world_cup:{match:(e,t)=>"fifa.world"===e||t.includes("fifa_world_cup")||t.includes("world_cup"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"🏆",accent:"world_cup"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},uefa_euro:{match:(e,t)=>"uefa.euro"===e||t.includes("uefa_euro")||t.includes("european_championship"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"⭐",accent:"uefa_euro"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},copa_america:{match:(e,t)=>"conmebol.america"===e||t.includes("copa_america")||t.includes("conmebol_america"),champions:[1,2],europa:[],conference:[],relegation:"bottom2",kind:"cup_group",hero:{icon:"🏆",accent:"copa_america"},labels:{champions:"zone.qualified",europa:null,conference:null,relegation:"zone.eliminated"}}};customElements.define("soccer-live-classifica",class extends oe{static get properties(){return{hass:{},_config:{},maxTeamsVisible:{type:Number},hideHeader:{type:Boolean},selectedGroup:{type:String},_eventSubscriptions:{type:Array},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.maxTeamsVisible=e.max_teams_visible?e.max_teams_visible:10,this.hideHeader=e.hide_header||!1,this.selectedGroup=e.selected_group||"",this.showEventToasts=!0===e.show_event_toasts,this.highlightTeam=(e.highlight_team||e.my_team||"").toLowerCase(),this.showStats=!1!==e.show_stats,this.showGoalsFor=!0===e.show_goals_for,this.compactMode=!0===e.compact_mode,this.compactTop=parseInt(e.compact_top)||5,this.compactBottom=parseInt(e.compact_bottom)||3,this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null}_t(e,t){return pe(e,de(this.hass,this._config),t)}connectedCallback(){super.connectedCallback(),this._subscribeToEvents()}disconnectedCallback(){super.disconnectedCallback(),this._toastTimer&&clearTimeout(this._toastTimer),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass&&this.hass.connection&&(this._eventSubscriptions=[],["soccer_live_goal","soccer_live_yellow_card","soccer_live_red_card"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleCalcioLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this._config.entity||"",a=e.competition_code;if(!a)return!1;const i=a.replace(/\./g,"_").toLowerCase();return t.toLowerCase().includes(i)}_handleCalcioLiveEvent(e){const t=e.event_type,a=e.data;this._eventBelongsToThisCard(a)&&this.showEventToasts&&this._showEventToast(t,a)}_showEventToast(e,t){let a="",i="goal";"soccer_live_goal"===e?(a=`<strong>${this._t("event.goal").toUpperCase()}!</strong> ${t.player} · ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="goal"):"soccer_live_yellow_card"===e?(a=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="yellow"):"soccer_live_red_card"===e?(a=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="red"):"soccer_live_match_finished"===e&&(a=`<strong>${this._t("status.finished")}!</strong> ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="finished"),a&&(this._toastMessage=a,this._toastVariant=i,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}getCardSize(){return 5}static getConfigElement(){return document.createElement("soccer-live-classifica-editor")}static getStubConfig(){return{entity:"sensor.soccerlive",max_teams_visible:10,hide_header:!1,selected_group:"",show_event_toasts:!1}}_getZoneConfig(){if(this._config.zone_config)return this._config.zone_config;if(this._config.zone_preset&&fe[this._config.zone_preset])return fe[this._config.zone_preset];return this._inferPresetFromEntity()||{champions:[],europa:[],conference:[],relegation:null}}_getZoneLabels(){const e=this._getZoneConfig().labels||{};return{champions:void 0!==e.champions?e.champions:"zone.champions",europa:void 0!==e.europa?e.europa:"zone.europa",conference:void 0!==e.conference?e.conference:"zone.conference",relegation:void 0!==e.relegation?e.relegation:"zone.relegation"}}_hasZonePositions(e){return!!e&&(Array.isArray(e)?e.length>0:"string"==typeof e&&/^bottom\d+$/.test(e))}_inferPresetFromEntity(){const e=(this._config.entity||"").toLowerCase(),t=this.hass&&this._config.entity?this.hass.states[this._config.entity]:null,a=t&&t.attributes?String(t.attributes.competition_code||"").toLowerCase():"";for(const[,t]of Object.entries(fe))if(t.match&&t.match(a,e))return t;return null}_positionInZone(e,t,a){if(!a)return!1;const i=String(a).match(/^bottom(\d+)$/);if(i){const a=parseInt(i[1],10);return t&&e>t-a}return!!Array.isArray(a)&&a.includes(Number(e))}_translatePhase(e){return e?{"regular-season":this._t("phase.regular_season"),"regular season":this._t("phase.regular_season"),"group-stage":this._t("phase.group_stage"),"group stage":this._t("phase.group_stage"),playoffs:this._t("phase.playoffs")}[String(e).toLowerCase()]||e:""}_shouldShowPhase(e){return!!e&&("regular-season"!==String(e).toLowerCase()&&!/\d{4}/.test(e))}_isCupGroupStage(){const e=this._getZoneConfig();return e&&"cup_group"===e.kind}_groupHasNoMatches(e){if(!e||!e.length)return!1;const t=e=>{if(null==e||""===e)return 0;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?0:t};return e.every((e=>t(e.wins)+t(e.draws)+t(e.losses)===0))}_zoneClass(e,t){const a=this._getZoneConfig();return this._positionInZone(e,t,a.champions)?1!==e||this._isCupGroupStage()?"zone-cl":"zone-cl rank-first":this._positionInZone(e,t,a.europa)?"zone-el":this._positionInZone(e,t,a.conference)?"zone-conf":this._positionInZone(e,t,a.relegation)?"zone-rel":"zone-default"}_sortStandings(e,t){let a=(e||[]).filter((e=>null!=e.rank));return t.includes("MLS")?(a=a.slice().sort(((e,t)=>t.points!==e.points?t.points-e.points:t.goal_difference!==e.goal_difference?t.goal_difference-e.goal_difference:t.goals_for-e.goals_for)),a.forEach(((e,t)=>{e.rank=t+1}))):a=a.slice().sort(((e,t)=>e.rank-t.rank)),a}_currentGroup(e){return e.find((e=>e.name===this.selectedGroup))||e[0]}render(){if(!this.hass||!this._config)return B``;const e=this._config.entity,t=this.hass.states[e];if(!t)return B`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;const a=t.attributes.season||"",i=t.attributes.league_abbreviation&&"N/A"!==t.attributes.league_abbreviation?t.attributes.league_abbreviation:null,n=i&&t.attributes.league_name?a.replace(t.attributes.league_name,i).trim():a,s=t.attributes.standings_groups||[],o=!this.selectedGroup&&s.length>1,r=this._currentGroup(s),l=this._sortStandings(r?r.standings:[],n),c=l.length,d=48*Math.min(this.maxTeamsVisible,c)+50,p=this.highlightTeam?(l.find((e=>e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam)))||{}).rank:null,h=Math.round(l.reduce(((e,t)=>e+(parseInt(t.games_played)||0)),0)/2),g=l.reduce(((e,t)=>e+(parseInt(t.goals_for)||0)),0),u=(t.attributes.standings_groups||[]).some((e=>(e.standings||[]).some((e=>(parseInt(e.games_played)||0)>0)))),m=!u&&c>0&&l.every((e=>0===parseInt(e.wins??"0")&&0===parseInt(e.draws??"0")&&0===parseInt(e.losses??"0")));return B`
    ...
    `}_renderFullTable(e,t){let a=e,i=null;if(this.compactMode&&t>this.compactTop+this.compactBottom){const n=e.slice(0,this.compactTop),s=e.slice(t-this.compactBottom),o=t-this.compactTop-this.compactBottom,r=this.highlightTeam?e.slice(this.compactTop,t-this.compactBottom).find((e=>e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam))):null;a=[...n,...r?[r]:[],{_separator:!0,hiddenCount:o},...s],i=!0}return B`
      <table class="standings-table">
        ...
        <tbody>
          ${a.map((e=>{if(e._separator)return B`
              ...
              <tr class="${this._zoneClass(e.rank,t)} ${a?"highlighted-team":""}">
                ...
                <td class="team-cell">
                  ...
                  <div class="tname-group">
                    ...
                    ${this.showGoalsFor&&e.goals_for&&parseInt(e.goals_for)>=0?B`<span class="goals-for-hint">⚽ ${e.goals_for}</span>`:""}
                  </div>
                </td>
                <td>${l??"-"}</td>
                <td>${n??"-"}</td>
    ...
    `}_renderCompactTable(e,t){return B`
      <table class="standings-table compact">
        ...
        <tbody>
          ${e.map((e=>{const a=(e=>{if(null==e||""===e)return null;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?null:t})(e.goal_difference),i=null===a?"":a>0?"gd-pos":a<0?"gd-neg":"",n=null===a?"-":a>0?`+${a}`:`${a}`;return B`
    ...
    `}_renderHeader(e,t,a,i,n,s){const o=this._getZoneConfig(),r=this._isCupGroupStage(),l=o&&o.hero?o.hero:null,c=e.attributes.league_abbreviation&&"N/A"!==e.attributes.league_abbreviation?e.attributes.league_abbreviation:null,d=c&&t?t.replace(c,"").trim():t&&"n/a"!==t.toLowerCase()?t:"",p=n?this._t("phase.group_stage"):this._shouldShowPhase(a&&a.name)?this._translatePhase(a.name):"",h=[];c&&h.push(this._t("card.standings")),d&&h.push(d),p&&h.push(p);let g=0;if(n)for(const e of i)g+=(e.standings||[]).filter((e=>null!=e.rank)).length;return B`
      <div class="top-bar ${r?"top-bar-cup":""} ${l?`accent-${l.accent}`:""}">
        ${l&&l.icon?B`<div class="hero-icon">${l.icon}</div>`:""}
        <div class="league-title">
          <h2>${c||e.state}</h2>
          <div class="sub">${h.join(" · ")}</div>
        </div>
        ${s?B`<span class="highlight-pos-badge">${s}e</span>`:""}
        ${n&&r?B`
    ...
    `:""}_renderGroupsGrid(e,t){const a=this._isCupGroupStage();return B`
      <div class="groups-grid ${a?"groups-grid-cup":""}">
        ${e.map((e=>{const a=this._sortStandings(e.standings||[],t),i=this._groupHasNoMatches(a);return B`
            <div class="group-cell ${i?"group-cell-pending":""}">
              <div class="group-title">
                <span>${e.name}</span>
                ${i?B`<span class="group-pending-badge">${this._t("hero.not_started")}</span>`:""}
              </div>
...
`;customElements.define("soccer-live-classifica-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array},groups:{type:Array}}}constructor(){super(),this.entities=[],this.groups=[]}static get styles(){return[ve,s`
    ...
    `}}),customElements.define("soccer-live-matches",class extends oe{static get properties(){return{hass:{},_config:{},showPopup:{type:Boolean},activeMatch:{type:Object},_eventSubscriptions:{type:Array},_recentEventMatches:{type:Object},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}constructor(){super(),this._recentEventMatches=new Map,this._eventSubscriptions=[],this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.maxEventsVisible=e.max_events_visible?e.max_events_visible:5,this.maxEventsTotal=e.max_events_total?e.max_events_total:50,this.showFinishedMatches=void 0===e.show_finished_matches||e.show_finished_matches,this.hideHeader=void 0!==e.hide_header&&e.hide_header,this.hidePastDays=void 0!==e.hide_past_days?e.hide_past_days:0,this.reverseOrder=!0===e.reverse_order,this.showEventToasts=!0===e.show_event_toasts,this.myTeam=(e.my_team||"").toLowerCase(),this.showLiveTicker=!1!==e.show_live_ticker,this.activeMatch=null,this.showPopup=!1}_t(e,t){return pe(e,de(this.hass,this._config),t)}connectedCallback(){super.connectedCallback(),this._subscribeToEvents()}disconnectedCallback(){super.disconnectedCallback(),this._toastTimer&&clearTimeout(this._toastTimer),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass&&this.hass.connection&&(this._eventSubscriptions=[],["soccer_live_goal","soccer_live_yellow_card","soccer_live_red_card"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleCalcioLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this.hass.states[this._config.entity];return!!t&&(t.attributes.matches||[]).some((t=>t.home_team===e.home_team&&t.away_team===e.away_team))}_handleCalcioLiveEvent(e){const t=e.event_type,a=e.data;if(!this._eventBelongsToThisCard(a))return;const i=`${a.home_team}_${a.away_team}`;this._recentEventMatches.set(i,"soccer_live_goal"===t?"goal":"card"),this.requestUpdate(),setTimeout((()=>{this._recentEventMatches.delete(i),this.requestUpdate()}),5e3),"soccer_live_goal"===t&&requestAnimationFrame((()=>this._triggerGoalCelebration())),this.showEventToasts&&this._showEventToast(t,a)}_triggerGoalCelebration(){const e=this.shadowRoot&&this.shadowRoot.querySelector("ha-card");if(!e)return;e.querySelectorAll(".confetti").forEach((e=>e.remove()));const t=["#ec4899","#6366f1","#06b6d4","#fbbf24","#10b981","#ef4444"],a=["⚽","🎉","✨","🔥","⭐"];for(let i=0;i<28;i++){const i=document.createElement("div");i.className="confetti",Math.random()>.55?(i.textContent=a[Math.floor(Math.random()*a.length)],i.style.fontSize=12+10*Math.random()+"px",i.style.background="transparent"):(i.style.background=t[Math.floor(Math.random()*t.length)],i.style.borderRadius=Math.random()>.5?"50%":"2px"),i.style.setProperty("--dx",380*(Math.random()-.5)+"px"),i.style.setProperty("--dy",200*Math.random()+80+"px"),i.style.animationDelay=.4*Math.random()+"s",e.appendChild(i),setTimeout((()=>i.remove()),2200)}}_showEventToast(e,t){let a="",i="goal";"soccer_live_goal"===e?(a=`<strong>${this._t("event.goal").toUpperCase()}!</strong> ${t.player} · ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="goal"):"soccer_live_yellow_card"===e?(a=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="yellow"):"soccer_live_red_card"===e&&(a=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="red"),a&&(this._toastMessage=a,this._toastVariant=i,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}getCardSize(){return 4}static getConfigElement(){return document.createElement("soccer-live-matches-editor")}static getStubConfig(){return{entity:"sensor.soccerlive",max_events_visible:5,max_events_total:50,hide_past_days:0,show_finished_matches:!0,hide_header:!1,show_event_toasts:!1}}_parseMatchDate(e){if(!e)return null;const[t,a]=e.split(" "),[i,n,s]=t.split(/[-\/]/).map(Number),[o,r]=a?a.split(":").map(Number):[0,0];return new Date(s,n-1,i,o,r)}_matchTimeLabel(e){if("in"===e.state)return e.clock&&"N/A"!==e.clock?e.clock:"LIVE";if("post"===e.state)return"FT";if(e.date){const t=e.date.split(" ");return t[1]||t[0]}return"—"}_matchScore(e,t){if("pre"===e.state)return"-";const a=e["home"===t?"home_score":"away_score"];return null==a||"N/A"===a?"-":a}_isWinner(e,t){if("pre"===e.state)return null;const a=parseInt(e.home_score),i=parseInt(e.away_score);return isNaN(a)||isNaN(i)||a===i?null:"home"===t?a>i:i>a}_dayKey(e){if(!e.date)return"—";const t=this._parseMatchDate(e.date);if(!t)return e.date.split(" ")[0]||"—";const a=new Date;a.setHours(0,0,0,0);const i=new Date(t);i.setHours(0,0,0,0);const n=Math.round((i-a)/864e5);if(0===n)return"⚡ "+this._t("time.today");if(-1===n)return this._t("time.yesterday");if(1===n)return this._t("time.tomorrow");const s=this._t("month."+(i.getMonth()+1));return`${i.getDate()} ${s}`}showDetails(e){this.activeMatch=e,this.showPopup=!0}closePopup(){this.showPopup=!1}separateEvents(e){const t=[],a=[],i=[];return e.forEach((e=>{const n=String(e||"");n.includes("Goal")||n.includes("Penalty - Scored")?t.push(this.formatMatchEvent(n)):n.includes("Yellow Card")?a.push(this.formatMatchEvent(n)):n.includes("Red Card")&&i.push(this.formatMatchEvent(n))})),{goals:t,yellowCards:a,redCards:i}}formatMatchEvent(e){const t=e=>this._t(e);let a=String(e||"").trim();a=a.replace(/^Goal\s*-\s*/i,"").replace(/^Yellow Card\s*-\s*/i,"").replace(/^Red Card\s*-\s*/i,"").replace(/^Penalty - Scored\s*-\s*/i,`${t("event.penalty")} - `).replace(/^Header\s*-\s*/i,`${t("event.header")} - `).replace(/^Shot\s*-\s*/i,`${t("event.shot")} - `).replace(/^Free-kick\s*-\s*/i,`${t("event.free_kick")} - `).replace(/^Penalty\s*-\s*/i,`${t("event.penalty")} - `),a=a.replace(/^([^:]+):\s*/,"$1 ");const i=[t("event.header"),t("event.shot"),t("event.penalty"),t("event.free_kick")].map((e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")));return a=a.replace(new RegExp(`^(${i.join("|")})\\s*-\\s*(.+)$`,"i"),((e,t,a)=>`${a} (${t.toLowerCase()})`)),a=a.replace(/\bN\/A\b/g,t("generic.unknown")),a}render(){if(!this.hass||!this._config)return B``;const e=this._config.entity,t=this.hass.states[e];if(!t)return B`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;let a=t.attributes.matches||[];const i=t.attributes.league_info?t.attributes.league_info[0]:null,n=t.attributes.team_logo||null;if(this.showFinishedMatches||(a=a.filter((e=>"Full Time"!==e.status))),a=a.slice().sort(((e,t)=>{const a=this._parseMatchDate(e.date)||new Date(0),i=this._parseMatchDate(t.date)||new Date(0);return this.reverseOrder?i-a:a-i})),this.hidePastDays>0){const e=new Date;e.setDate(e.getDate()-this.hidePastDays),a=a.filter((t=>{const a=this._parseMatchDate(t.date);return!a||a>=e}))}const s=a.slice(0,this.maxEventsTotal);if(0===s.length)return B`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const o=s.filter((e=>"in"===e.state)).length,r=new Set(s.map((e=>e.league_name)).filter((e=>e&&"N/A"!==e))),l=r.size>1,c=[];let d=null;s.forEach((e=>{const t=this._dayKey(e);if(t!==d){d=t;const a=this._parseMatchDate(e.date);let i=null;if(a){const e=new Date;e.setHours(0,0,0,0);const t=new Date(a);t.setHours(0,0,0,0),i=Math.round((t-e)/864e5)}c.push({key:t,dayDiff:i,matches:[e]})}else c[c.length-1].matches.push(e)}));const p=Math.max(80*this.maxEventsVisible,240),h=s.filter((e=>"in"===e.state)),g=h.map((e=>`${e.home_abbrev||e.home_team}  ${e.home_score??"-"} - ${e.away_score??"-"}  ${e.away_abbrev||e.away_team}`)).join("     ·     ");return B`
      <ha-card>
        ...
        ${this.showLiveTicker&&h.length>0?B`
        ...
        ${this.hideHeader?"":B`
          <div class="matches-header">
            ${i&&i.logo_href?B`<img class="league-logo" src="${i.logo_href}" alt="${i.abbreviation||""}" />`:n?B`<img class="league-logo" src="${n}" alt="" />`:""}
        ...
        <div class="scroll-content" style="max-height: ${p}px;">
          ${c.map((e=>B`
            <div class="day-divider ${0===e.dayDiff?"today":-1===e.dayDiff?"yesterday":1===e.dayDiff?"tomorrow":""}">
              ${e.key}
              ${null!==e.dayDiff&&e.dayDiff>1?B`<span class="day-rel">· over ${e.dayDiff} d</span>`:""}
            </div>
            ${e.matches.map((e=>{const t=`${e.home_team}_${e.away_team}`,a="in"===e.state,i=this._recentEventMatches.get(t),n=this._isWinner(e,"home"),s=this._isWinner(e,"away"),o=e.broadcast&&""!==e.broadcast&&"N/A"!==e.broadcast?e.broadcast:"",r="pre"===e.state,c=this.myTeam&&e.home_team&&e.home_team.toLowerCase().includes(this.myTeam),d=this.myTeam&&e.away_team&&e.away_team.toLowerCase().includes(this.myTeam);return B`
                <div class="match-row ${a?"live":""} ${"goal"===i?"goal-pulse":""} ${"card"===i?"card-pulse":""}"
                  ...
                  <div class="match-teams">
                    ...
                    ${o&&r||l&&e.league_name&&"N/A"!==e.league_name?B`
                      <div class="row-extras">
                        ${l&&e.league_name&&"N/A"!==e.league_name?B`
    ...
    `}updated(e){(e.has("showPopup")||e.has("activeMatch"))&&this.renderPopupToBody()}renderPopupToBody(){if(!this.showPopup||!this.activeMatch){const e=document.getElementById("soccer-live-matches-popup");return void(e&&e.remove())}let e=document.getElementById("soccer-live-matches-popup");e||(e=document.createElement("div"),e.id="soccer-live-matches-popup",e.style.cssText="\n        position: fixed; inset: 0;\n        display: flex; justify-content: center; align-items: center;\n        z-index: 999999;\n        background: rgba(0,0,0,0.7);\n        backdrop-filter: blur(8px);\n        overflow: auto;\n      ",e.addEventListener("click",(t=>{t.target===e&&(this.showPopup=!1)})),document.body.appendChild(e));const t=this.activeMatch,a=e=>this._t(e),i=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),n=getComputedStyle(this),s=n.getPropertyValue("--cl-bg").trim()||"#1a1f2e",o=n.getPropertyValue("--cl-text").trim()||"#f8fafc",r=n.getPropertyValue("--cl-text-2").trim()||"#94a3b8",l=n.getPropertyValue("--cl-accent").trim()||"#6366f1",c=n.getPropertyValue("--cl-accent-2").trim()||"#ec4899",d=n.getPropertyValue("--cl-divider").trim()||"rgba(255,255,255,0.08)";e.innerHTML=`\n      <div style="background:${s}; padding:24px; border-radius:20px; width:90%; max-width:560px; max-height:85vh; overflow-y:auto; border:1px solid ${d}; box-shadow:0 24px 64px rgba(0,0,0,0.6); margin:auto; color:${o}; font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display',sans-serif;">\n        <h3 style="margin:0 0 20px; font-size:22px; font-weight:800; letter-spacing:-0.02em; background:linear-gradient(135deg,${l},${c}); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color:transparent;">${a("popup.match_details")}</h3>\n        <div style="display:flex; justify-content:center; align-items:center; gap:18px; margin-bottom:24px;">\n          <img style="width:64px; height:64px; object-fit:contain;" src="${i(t.home_logo)}" alt="${i(t.home_team)}" />\n          <div style="text-align:center;">\n            <div style="font-size:38px; font-weight:900; letter-spacing:-0.04em; line-height:1;">${i(t.home_score&&"N/A"!==t.home_score?t.home_score:"-")} <span style="opacity:0.4;">-</span> ${i(t.away_score&&"N/A"!==t.away_score?t.away_score:"-")}</div>\n            <div style="font-size:12px; color:${r}; margin-top:8px; font-weight:600;">${i(t.clock&&"N/A"!==t.clock?t.clock:t.status&&"N/A"!==t.status?t.status:"")}</div>\n          </div>\n          <img style="width:64px; height:64px; object-fit:contain;" src="${i(t.away_logo)}" alt="${i(t.away_team)}" />\n        </div>\n        <p style="text-align:center; color:${r}; font-size:14px; margin:0 0 20px;"><strong>${i(t.home_team)}</strong> tegen <strong>${i(t.away_team)}</strong></p>\n        <div id="matches-events-container"></div>\n        <button id="popup-close-btn" style="background:linear-gradient(135deg,${l},${c}); color:white; padding:12px 20px; border:none; border-radius:12px; cursor:pointer; margin-top:20px; font-weight:800; width:100%; font-size:14px;">${a("generic.close")}</button>\n      </div>\n    `;const p=e.querySelector("#popup-close-btn");p&&p.addEventListener("click",(()=>{this.showPopup=!1}));const h=e.querySelector("#matches-events-container"),{goals:g,yellowCards:u,redCards:m}=this.separateEvents(t.match_details||[]),f=(e,t,a)=>t.length?`<div style="margin-bottom:14px; padding:14px; background:${a.bg}; border-left:3px solid ${a.border}; border-radius:10px;">\n        <h5 style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:${a.border}; font-weight:800;">${e}</h5>\n        <ul style="margin:0; padding-left:18px; font-size:13px; color:#cbd5e1;">${t.map((e=>`<li style="margin:4px 0;">${i(e)}</li>`)).join("")}</ul>\n      </div>`:"";let v="";v+=f(a("event.goal"),g,{bg:`rgba(${l.replace("#","")},0.1)`,border:l}),v+=f(a("event.yellow_card"),u,{bg:"rgba(245,158,11,0.1)",border:"#f59e0b"}),v+=f(a("event.red_card"),m,{bg:"rgba(239,68,68,0.1)",border:"#ef4444"}),h.innerHTML=v||`<p style="text-align:center; color:#94a3b8; font-size:13px;">${a("popup.no_events")}</p>`}static get styles(){return[he,s`
      :host {
        --cl-accent: #6366f1;
        --cl-accent-2: #ec4899;
        --cl-live: #ef4444;
...
`;async function Ce(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,n=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null;if(!e||"N/A"===e)return B``;try{let s=null;if(s=null!==i&&null!==n?{lat:i,lon:n}:await function(e){if(!e||"N/A"===e)return null;if(be.has(e))return be.get(e);const t=ye[e]||null;return t&&(we(be),be.set(e,t)),t}(e),!s)return B``;const o=await async function(e,t){const a=`${e},${t}`;if(_e.has(a)){const e=_e.get(a);if(Date.now()-e.timestamp<36e5)return e.data}try{const s=await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${e}&longitude=${t}&current=temperature_2m,weather_code,wind_speed_10m&timezone=auto`),o=await s.json();if(o.current){const e={temp:Math.round(o.current.temperature_2m),code:o.current.weather_code,wind:(n=o.current.wind_speed_10m,n<1?0:n<6?1:n<12?2:n<20?3:n<29?4:n<39?5:n<50?6:n<62?7:n<75?8:n<89?9:n<103?10:n<118?11:12),wind_unit:"BFT",icon:(i=o.current.weather_code,i&&0!==i&&1!==i?2===i?"⛅":3===i?"☁️":45===i||48===i?"🌫️":i>=51&&i<=55?"🌦️":i>=61&&i<=65?"🌧️":i>=71&&i<=77?"🌨️":i>=80&&i<=82?"🌧️":85===i||86===i?"🌨️":95===i||96===i||99===i?"⛈️":"🌤️":"☀️"),description:$e(o.current.weather_code),timestamp:Date.now()};return we(_e),_e.set(a,{data:e,timestamp:Date.now()}),e}}catch(e){console.warn("Weather fetch failed:",e)}var i,n;return null}(s.lat,s.lon);if(!o)return B``;const r=t?pe("weather.wind",de(t,a)):"Wind speed (Beaufort)";return B`
    ...
    `}catch(e){return console.warn("Weather badge error:",e),B``}}const ze=s`
  .spinner-container {
    display: flex;
    align-items: center;
    justify-content: center;
...
`,function(e,t,a){let i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return B`
...
`}),Ae="soccerlive_cache_",Te=new Map;class Le{static set(e,t){try{const a=JSON.stringify(t);if(Te.get(e)===a)return;Te.size>=50&&Te.delete(Te.keys().next().value),Te.set(e,a),localStorage.setItem(Ae+e,JSON.stringify({timestamp:Date.now(),data:t}))}catch(e){console.warn("Failed to cache:",e)}}static get(e){try{const t=localStorage.getItem(Ae+e);if(!t)return null;const{timestamp:a,data:i}=JSON.parse(t),n=Date.now()-a;return n<864e5?{data:i,age:n,isCached:!0}:(this.clear(e),null)}catch(e){return console.warn("Failed to read cache:",e),null}}static clear(e){try{localStorage.removeItem(Ae+e)}catch(e){console.warn("Failed to clear cache:",e)}}static clearAll(){try{Object.keys(localStorage).forEach((e=>{e.startsWith(Ae)&&localStorage.removeItem(e)}))}catch(e){console.warn("Failed to clear all cache:",e)}}static getAge(e){const t=localStorage.getItem(Ae+e);if(!t)return null;try{const{timestamp:e}=JSON.parse(t),a=Date.now()-e,i=Math.floor(a/6e4);if(i<60)return`${i}m ago`;const n=Math.floor(i/60);return n<24?`${n}h ago`:`${Math.floor(n/24)}d ago`}catch(e){return null}}}customElements.define("soccer-live-team",class extends oe{static get properties(){return{hass:{},_config:{},_isLoading:{type:Boolean},showPopup:{type:Boolean},activeMatch:{type:Object},_eventSubscriptions:{type:Array},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String},_weatherBadge:{type:Object},_cachedData:{type:Object}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e);const t=["big","huge"].includes(e.score_size)?e.score_size:"normal";this.setAttribute("data-score",t),this._isLoading=!0,this._loadingStarted=Date.now(),this._lastWeatherVenue=null,this.showPopup=!1,this.activeMatch=null,this.showEventToasts=!0===e.show_event_toasts,this.myTeam=(e.my_team||"").toLowerCase(),this.showPreviousMatches=!0===e.show_previous_matches,this.showFormTrend=!0===e.show_form_trend,this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null}_t(e,t){return pe(e,de(this.hass,this._config),t)}_translatePhase(e){return e?{"regular-season":this._t("phase.regular_season"),"regular season":this._t("phase.regular_season"),"group-stage":this._t("phase.group_stage"),"group stage":this._t("phase.group_stage"),playoffs:this._t("phase.playoffs")}[String(e).toLowerCase()]||e:""}_shouldShowPhase(e){return!!e&&"regular-season"!==String(e).toLowerCase()}connectedCallback(){super.connectedCallback(),this._subscribeToEvents(),this._countdownInterval=setInterval((()=>this.requestUpdate()),3e4),this._loadingTimer=setTimeout((()=>this.requestUpdate()),1e4)}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this._countdownInterval),this._countdownInterval=null,clearTimeout(this._loadingTimer),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass&&this.hass.connection&&(this._eventSubscriptions=[],["soccer_live_goal","soccer_live_yellow_card","soccer_live_red_card"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleCalcioLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this.hass.states[this._config.entity];if(!t)return!1;const a=t.attributes.matches||[];if(0===a.length)return!1;const i=a[0];return i.home_team===e.home_team&&i.away_team===e.away_team}_handleCalcioLiveEvent(e){const t=e.event_type,a=e.data;if(this._eventBelongsToThisCard(a)&&this.showEventToasts)if("soccer_live_goal"===t){const e=a.team===a.home_team?"home":"away";requestAnimationFrame((()=>this._triggerGoalCelebration(e,a)))}else this._showEventToast(t,a)}_showEventToast(e,t){let a="",i="goal";"soccer_live_goal"===e?(a=`<strong>${this._t("event.goal").toUpperCase()}!</strong> ${t.player} · ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="goal"):"soccer_live_yellow_card"===e?(a=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="yellow"):"soccer_live_red_card"===e&&(a=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="red"),a&&(this._toastMessage=a,this._toastVariant=i,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}_triggerGoalCelebration(e,t){const a=this.shadowRoot&&this.shadowRoot.querySelector("ha-card");if(!a)return;a.querySelectorAll(".confetti, .goal-banner, .goal-flash-overlay").forEach((e=>e.remove())),a.classList.remove("goal-flash"),a.offsetWidth,a.classList.add("goal-flash"),setTimeout((()=>a.classList.remove("goal-flash")),1700);const i=document.createElement("div");i.className="goal-flash-overlay",a.appendChild(i),setTimeout((()=>i.remove()),1e3);const n=document.createElement("div");n.className="goal-banner",n.innerHTML='<div class="goal-banner-text">GOAL!</div>',a.appendChild(n),setTimeout((()=>n.remove()),1700);const s=a.querySelector(".score-numbers");s&&(s.classList.remove("goal-scored"),s.offsetWidth,s.classList.add("goal-scored"),setTimeout((()=>s.classList.remove("goal-scored")),1300));const o=a.querySelectorAll(".team-side .team-logo-big"),r="away"===e?o[1]:o[0];r&&(r.classList.remove("scorer-bounce"),r.offsetWidth,r.classList.add("scorer-bounce"),setTimeout((()=>r.classList.remove("scorer-bounce")),1300)),navigator.vibrate&&navigator.vibrate([180,80,180,80,280]),setTimeout((()=>this._showEventToast("soccer_live_goal",t)),600);const l=["#ec4899","#6366f1","#06b6d4","#fbbf24","#10b981","#ef4444"],c=["⚽","🎉","✨","🔥","⭐"];for(let e=0;e<36;e++){const e=document.createElement("div");e.className="confetti",Math.random()>.55?(e.textContent=c[Math.floor(Math.random()*c.length)],e.style.fontSize=14+10*Math.random()+"px",e.style.background="transparent"):(e.style.background=l[Math.floor(Math.random()*l.length)],e.style.borderRadius=Math.random()>.5?"50%":"2px");const t=380*(Math.random()-.5)+"px",i=240*Math.random()+100+"px";e.style.setProperty("--dx",t),e.style.setProperty("--dy",i),e.style.animationDelay=.3*Math.random()+"s",a.appendChild(e),setTimeout((()=>e.remove()),2e3)}}_parseMatchDate(e){if(!e||"N/A"===e)return null;try{const[t,a]=e.split(" "),[i,n,s]=t.split(/[-\/]/).map(Number),[o,r]=(a||"00:00").split(":").map(Number);return new Date(s,n-1,i,o,r)}catch(e){return null}}_liveCountdown(e){if(!e||"pre"!==e.state)return null;const t=this._parseMatchDate(e.date);if(!t)return null;const a=t-new Date;if(a<=0||a>1728e5)return null;const i=Math.floor(a/6e4);if(i<1)return this._t("time.now");if(i<60)return this._t("time.in_n_min",{n:i});const n=Math.floor(i/60);return this._t("time.in_n_h",{n})}getCardSize(){return 4}static getConfigElement(){return document.createElement("soccer-live-team-editor")}static getStubConfig(){return{entity:"sensor.soccerlive",show_event_toasts:!1}}showDetails(e){this.activeMatch=e,this.showPopup=!0}closePopup(){this.showPopup=!1}separateEvents(e){const t=[],a=[],i=[];return e.forEach((e=>{const n=String(e||"");n.includes("Goal")||n.includes("Penalty - Scored")?t.push(this.formatMatchEvent(n)):n.includes("Yellow Card")?a.push(this.formatMatchEvent(n)):n.includes("Red Card")&&i.push(this.formatMatchEvent(n))})),{goals:t,yellowCards:a,redCards:i}}formatMatchEvent(e){const t=e=>this._t(e);let a=String(e||"").trim();a=a.replace(/^Goal\s*-\s*/i,"").replace(/^Yellow Card\s*-\s*/i,"").replace(/^Red Card\s*-\s*/i,"").replace(/^Penalty - Scored\s*-\s*/i,`${t("event.penalty")} - `).replace(/^Header\s*-\s*/i,`${t("event.header")} - `).replace(/^Shot\s*-\s*/i,`${t("event.shot")} - `).replace(/^Free-kick\s*-\s*/i,`${t("event.free_kick")} - `).replace(/^Penalty\s*-\s*/i,`${t("event.penalty")} - `),a=a.replace(/^([^:]+):\s*/,"$1 ");const i=[t("event.header"),t("event.shot"),t("event.penalty"),t("event.free_kick")].map((e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")));return a=a.replace(new RegExp(`^(${i.join("|")})\\s*-\\s*(.+)$`,"i"),((e,t,a)=>`${a} (${t.toLowerCase()})`)),a=a.replace(/\bN\/A\b/g,t("generic.unknown")),a}_renderStatusBadge(e){const t=e.state;return"in"===t?B`<span class="status-badge live"><span class="dot"></span>${this._t("status.live")}</span>`:"post"===t?B`<span class="status-badge finished">${this._t("status.finished")}</span>`:B`<span class="status-badge scheduled">${e.date||this._t("status.scheduled")}</span>`}_renderClock(e){const t=e.state;if("in"===t){const t=e.status_detail&&"N/A"!==e.status_detail?e.status_detail:"",a=(e.clock&&"N/A"!==e.clock?e.clock:"")||t||e.status||"";return B`<div class="clock"><span class="dot"></span>${a}</div>`}if("post"===t)return B`<div class="clock finished">${this._t("status.full_time")}</div>`;const a=this._liveCountdown(e);return B`<div class="clock upcoming">${a||e.date||""}</div>`}_renderRecord(e){if(!e||"N/A"===e)return"";const t=String(e).split("-");return 3===t.length?t.every((e=>0===parseInt(e)))?"":B`<div class="record">
      ...
      </div>`:B`<div class="record"><span class="rec">${e}</span></div>`}_hexToRgb(e){if(!e||"N/A"===e)return null;const t=String(e).replace("#","");return 6!==t.length?null:`${parseInt(t.slice(0,2),16)},${parseInt(t.slice(2,4),16)},${parseInt(t.slice(4,6),16)}`}_renderTopScorer(e){if(!e||!e.name)return"";const t=e.short_name||e.name,a=this._t("team.top_scorer");return B`
    ...
    `}_renderForm(e){if(!e||"N/A"===e)return"";const t=String(e).replace(/[^WLDwld]/g,"").toUpperCase();if(!t.length)return"";const a=t.slice(-5).split(""),i=e=>this._t("form."+e);return B`
      <div class="form-pills">
        ${a.map((e=>B`<div class="form-pill ${e}">${i(e)}</div>`))}
      </div>
    `}_renderStatsRow(e){const t=e.home_statistics||{},a=e.away_statistics||{},i=[],n=e=>{const t=parseFloat(e);return isNaN(t)?null:t},s=function(e,s,o){let r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"";const l=n(t[s]),c=n(a[o]);null!==l&&null!==c&&i.push({label:e,home:t[s],away:a[o],hNum:l,aNum:c,suffix:r})};return s(this._t("team.possession"),"possessionPct","possessionPct","%"),s(this._t("team.shots"),"totalShots","totalShots"),s(this._t("team.on_target"),"shotsOnTarget","shotsOnTarget"),0===i.length?"":B`
      <div class="stats-row">
        ${i.map((e=>{const t=e.hNum+e.aNum,a=t>0?e.hNum/t*100:50,i=100-a;return B`
            <div class="stat-bar">
    ...
    `}render(){if(!this.hass||!this._config)return Se("Loading...");const e=this._config.entity,t=this.hass.states[e];if(!t){const t=Le.get(e);return t?Ee("⏱","Offline - showing cached data","Last update: "+new Date(t.data.timestamp||Date.now()).toLocaleTimeString(),"Waiting for integration to come online"):Ee("⚠️","Entity not found",`Unable to find: ${e}`,"Check the entity configuration")}if("unavailable"===t.state){const t=Le.get(e);if(!t||!t.data.matches)return Ee("📡","Sensor unavailable","The integration may not be running","Restart Home Assistant or check the integration");this._cachedData=t.data}if(this._isLoading)return Date.now()-this._loadingStarted>1e4?Ee("⏱",this._t("ui.loading_timeout"),`${this._t("ui.entity_not_responding")}: ${this._config.entity}`,this._t("ui.check_integration")):Se(this._t("ui.loading"));const a=t&&"unavailable"!==t.state?t.attributes:this._cachedData;if(!a||!a.matches||0===a.matches.length)return B`
        ...
        </ha-card>`;const i=a.matches[0],n=a.league_info?a.league_info[0]:null,s=n&&n.logo_href&&"N/A"!==n.logo_href?n.logo_href:null,o="in"===i.state,r="post"===i.state,l=o||r,c=n&&n.abbreviation&&"N/A"!==n.abbreviation?n.abbreviation:i.league_name&&"N/A"!==i.league_name?i.league_name:i.season_info&&"N/A"!==i.season_info&&this._shouldShowPhase(i.season_info)?this._translatePhase(i.season_info):"",d=i.venue&&"N/A"!==i.venue?i.venue:"",p=i.venue_city&&"N/A"!==i.venue_city?i.venue_city:"",h=d?p?`${d}, ${p}`:d:"—",g=i.broadcast&&""!==i.broadcast&&"N/A"!==i.broadcast?i.broadcast:"",u=parseInt(i.attendance,10),m=!isNaN(u)&&u>0,f=this._hexToRgb(i.home_color),v=this._hexToRgb(i.away_color),b=f||v?`background:\n      radial-gradient(ellipse at 0% 0%, rgba(${f||"99,102,241"},0.18), transparent 55%),\n      radial-gradient(ellipse at 100% 100%, rgba(${v||"236,72,153"},0.18), transparent 55%)`:"",_=this.myTeam||(a.team_name||"").toLowerCase(),x=_&&i.home_team&&i.home_team.toLowerCase().includes(_),y=_&&i.away_team&&i.away_team.toLowerCase().includes(_);return B`
      <ha-card class="${o?"live":""}">
        ...
        <div class="scoreboard">
          ...
          <div class="score-center">
            ${l?B`<div class="score-numbers">${i.home_score} <span class="dash">-</span> ${i.away_score}</div>`:B`<div class="score-vs">tegen</div>`}
            ${this._renderClock(i)}
          </div>
        ...
        <div class="meta-row">
          ...
          ${l?B`<button class="info-btn" @click="${()=>this.showDetails(i)}">${this._t("team.details")} ›</button>`:B`
              <div class="meta-item">
      ...
      <div class="form-trend-section">
        ...
        <div class="form-trend-row">
          <div class="form-trend-dots">
            ${s.map((e=>B`<span class="ft-dot ${e.toLowerCase()}">${e}</span>`))}
          </div>
          <span class="form-trend-summary">${o}W ${r}G ${l}V</span>
        </div>
      </div>
    `}_renderPreviousMatches(e,t,a){const i=e&&e.length>0?e.filter((e=>"post"===e.state||!e.state)):t?t.filter((e=>"post"===e.state)).slice(-3).reverse():[];if(0===i.length)return"";const n=(a||"").toLowerCase();return B`
      <div class="upcoming-list">
        <div class="upcoming-list-title">${this._t("team.previous_matches")}</div>
        ${i.map((e=>{const t=n&&e.home_team&&e.home_team.toLowerCase().includes(n),a=n&&e.away_team&&e.away_team.toLowerCase().includes(n),i=parseInt(e.home_score),s=parseInt(e.away_score),o=!isNaN(i)&&!isNaN(s)&&i>s,r=!isNaN(i)&&!isNaN(s)&&s>i;return B`
    ...
    `}_renderUpcomingList(e,t,a){const i=e&&e.length>0?e:t&&t.length>1?t.slice(1).filter((e=>"pre"===e.state||"in"===e.state)).slice(0,4):[];if(0===i.length)return"";const n=(a||"").toLowerCase();return B`
      <div class="upcoming-list">
        <div class="upcoming-list-title">${this._t("team.upcoming_matches")}</div>
        ${i.map((e=>{const t=n&&e.home_team&&e.home_team.toLowerCase().includes(n),a=n&&e.away_team&&e.away_team.toLowerCase().includes(n),i="in"===e.state,s=e.head_to_head&&e.head_to_head.length>0;return B`
            <div class="upcoming-row ${s?"clickable":""}"
              ...
              ${i?B`<span class="upcoming-live-score">${e.home_score}<span class="live-dot">●</span>${e.away_score}</span>`:B`<span class="upcoming-vs">-</span>`}
              <span class="upcoming-team away-side ${a?"tracked":""}">
                ${this._teamBadge(e.away_abbrev||"?",e.away_color)}
                <img src="${e.away_logo}" alt="" />
              </span>
    ...
    `}_renderH2H(e){if(!e||0===e.length)return"";const t=e.slice(0,3);return B`
      <div class="h2h-section">
        <div class="upcoming-list-title">${this._t("team.h2h")}</div>
        ${t.map((e=>{const t=e.date?e.date.split("T")[0].split("-"):[],a=3===t.length?`${t[2]}/${t[1]}/${t[0].slice(2)}`:"",i=parseInt(e.home_score)>parseInt(e.away_score),n=parseInt(e.away_score)>parseInt(e.home_score);return B`
            <div class="h2h-row">
    ...
    `}updated(e){if((e.has("showPopup")||e.has("activeMatch"))&&this.renderPopupToBody(),e.has("activeMatch")&&this.activeMatch&&this._loadWeather(this.activeMatch.venue,this.activeMatch.venue_lat,this.activeMatch.venue_lon),e.has("hass")&&this.hass&&this._config){const e=this.hass.states[this._config.entity];if(e&&"unavailable"!==e.state&&(this._isLoading=!1,Le.set(this._config.entity,e.attributes)),e&&e.attributes.matches&&e.attributes.matches[0]){const t=e.attributes.matches[0];t.venue!==this._lastWeatherVenue&&this._loadWeather(t.venue,t.venue_lat,t.venue_lon)}}}async _loadWeather(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;this._lastWeatherVenue=e;try{this._weatherBadge=await Ce(e,this.hass,this._config,t,a),this.requestUpdate()}catch(e){console.warn("Weather load failed:",e)}}renderPopupToBody(){if(!this.showPopup||!this.activeMatch){const e=document.getElementById("soccer-live-team-popup");return void(e&&e.remove())}let e=document.getElementById("soccer-live-team-popup");e||(e=document.createElement("div"),e.id="soccer-live-team-popup",e.style.cssText="\n        position: fixed; inset: 0;\n        display: flex; justify-content: center; align-items: center;\n        z-index: 999999;\n        background: rgba(0,0,0,0.7);\n        backdrop-filter: blur(8px);\n        overflow: auto;\n      ",e.addEventListener("click",(t=>{t.target===e&&(this.showPopup=!1)})),document.body.appendChild(e));const t=this.activeMatch,a=e=>this._t(e),i=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),n=getComputedStyle(this),s=n.getPropertyValue("--cl-bg").trim()||"#1a1f2e",o=n.getPropertyValue("--cl-text").trim()||"#f8fafc",r=n.getPropertyValue("--cl-text-2").trim()||"#94a3b8",l=n.getPropertyValue("--cl-accent").trim()||"#6366f1",c=n.getPropertyValue("--cl-accent-2").trim()||"#ec4899",d=n.getPropertyValue("--cl-divider").trim()||"rgba(255,255,255,0.08)",p=n.getPropertyValue("--cl-surface").trim()||"rgba(255,255,255,0.04)";e.innerHTML=`\n      <div style="background:${s}; padding: 24px; border-radius: 20px; width: 90%; max-width: 560px; max-height: 85vh; overflow-y: auto; border: 1px solid ${d}; box-shadow: 0 24px 64px rgba(0,0,0,0.6); margin: auto; color: ${o}; font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', sans-serif;">\n        <h3 style="margin:0 0 20px; font-size: 22px; font-weight: 800; letter-spacing:-0.02em; background: linear-gradient(135deg,${l},${c}); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color: transparent;">${a("popup.match_details")}</h3>\n        <div style="display:flex; justify-content:center; align-items:center; gap:18px; margin-bottom:24px;">\n          <img style="width:72px; height:72px; object-fit:contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.4));" src="${i(t.home_logo)}" alt="${i(t.home_team)}" />\n          <div style="text-align:center;">\n            <div style="font-size:42px; font-weight:900; letter-spacing:-0.04em; line-height:1;">${i(t.home_score??"-")} <span style="opacity:0.4;">-</span> ${i(t.away_score??"-")}</div>\n            <div style="font-size:12px; color:${r}; margin-top:8px; font-weight:600;">${i(t.clock??t.status??"")}</div>\n          </div>\n          <img style="width:72px; height:72px; object-fit:contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.4));" src="${i(t.away_logo)}" alt="${i(t.away_team)}" />\n        </div>\n        <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px; margin-bottom:18px;">\n          <div style="background:${p}; padding:14px; border-radius:14px;">\n            <div style="font-size:10px; text-transform:uppercase; letter-spacing:0.1em; color:${r}; font-weight:700; margin-bottom:6px;">${i(t.home_team)}</div>\n            <div style="font-size:13px;"><span style="color:${r};">${a("team.possession")}:</span> <strong>${i(t.home_statistics?.possessionPct??"—")}%</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${a("team.shots")}:</span> <strong>${i(t.home_statistics?.totalShots??"—")}</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${a("team.on_target")}:</span> <strong>${i(t.home_statistics?.shotsOnTarget??"—")}</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${a("team.fouls")}:</span> <strong>${i(t.home_statistics?.foulsCommitted??"—")}</strong></div>\n          </div>\n          <div style="background:${p}; padding:14px; border-radius:14px;">\n            <div style="font-size:10px; text-transform:uppercase; letter-spacing:0.1em; color:${r}; font-weight:700; margin-bottom:6px;">${i(t.away_team)}</div>\n            <div style="font-size:13px;"><span style="color:${r};">${a("team.possession")}:</span> <strong>${i(t.away_statistics?.possessionPct??"—")}%</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${a("team.shots")}:</span> <strong>${i(t.away_statistics?.totalShots??"—")}</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${a("team.on_target")}:</span> <strong>${i(t.away_statistics?.shotsOnTarget??"—")}</strong></div>\n            <div style="font-size:13px;"><span style="color:${r};">${a("team.fouls")}:</span> <strong>${i(t.away_statistics?.foulsCommitted??"—")}</strong></div>\n          </div>\n        </div>\n        <div id="team-events-container"></div>\n        <button id="popup-close-btn" style="background:linear-gradient(135deg,${l},${c}); color:white; padding:12px 20px; border:none; border-radius:12px; cursor:pointer; margin-top:20px; font-weight:800; width:100%; font-size:14px;">${a("generic.close")}</button>\n      </div>\n    `;const h=e.querySelector("#popup-close-btn");h&&h.addEventListener("click",(()=>{this.showPopup=!1}));const g=e.querySelector("#team-events-container"),{goals:u,yellowCards:m,redCards:f}=this.separateEvents(t.match_details||[]),v=(e,t,a)=>t.length?`<div style="margin-bottom:14px; padding:14px; background:${a.bg}; border-left:3px solid ${a.border}; border-radius:10px;">\n        <h5 style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:${a.border}; font-weight:800;">${e}</h5>\n        <ul style="margin:0; padding-left:18px; font-size:13px; color:#cbd5e1;">${t.map((e=>`<li style="margin:4px 0;">${i(e)}</li>`)).join("")}</ul>\n      </div>`:"";let b="";b+=v(a("event.goal"),u,{bg:"rgba(99,102,241,0.1)",border:"#6366f1"}),b+=v(a("event.yellow_card"),m,{bg:"rgba(245,158,11,0.1)",border:"#f59e0b"}),b+=v(a("event.red_card"),f,{bg:"rgba(239,68,68,0.1)",border:"#ef4444"});const _=t.lineup_home||[],x=t.lineup_away||[];if(_.length||x.length){const e=t.formation_home||"",n=t.formation_away||"",s=(e,t,a)=>{const n=(e||[]).filter((e=>e.starter));return n.length?`<div style="margin-bottom:8px;">\n          <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:6px;">\n            <span style="font-size:12px; font-weight:800; color:#fff;">${i(a)}</span>\n            ${t?`<span style="font-size:10px; font-weight:700; color:#6366f1; letter-spacing:0.1em;">${i(t)}</span>`:""}\n          </div>\n          <div style="font-size:12px; color:#cbd5e1; line-height:1.7;">\n            ${n.map((e=>`<span style="display:inline-block; padding:2px 8px; background:rgba(255,255,255,0.05); border-radius:6px; margin:2px;">${e.jersey?`<strong style="color:#fbbf24;">${i(e.jersey)}</strong> `:""}${i(e.short_name||e.name)}</span>`)).join("")}\n          </div>\n        </div>`:""};b+=`<div style="margin-bottom:14px; padding:14px; background:rgba(16,185,129,0.08); border-left:3px solid #10b981; border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#10b981; font-weight:800;">${a("popup.lineups")}</h5>\n        ${s(_,e,t.home_team)}\n        ${s(x,n,t.away_team)}\n      </div>`}const y=t.key_events||[];if(y.length){const e=e=>{const t=(e.type||"").toLowerCase(),a=(e.type_text||"").toLowerCase();return"goal"===t||e.scoring_play?"⚽":a.includes("yellow")?"🟨":a.includes("red")?"🟥":"substitution"===t?"🔄":a.includes("halftime")?"⏸":a.includes("kickoff")?"▶":a.includes("end")?"🏁":"·"};b+=`<div style="margin-bottom:14px; padding:14px; background:rgba(251,191,36,0.08); border-left:3px solid #fbbf24; border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#fbbf24; font-weight:800;">${a("popup.timeline")}</h5>\n        <ul style="margin:0; padding:0; list-style:none;">\n          ${y.map((t=>`<li style="display:grid; grid-template-columns:36px 24px 1fr; gap:8px; align-items:start; padding:5px 0; border-bottom:1px solid rgba(255,255,255,0.04); font-size:12px; color:#cbd5e1;">\n            <span style="text-align:right; font-weight:700; color:#94a3b8; font-variant-numeric:tabular-nums;">${i(t.clock||"")}</span>\n            <span style="text-align:center;">${e(t)}</span>\n            <span><strong style="color:#fff;">${i((t.athletes||[]).filter(Boolean).join(", ")||t.type_text||"")}</strong>${t.team?`<br><span style="color:#94a3b8; font-size:11px;">${i(t.team)}</span>`:""}</span>\n          </li>`)).join("")}\n        </ul>\n      </div>`}const w=t.head_to_head||[];w.length&&(b+=`<div style="margin-bottom:14px; padding:14px; background:rgba(var(--cl-accent-rgb),0.08); border-left:3px solid var(--cl-accent); border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#6366f1; font-weight:800;">${a("popup.h2h")} (${w.length})</h5>\n        <ul style="margin:0; padding:0; list-style:none;">\n          ${w.slice(0,8).map((e=>{const t=e.date?new Date(e.date).toLocaleDateString(de(this.hass,this._config)):"";return`<li style="display:flex; justify-content:space-between; padding:5px 0; border-bottom:1px solid rgba(255,255,255,0.04); font-size:12px; color:#cbd5e1;">\n              <span>${i(e.home_team)} <strong>${i(e.home_score??"-")}</strong> - <strong>${i(e.away_score??"-")}</strong> ${i(e.away_team)}</span>\n              <span style="color:#94a3b8;">${i(t)}</span>\n            </li>`})).join("")}\n        </ul>\n      </div>`),g.innerHTML=b||`<p style="text-align:center; color:#94a3b8; font-size:13px;">${a("popup.no_events")}</p>`}static get styles(){return[he,ze,ke,s`
      :host {
        --cl-accent: #6366f1;
        --cl-accent-2: #ec4899;
        --cl-live: #ef4444;
    ...
    `]}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.target.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.checked;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.value;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_next"))).sort())}render(){if(!this._config||!this.hass)return B``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return B`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
          <label class="field-label">Entity</label>
    ...
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.target.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.checked;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.value;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_numberChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=parseInt(t.value,10);isNaN(i)||this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_news"))).sort())}render(){if(!this._config||!this.hass)return B``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return B`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
    ...
    `}render(){if(!this.hass||!this._config)return B``;const e=this.hass.states[this._config.entity];if(!e)return B`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(0===t.length)return B`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const a=t[0],i=a.lineup_home||e.attributes.lineup_home||[],n=a.lineup_away||e.attributes.lineup_away||[],s=a.formation_home||e.attributes.formation_home||"",o=a.formation_away||e.attributes.formation_away||"";if(0===i.length&&0===n.length)return B`
      ...
      `;const r=this._starters(i),l=this._bench(i),c=this._starters(n),d=this._bench(n);return B`
      <ha-card>
        <div class="hero-bg"></div>
        ${this.hideHeader?"":B`
    ...
    `}}),customElements.define("soccer-live-timeline",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.reverseOrder=!0===e.reverse_order}_t(e,t){return pe(e,de(this.hass,this._config),t)}getCardSize(){return 5}static getConfigElement(){return document.createElement("soccer-live-timeline-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_next",hide_header:!1,reverse_order:!0}}_eventMeta(e){const t=(e.type||"").toLowerCase(),a=(e.type_text||"").toLowerCase();return a.includes("kickoff")||"kickoff"===t?{icon:"⚽",label:this._t("status.kickoff"),cls:"meta"}:a.includes("halftime")||a.includes("intervallo")?{icon:"⏸",label:this._t("status.halftime"),cls:"meta"}:a.includes("start 2nd")||a.includes("secondo tempo")?{icon:"▶",label:this._t("status.second_half"),cls:"meta"}:a.includes("end regular")||a.includes("full time")?{icon:"🏁",label:this._t("status.end"),cls:"meta"}:"goal"===t||e.scoring_play?{icon:"⚽",label:this._t("event.goal"),cls:"goal"}:a.includes("penalty")?{icon:"⚽",label:this._t("timeline.penalty"),cls:"goal"}:a.includes("yellow card")?{icon:"🟨",label:this._t("event.yellow_card"),cls:"yellow"}:a.includes("red card")?{icon:"🟥",label:this._t("event.red_card"),cls:"red"}:"substitution"===t||a.includes("substitution")?{icon:"🔄",label:this._t("event.substitution"),cls:"sub"}:a.includes("var")?{icon:"📺",label:this._t("event.var"),cls:"meta"}:{icon:"·",label:e.type_text||this._t("timeline.event"),cls:"meta"}}render(){if(!this.hass||!this._config)return B``;const e=this.hass.states[this._config.entity];if(!e)return B`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(0===t.length)return B`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const a=t[0],i=a.key_events||e.attributes.key_events||[];if(0===i.length)return B`
      ...
      `;const n=this.reverseOrder?[...i].reverse():i;return B`
      <ha-card>
        <div class="hero-bg"></div>
        ${this.hideHeader?"":B`
          <div class="tl-header">
        ...
        <div class="tl-body">
          ${n.map((e=>{const t=this._eventMeta(e),i=a.home_team&&e.team===a.home_team,n=a.away_team&&e.team===a.away_team,s=i?"home":n?"away":"meta",o=(e.athletes||[]).filter(Boolean);return B`
    ...
    `}}),customElements.define("soccer-live-bracket",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.compactMode=!0===e.compact,this._cardStyle="tree"===e.style?"tree":"list",this.treeShowPlayoffs=!0===e.tree_show_playoffs}_t(e,t){return pe(e,de(this.hass,this._config),t)}_formatDate(e){if(!e)return"";try{const t=new Date(e),a=this._t("month."+(t.getMonth()+1));return`${t.getDate()} ${a}`}catch(e){return""}}_localizeRoundName(e){const t={Final:"round.final",Semifinals:"round.semifinals",Quarterfinals:"round.quarterfinals","Round of 16":"round.r16","Round of 32":"round.r32","Knockout Playoffs":"round.knockout_playoffs","Preliminary Round":"round.preliminary"}[e.name];return t?this._t(t):e.name}getCardSize(){return 6}static getConfigElement(){return document.createElement("soccer-live-bracket-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_bracket",hide_header:!1,compact:!1,style:"list"}}_formatScore(e){return null==e?"-":String(e)}_renderTie(e){const t=e.team_a||{},a=e.team_b||{},i=e.leg1,n=e.leg2,s=e.single,o=e.winner_team,r=o&&t.name&&o===t.name,l=o&&a.name&&o===a.name,c=(e,t)=>e&&t&&t.name?e.home_team===t.name?e.home_score:e.away_team===t.name?e.away_score:null:null,d=c(i,t),p=c(i,a),h=c(n,t),g=c(n,a),u=c(s,t),m=c(s,a),f=i&&"in"===i.state||n&&"in"===n.state||s&&"in"===s.state,v=!i&&!s;return B`
      <div class="tie ${f?"live":""} ${e.completed?"done":""}">
        ...
        <div class="tie-row ${l?"winner":""} ${r?"loser":""}">
          ...
          <span class="legs">
            ${s?B`<span class="leg">${this._formatScore(m)}</span>`:B`
    ...
    `}_aggregateFor(e,t){if(!t||!t.name)return null;const a=(e,t)=>e&&t&&t.name?e.home_team===t.name?e.home_score:e.away_team===t.name?e.away_score:null:null;if(e.single)return a(e.single,t);let i=0,n=!1;const s=a(e.leg1,t),o=a(e.leg2,t);return null!=s&&(i+=s,n=!0),null!=o&&(i+=o,n=!0),n?i:null}_renderMiniTie(e){const t=e.team_a||{},a=e.team_b||{},i=this._aggregateFor(e,t),n=this._aggregateFor(e,a),s=e.winner_team,o=s&&t.name&&s===t.name,r=s&&a.name&&s===a.name,l=e.leg1&&"in"===e.leg1.state||e.leg2&&"in"===e.leg2.state||e.single&&"in"===e.single.state,c=!e.leg1&&!e.single,d=t.abbrev||(t.name?t.name.substring(0,3).toUpperCase():"TBD"),p=a.abbrev||(a.name?a.name.substring(0,3).toUpperCase():"TBD");return B`
      <div class="mini-tie ${l?"live":""} ${e.completed?"done":""} ${c?"pending":""}">
        ...
        <div class="mini-team ${r?"winner":""} ${o?"loser":""}">
          ${a.logo?B`<img src="${a.logo}" alt="${a.name}" />`:B`<div class="logo-ph"></div>`}
    ...
    `}render(){if(!this.hass||!this._config)return B``;const e=this.hass.states[this._config.entity];if(!e)return B`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.rounds||[];return 0===t.length?B`
        <ha-card class="empty">
          <div class="hero-bg"></div>
          <div class="empty-state">
            <div class="empty-icon">🏆</div>
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-bracket",name:"Soccer Live Bracket Card",description:"Knockout bracket for Champions League, Europa League, and other cup competitions"}),customElements.define("soccer-live-bracket-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return s`
      ...
      h3 { margin: 8px 0 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--secondary-text-color); }
      .hint { font-size: 12px; color: var(--secondary-text-color); }
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.target.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.checked;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.value;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_bracket"))).sort())}render(){if(!this._config||!this.hass)return B``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return B`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
          ...
          <div class="list">
            ${t.map(((e,t)=>B`
              <div class="scorer-row ${t%2==0?"even":""}">
                ...
                ${e.headshot?B`<img class="headshot" src="${e.headshot}" alt="${e.player}" @error=${e=>e.target.style.display="none"}>`:B`<div class="headshot-placeholder"></div>`}
                <div class="player-info">
                  <span class="player-name">${e.player}</span>
                  <span class="team-name">${e.team_name}</span>
                </div>
                ${e.team_logo?B`<img class="team-logo" src="${e.team_logo}" alt="${e.team_name}" @error=${e=>e.target.style.display="none"}>`:B`<div class="team-logo-placeholder"></div>`}
      ...
      <ha-card>
        ...
        <table>
          <tr>
            ...
            <th>P</th>
            ${this._config.hide_stats?"":B`<th>W</th><th>D</th><th>L</th><th>GD</th>`}
            <th>Pts</th>
          </tr>
          ${l.map((e=>{const t=s&&e.team_name&&e.team_name.toLowerCase().includes(s),a=(parseInt(e.wins)||0)+(parseInt(e.draws)||0)+(parseInt(e.losses)||0),i=parseInt(e.goal_difference)||0,n=i>0?`+${i}`:`${i}`;return B`
              <tr class="${t?"hl":""}">
                <td class="pos">${e.rank??""}</td>
                <td class="left">
                  <div class="team-row">
                    ${e.team_logo?B`<img class="team-logo" src="${e.team_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
                    <span class="team-name">${e.team_name||""}</span>
                  </div>
                </td>
                <td>${a||0}</td>
                ${this._config.hide_stats?"":B`<td>${e.wins??0}</td><td>${e.draws??0}</td><td>${e.losses??0}</td><td>${null!=e.goal_difference?n:0}</td>`}
                <td class="pts">${e.points??0}</td>
              </tr>
            `}))}
        </table>
      </ha-card>
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-mini-standings",name:"Soccer Live Mini Standings",description:"Compact standings table with group selector"});const je=["dark","light","red-white","classic","neon","gold"],Pe=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-mini-standings-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s``]}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_classifica"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_numberChanged(e){const t=parseInt(e.target.value,10);isNaN(t)||this._fire({...this._config,[e.target.dataset.configValue]:t})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}_textChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}render(){if(!this._config||!this.hass)return B``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return B`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
    ...
    `]}render(){if(!this.hass||!this._config)return Se("Loading...");const e=this.hass.states[this._config.entity];if(!e)return Le.get(this._config.entity)?Ee("⏱","Offline - showing cached data","Last update: "+(new Date).toLocaleTimeString(),"Waiting for integration to come online"):Ee("⚠️","Entity not found",`Unable to find: ${this._config.entity}`,"Check the entity configuration");if("unavailable"===e.state){const e=Le.get(this._config.entity);if(!e)return Ee("📡","Sensor unavailable","The integration may not be running","Restart Home Assistant or check the integration");this._cachedData=e.data}if(this._isLoading)return Date.now()-this._loadingStarted>1e4?Ee("⏱",this._t("ui.loading_timeout"),`${this._t("ui.entity_not_responding")}: ${this._config.entity}`,this._t("ui.check_integration")):Se(this._t("ui.loading"));const t=e&&"unavailable"!==e.state?e.attributes:this._cachedData,a=this._getNextMatch({attributes:t});if(!a)return Ee("⚽","No match data","Unable to find match information","Check if the sensor has data");const i="in"===a.state,n="post"===a.state,s=i||n?null:this._countdown(a.date),o=a.competition_name||e.attributes.league_name||"",r=a.competition_logo||e.attributes.league_logo||"",l=a.venue&&"N/A"!==a.venue?a.venue:"",c=a.venue_city&&"N/A"!==a.venue_city?a.venue_city:"",d=this._t("cd.days")||"days",p=this._t("cd.hrs")||"hrs",h=this._t("cd.min")||"min",g=this._t("cd.sec")||"sec";return B`
      <ha-card>
        ${!this._config.hide_header&&o?B`
          <div class="header">
            ${r?B`<img class="comp-logo" src="${r}" alt="">`:""}
        ...
        <div class="teams">
          <div class="team">
            ${a.home_logo?B`<img class="team-logo" src="${a.home_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
          ...
          <div class="center">
            ${i?B`
              ...
              ${a.clock?B`<div class="minute">${a.clock}</div>`:""}
            `:n?B`
              <div class="ft-badge">FT</div>
              <div class="score">${a.home_score??0} - ${a.away_score??0}</div>
            `:s?B`
              ${a.date?B`<div class="sched-date">${a.date}</div>`:""}
              <div class="countdown">
                ${s.days>0?B`
          ...
          <div class="team">
            ${a.away_logo?B`<img class="team-logo" src="${a.away_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-countdown",name:"Soccer Live Match Countdown",description:"Countdown to next match with live score"});const De=["dark","light","red-white","classic","neon","gold"],Ve=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-countdown-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s`
      ...
      h3 { margin: 8px 0 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--secondary-text-color); }
    `]}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_next"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}render(){if(!this._config||!this.hass)return B``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return B`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${De.map((e=>B`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${Ve.map((e=>B`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    ...
    `]}updated(e){if(e.has("hass")){const e=this.hass?.states[this._config?.entity];e&&"unavailable"!==e.state&&(this._isLoading=!1,Le.set(this._config.entity,e.attributes))}}render(){if(!this.hass||!this._config)return Se("Loading...");const e=this.hass.states[this._config.entity];if(!e)return Le.get(this._config.entity)?Ee("⏱","Offline - showing cached data","Last update: "+(new Date).toLocaleTimeString(),"Waiting for integration"):Ee("⚠️","Entity not found",`Unable to find: ${this._config.entity}`,"Check the entity configuration");if("unavailable"===e.state){const e=Le.get(this._config.entity);if(!e||!e.data.matches)return Ee("📡","Sensor unavailable","The integration may not be running","Restart Home Assistant or check the integration");this._cachedData=e.data}if(this._isLoading)return Date.now()-this._loadingStarted>1e4?Ee("⏱",this._t("ui.loading_timeout"),`${this._t("ui.entity_not_responding")}: ${this._config.entity}`,this._t("ui.check_integration")):Se(this._t("ui.loading"));const t=e&&"unavailable"!==e.state?e.attributes:this._cachedData,a=this._getMatch({attributes:t});if(!a)return Ee("⚽","No match data","Unable to find match information","Check if the sensor has data");const i="in"===a.state||"live"===a.status,n="post"===a.state,s=("pre"===a.state||a.status,a.key_events||a.events||a.match_events||[]),o=a.competition_name||e.attributes.league_name||"",r=a.competition_logo||e.attributes.league_logo||"",l=a.venue&&"N/A"!==a.venue?a.venue:"",c=a.venue_city&&"N/A"!==a.venue_city?a.venue_city:"",d=a.stats||a.statistics||[];return B`
      <ha-card>
        <div class="hero">
          ${a.home_logo?B`<img class="bg-logo home" src="${a.home_logo}" alt="">`:""}
          ${a.away_logo?B`<img class="bg-logo away" src="${a.away_logo}" alt="">`:""}
          ...
          <div class="teams-row">
            ...
            <div class="score-center">
              ${i?B`<div class="live-badge">LIVE</div>`:n?B`<div class="sched-info">FT</div>`:B`<div class="sched-info">${a.date||this._t("match.vs")}</div>`}
              ${i||n?B`<div class="score">${a.home_score??0} - ${a.away_score??0}</div>`:B`<div class="vs-text">${this._t("match.vs")}</div>`}
              ${i&&a.clock?B`<div class="minute">${a.clock}</div>`:""}
            </div>
            ...
            ${s.map((e=>B`
              <div class="event-row">
                ...
                <div class="event-text">
                  ...
                  ${e.team?B`<div class="event-team">${e.team}</div>`:""}
                </div>
              </div>
            `))}
          </div>
        ...
        ${d.length>0?B`
          <div class="divider"></div>
          ${d.slice(0,this._config.max_stats||4).map((e=>{const t=parseFloat(e.home??e.homeValue??0)||0,a=t+(parseFloat(e.away??e.awayValue??0)||0);return a>0&&Math.round(t/a*100),B`
              <div class="stats-row">
    ...
    `}}),customElements.define("soccer-live-multi-team",class extends oe{static get properties(){return{hass:{},_config:{},_isLoading:{type:Boolean},_cachedData:{}}}setConfig(e){if(!e.entities||!e.entities.length)throw new Error("At least one entity required");this._config=e,ue(this,e),this._isLoading=!0,this._loadingStarted=Date.now(),this._lastWeatherVenue=null}connectedCallback(){super.connectedCallback(),this._loadingTimer=setTimeout((()=>this.requestUpdate()),1e4)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._loadingTimer)}updated(e){if(e.has("hass")){const e=this._config?.entities||[],t=e.every((e=>{const t=this.hass?.states[e];return t&&"unavailable"!==t.state}));t&&(this._isLoading=!1,e.forEach((e=>{const t=this.hass?.states[e];t&&Le.set(e,t.attributes)})))}}getCardSize(){return Math.max(2,(this._config.entities||[]).length+1)}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-multi-team-editor")}static getStubConfig(){return{entities:[]}}_getMatch(e){const t=e.attributes.matches||[];return t.find((e=>"in"===e.state))||t.find((e=>"pre"===e.state))||t.find((e=>"post"===e.state))||t[0]||null}static get styles(){return[he,ze,s`
      ...
      .empty { padding: 16px; text-align: center; color: var(--cl-text-2); }
    `]}_renderMatch(e){const t=this.hass.states[e];if(!t)return B`<div class="match-row"><div class="no-match">${this._t("team.unknown_entity")}: ${e}</div></div>`;const a=this._getMatch(t);if(!a)return B`<div class="match-row"><div class="no-match">${this._t("team.no_match")} (${e})</div></div>`;const i="in"===a.state,n="post"===a.state,s=i||n,o=a.date||"";return B`
      <div class="match-row">
        <div class="team-block">
          ${a.home_logo?B`<img class="team-logo" src="${a.home_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
          <span class="team-name">${a.home_team||"?"}</span>
        ...
        <div class="score-block">
          ${i?B`<div><span class="live-dot"></span><span class="status">${a.clock||"LIVE"}</span></div>`:""}
          ${s?B`<div class="score">${a.home_score??0} - ${a.away_score??0}</div>`:B`<div class="status">${o||this._t("match.vs")}</div>`}
          ${n?B`<div class="status">FT</div>`:""}
        </div>
    ...
    `]}setConfig(e){this._config={...e,entities:[...e.entities||[]]}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this._allEntities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_next")||e.includes("all_mixed"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}_textChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_entityChanged(e,t){const a=[...this._config.entities||[]];a[t]=e.target.value,this._fire({...this._config,entities:a})}_removeEntity(e){const t=[...this._config.entities||[]];t.splice(e,1),this._fire({...this._config,entities:t})}_addEntity(){const e=[...this._config.entities||[],""];this._fire({...this._config,entities:e})}render(){if(!this._config||!this.hass)return B``;const e=this._config.entities||[];return B`
      <div class="card-config">
        <h3>Teams</h3>
          ...
          ${e.map(((e,t)=>B`
            <div class="entity-row">
              <select @change=${e=>this._entityChanged(e,t)}>
                ${e&&this._allEntities.includes(e)?"":B`<option value="${e}" selected>${e||"— select —"}</option>`}
                ${this._allEntities.map((t=>B`<option value="${t}" ?selected=${t===e}>${t}</option>`))}
              </select>
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${Fe.map((e=>B`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${Ie.map((e=>B`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    ...
    `]}render(){if(!this.hass||!this._config)return B``;const e=this.hass.states[this._config.entity];if(!e)return Ee("⚠️","Entity not found",`Unable to find: ${this._config.entity}`,"Check the entity configuration");const t=e.attributes.matches||[];if(!t.length)return Ee("⚽","No match data","Unable to find matches","Check if the team has scheduled matches");const a=this._groupByCompetition(t),i=a.find((e=>e.key===this._selectedComp))||a[0],n=this._config.team_name||e.attributes.team_name||"",s=e.attributes.team_logo||"",o=i.featured;return B`
      <ha-card>
        ${this._config.hide_header?"":B`
          <div class="card-header">
            ${s?B`<img class="team-logo" src="${s}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
        ...
        ${i&&o?B`
          <div class="match-display">
            ${i.logo?B`<img class="comp-logo" src="${i.logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}

            <div class="match-block">
              <div class="team-block">
                ${o.home_logo?B`<img class="team-logo" src="${o.home_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
              ...
              <div class="team-block right">
                ...
                ${o.away_logo?B`<img class="team-logo" src="${o.away_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
              </div>
            </div>
          </div>
        `:""}
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-team-competitions",name:"Soccer Live Team Competitions",description:"All team competitions with tab selector"});const Re=["dark","light","red-white","classic","neon","gold"],Be=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-team-competitions-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return[ve,s`
      .hint { font-size: 11px; color: var(--secondary-text-color); }
    `]}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("all_mixed"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_numberChanged(e){const t=parseInt(e.target.value,10);isNaN(t)||this._fire({...this._config,[e.target.dataset.configValue]:t})}_textChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}render(){if(!this._config||!this.hass)return B``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return B`
      <div class="card-config">
        <h3>Sensor</h3>
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${Re.map((e=>B`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${Be.map((e=>B`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    `}}),customElements.define("soccer-live-live-commentary",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e)}getCardSize(){return 5}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-live-commentary-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_commentary_"}}static get styles(){return[he,s`
      ...
      .empty { padding: 20px; text-align: center; color: var(--cl-text-2); }
    `]}_getEventIcon(e){if(!e)return"📋";const t=e.toLowerCase();return t.includes("goal")?"⚽":t.includes("yellow")?"🟨":t.includes("red")?"🟥":t.includes("substitut")||t.includes("sub")?"🔄":t.includes("penaalty")||t.includes("pen")?"⚽":t.includes("own goal")?"🔴":"📋"}render(){if(!this.hass||!this._config)return B``;const e=this.hass.states[this._config.entity];if(!e)return Ee("⚠️","Entity not found",`Unable to find: ${this._config.entity}`,"Check the entity configuration");const t=e.attributes.commentary||[],a=(e.attributes.matches||[]).find((e=>"in"===e.state)),i=a?.home_team||e.attributes.home_team||"?",n=a?.away_team||e.attributes.away_team||"?",s=a?.home_score??e.attributes.home_score??0,o=a?.away_score??e.attributes.away_score??0,r=e.attributes.match_status||"",l=(e.attributes.league_info||[{}])[0].abbreviation||"",c="in"===r||a&&"in"===a.state,d=a?a.clock:"",p=a?a.home_logo:"",h=a?a.away_logo:"";return B`
      <ha-card>
        <div class="header">
          ${l?B`<div class="comp-name">${l}</div>`:""}
          <div class="match-header">
            <div class="team-block">
              ${p?B`<img class="team-logo" src="${p}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
            ...
            <div class="score-block">
              ...
              <div class="clock">
                ${c?B`<span class="live-badge"></span>`:""}
                ${d||"—"}
              </div>
            </div>
            ...
            <div class="team-block right">
              ...
              ${h?B`<img class="team-logo" src="${h}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
            </div>
          </div>
        </div>
            ...
            ${t.map((e=>B`
              <div class="event">
                ...
                <div class="event-content">
                  ...
                  ${void 0!==e.home_score&&void 0!==e.away_score?B`
    ...
    `]}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_commentary"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}render(){if(!this._config||!this.hass)return B``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return B`
      <div class="card-config">
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${qe.map((e=>B`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${Ue.map((e=>B`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    `}})})();