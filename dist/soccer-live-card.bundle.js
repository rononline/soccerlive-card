...
`,ge=["dark","light","red-white","classic","neon","gold"];function ue(e,t){const a=function(e){const t=e&&"string"==typeof e.skin?e.skin.toLowerCase():"dark";return ge.includes(t)?t:"dark"}(t);return e&&e.setAttribute&&e.setAttribute("data-skin",a),a}const me=(e,t)=>Array.from({length:t-e+1},((t,a)=>e+a)),fe={serie_a:{match:(e,t)=>"ita.1"===e||t.includes("italian_serie_a"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},premier_league:{match:(e,t)=>"eng.1"===e||t.includes("english_premier"),champions:[1,2,3,4,5],europa:[6],conference:[7],relegation:"bottom3"},laliga:{match:(e,t)=>"esp.1"===e||t.includes("spanish_la_liga")||t.includes("spanish_laliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},bundesliga:{match:(e,t)=>"ger.1"===e||t.includes("german_bundesliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:[17,18]},ligue_1:{match:(e,t)=>"fra.1"===e||t.includes("french_ligue_1"),champions:[1,2,3],europa:[4],conference:[5],relegation:[17,18]},eredivisie:{match:(e,t)=>"ned.1"===e||t.includes("dutch_eredivisie"),champions:[1,2],europa:[3],conference:[4,5],relegation:[17,18]},primeira_liga:{match:(e,t)=>"por.1"===e||t.includes("portuguese_primeira"),champions:[1,2],europa:[3],conference:[4],relegation:[17,18]},ucl_league_phase:{match:(e,t)=>"uefa.champions"===e||t.includes("uefa_champions_league"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},uel_league_phase:{match:(e,t)=>"uefa.europa"===e||t.includes("uefa_europa_league"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},uecl_league_phase:{match:(e,t)=>"uefa.europa.conf"===e||t.includes("uefa_conference"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},world_cup:{match:(e,t)=>"fifa.world"===e||t.includes("fifa_world_cup")||t.includes("world_cup"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"🏆",accent:"world_cup"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},uefa_euro:{match:(e,t)=>"uefa.euro"===e||t.includes("uefa_euro")||t.includes("european_championship"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"⭐",accent:"uefa_euro"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},copa_america:{match:(e,t)=>"conmebol.america"===e||t.includes("copa_america")||t.includes("conmebol_america"),champions:[1,2],europa:[],conference:[],relegation:"bottom2",kind:"cup_group",hero:{icon:"🏆",accent:"copa_america"},labels:{champions:"zone.qualified",europa:null,conference:null,relegation:"zone.eliminated"}}};customElements.define("soccer-live-classifica",class extends oe{static get properties(){return{hass:{},_config:{},maxTeamsVisible:{type:Number},hideHeader:{type:Boolean},selectedGroup:{type:String},_eventSubscriptions:{type:Array},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.maxTeamsVisible=e.max_teams_visible?e.max_teams_visible:10,this.hideHeader=e.hide_header||!1,this.selectedGroup=e.selected_group||"",this.showEventToasts=!0===e.show_event_toasts,this.highlightTeam=(e.highlight_team||e.my_team||"").toLowerCase(),this.showStats=!1!==e.show_stats,this.showGoalsFor=!0===e.show_goals_for,this.compactMode=!0===e.compact_mode,this.compactTop=parseInt(e.compact_top)||5,this.compactBottom=parseInt(e.compact_bottom)||3,this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null}_t(e,t){return pe(e,de(this.hass,this._config),t)}connectedCallback(){super.connectedCallback(),this._subscribeToEvents()}disconnectedCallback(){super.disconnectedCallback(),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass&&this.hass.connection&&(this._eventSubscriptions=[],["soccer_live_goal","soccer_live_yellow_card","soccer_live_red_card"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleCalcioLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this._config.entity||"",a=e.competition_code;if(!a)return!1;const i=a.replace(/\./g,"_").toLowerCase();return t.toLowerCase().includes(i)}_handleCalcioLiveEvent(e){const t=e.event_type,a=e.data;this._eventBelongsToThisCard(a)&&this.showEventToasts&&this._showEventToast(t,a)}_showEventToast(e,t){let a="",i="goal";"soccer_live_goal"===e?(a=`<strong>${this._t("event.goal").toUpperCase()}!</strong> ${t.player} · ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="goal"):"soccer_live_yellow_card"===e?(a=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="yellow"):"soccer_live_red_card"===e?(a=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="red"):"soccer_live_match_finished"===e&&(a=`<strong>${this._t("status.finished")}!</strong> ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="finished"),a&&(this._toastMessage=a,this._toastVariant=i,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}getCardSize(){return 5}static getConfigElement(){return document.createElement("soccer-live-classifica-editor")}static getStubConfig(){return{entity:"sensor.soccerlive",max_teams_visible:10,hide_header:!1,selected_group:"",show_event_toasts:!1}}_getZoneConfig(){if(this._config.zone_config)return this._config.zone_config;if(this._config.zone_preset&&fe[this._config.zone_preset])return fe[this._config.zone_preset];return this._inferPresetFromEntity()||{champions:[],europa:[],conference:[],relegation:null}}_getZoneLabels(){const e=this._getZoneConfig().labels||{};return{champions:void 0!==e.champions?e.champions:"zone.champions",europa:void 0!==e.europa?e.europa:"zone.europa",conference:void 0!==e.conference?e.conference:"zone.conference",relegation:void 0!==e.relegation?e.relegation:"zone.relegation"}}_hasZonePositions(e){return!!e&&(Array.isArray(e)?e.length>0:"string"==typeof e&&/^bottom\d+$/.test(e))}_inferPresetFromEntity(){const e=(this._config.entity||"").toLowerCase(),t=this.hass&&this._config.entity?this.hass.states[this._config.entity]:null,a=t&&t.attributes?String(t.attributes.competition_code||"").toLowerCase():"";for(const[,t]of Object.entries(fe))if(t.match&&t.match(a,e))return t;return null}_positionInZone(e,t,a){if(!a)return!1;const i=String(a).match(/^bottom(\d+)$/);if(i){const a=parseInt(i[1],10);return t&&e>t-a}return!!Array.isArray(a)&&a.includes(Number(e))}_translatePhase(e){return e?{"regular-season":this._t("phase.regular_season"),"regular season":this._t("phase.regular_season"),"group-stage":this._t("phase.group_stage"),"group stage":this._t("phase.group_stage"),playoffs:this._t("phase.playoffs")}[String(e).toLowerCase()]||e:""}_shouldShowPhase(e){return!!e&&("regular-season"!==String(e).toLowerCase()&&!/\d{4}/.test(e))}_isCupGroupStage(){const e=this._getZoneConfig();return e&&"cup_group"===e.kind}_groupHasNoMatches(e){if(!e||!e.length)return!1;const t=e=>{if(null==e||""===e)return 0;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?0:t};return e.every((e=>t(e.wins)+t(e.draws)+t(e.losses)===0))}_zoneClass(e,t){const a=this._getZoneConfig();return this._positionInZone(e,t,a.champions)?1!==e||this._isCupGroupStage()?"zone-cl":"zone-cl rank-first":this._positionInZone(e,t,a.europa)?"zone-el":this._positionInZone(e,t,a.conference)?"zone-conf":this._positionInZone(e,t,a.relegation)?"zone-rel":"zone-default"}_sortStandings(e,t){let a=(e||[]).filter((e=>null!=e.rank));return t.includes("MLS")?(a=a.slice().sort(((e,t)=>t.points!==e.points?t.points-e.points:t.goal_difference!==e.goal_difference?t.goal_difference-e.goal_difference:t.goals_for-e.goals_for)),a.forEach(((e,t)=>{e.rank=t+1}))):a=a.slice().sort(((e,t)=>e.rank-t.rank)),a}_currentGroup(e){return e.find((e=>e.name===this.selectedGroup))||e[0]}render(){if(!this.hass||!this._config)return q``;const e=this._config.entity,t=this.hass.states[e];if(!t)return q`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;const a=t.attributes.season||"",i=t.attributes.league_abbreviation&&"N/A"!==t.attributes.league_abbreviation?t.attributes.league_abbreviation:null,s=i&&t.attributes.league_name?a.replace(t.attributes.league_name,i).trim():a,n=t.attributes.standings_groups||[],o=!this.selectedGroup&&n.length>1,r=this._currentGroup(n),l=this._sortStandings(r?r.standings:[],s),c=l.length,d=48*Math.min(this.maxTeamsVisible,c)+50,p=this.highlightTeam?(l.find((e=>e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam)))||{}).rank:null,h=Math.round(l.reduce(((e,t)=>e+(parseInt(t.games_played)||0)),0)/2),g=l.reduce(((e,t)=>e+(parseInt(t.goals_for)||0)),0),u=(t.attributes.standings_groups||[]).some((e=>(e.standings||[]).some((e=>(parseInt(e.games_played)||0)>0)))),m=!u&&c>0&&l.every((e=>0===parseInt(e.wins??"0")&&0===parseInt(e.draws??"0")&&0===parseInt(e.losses??"0")));return q`
      <ha-card>
        ...
        ${this.hideHeader?"":this._renderHeader(t,s,r,n,o,p)}

        ${m?q`
          <div class="preseason-banner">
            <span class="preseason-icon">🗓️</span>
            <span>Seizoen ${s||""} is nog niet begonnen</span>
          </div>
        `:""}

        ${o?this._renderGroupsGrid(n,s):q`
            <div class="table-wrap" style="max-height: ${d}px;">
              ${this._renderFullTable(l,c)}
            </div>
          `}

        ${this.showStats&&h>0?q`
    ...
    `}_renderFullTable(e,t){let a=e,i=null;if(this.compactMode&&t>this.compactTop+this.compactBottom){const s=e.slice(0,this.compactTop),n=e.slice(t-this.compactBottom),o=t-this.compactTop-this.compactBottom,r=this.highlightTeam?e.slice(this.compactTop,t-this.compactBottom).find((e=>e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam))):null;a=[...s,...r?[r]:[],{_separator:!0,hiddenCount:o},...n],i=!0}return q`
      <table class="standings-table">
        ...
        <tbody>
          ${a.map((e=>{if(e._separator)return q`
              <tr class="separator-row">
                <td colspan="8">
                  <span class="separator-dots">· · · ${e.hiddenCount} ${this._t("standings.compact_hidden")} · · ·</span>
                </td>
              </tr>`;const a=this.highlightTeam&&e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam),i=e=>{if(null==e||""===e)return null;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?null:t},s=i(e.wins),n=i(e.draws),o=i(e.losses),r=i(e.goal_difference),l=null!==s&&null!==n&&null!==o?s+n+o:null,c=null===r?"":r>0?"gd-pos":r<0?"gd-neg":"",d=null===r?"-":r>0?`+${r}`:`${r}`;return q`
              <tr class="${this._zoneClass(e.rank,t)} ${a?"highlighted-team":""}">
                ...
                <td class="team-cell">
                  ...
                  <div class="tname-group">
                    ...
                    ${this.showGoalsFor&&e.goals_for&&parseInt(e.goals_for)>=0?q`<span class="goals-for-hint">⚽ ${e.goals_for}</span>`:""}
                  </div>
                </td>
                <td>${l??"-"}</td>
                <td>${s??"-"}</td>
    ...
    `}_renderCompactTable(e,t){return q`
      <table class="standings-table compact">
        ...
        <tbody>
          ${e.map((e=>{const a=(e=>{if(null==e||""===e)return null;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?null:t})(e.goal_difference),i=null===a?"":a>0?"gd-pos":a<0?"gd-neg":"",s=null===a?"-":a>0?`+${a}`:`${a}`;return q`
    ...
    `}_renderHeader(e,t,a,i,s,n){const o=this._getZoneConfig(),r=this._isCupGroupStage(),l=o&&o.hero?o.hero:null,c=e.attributes.league_abbreviation&&"N/A"!==e.attributes.league_abbreviation?e.attributes.league_abbreviation:null,d=c&&t?t.replace(c,"").trim():t&&"n/a"!==t.toLowerCase()?t:"",p=s?this._t("phase.group_stage"):this._shouldShowPhase(a&&a.name)?this._translatePhase(a.name):"",h=[];c&&h.push(this._t("card.standings")),d&&h.push(d),p&&h.push(p);let g=0;if(s)for(const e of i)g+=(e.standings||[]).filter((e=>null!=e.rank)).length;return q`
      <div class="top-bar ${r?"top-bar-cup":""} ${l?`accent-${l.accent}`:""}">
        ${l&&l.icon?q`<div class="hero-icon">${l.icon}</div>`:""}
        <div class="league-title">
          <h2>${c||e.state}</h2>
          <div class="sub">${h.join(" · ")}</div>
        </div>
        ${n?q`<span class="highlight-pos-badge">${n}e</span>`:""}
        ${s&&r?q`
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-classifica",name:"Soccer Live Standings Card",description:"Shows the standings for a league or cup competition"}),customElements.define("soccer-live-classifica-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array},groups:{type:Array}}}constructor(){super(),this.entities=[],this.groups=[]}static get styles(){return n`
      .card-config {
        display: flex;
        flex-direction: column;
        gap: 16px;
    ...
    `}}),customElements.define("soccer-live-matches",class extends oe{static get properties(){return{hass:{},_config:{},showPopup:{type:Boolean},activeMatch:{type:Object},_eventSubscriptions:{type:Array},_recentEventMatches:{type:Object},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}constructor(){super(),this._recentEventMatches=new Map,this._eventSubscriptions=[],this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.maxEventsVisible=e.max_events_visible?e.max_events_visible:5,this.maxEventsTotal=e.max_events_total?e.max_events_total:50,this.showFinishedMatches=void 0===e.show_finished_matches||e.show_finished_matches,this.hideHeader=void 0!==e.hide_header&&e.hide_header,this.hidePastDays=void 0!==e.hide_past_days?e.hide_past_days:0,this.reverseOrder=!0===e.reverse_order,this.showEventToasts=!0===e.show_event_toasts,this.myTeam=(e.my_team||"").toLowerCase(),this.showLiveTicker=!1!==e.show_live_ticker,this.activeMatch=null,this.showPopup=!1}_t(e,t){return pe(e,de(this.hass,this._config),t)}connectedCallback(){super.connectedCallback(),this._subscribeToEvents()}disconnectedCallback(){super.disconnectedCallback(),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass&&this.hass.connection&&(this._eventSubscriptions=[],["soccer_live_goal","soccer_live_yellow_card","soccer_live_red_card"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleCalcioLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this.hass.states[this._config.entity];return!!t&&(t.attributes.matches||[]).some((t=>t.home_team===e.home_team&&t.away_team===e.away_team))}_handleCalcioLiveEvent(e){const t=e.event_type,a=e.data;if(!this._eventBelongsToThisCard(a))return;const i=`${a.home_team}_${a.away_team}`;this._recentEventMatches.set(i,"soccer_live_goal"===t?"goal":"card"),this.requestUpdate(),setTimeout((()=>{this._recentEventMatches.delete(i),this.requestUpdate()}),5e3),"soccer_live_goal"===t&&requestAnimationFrame((()=>this._triggerGoalCelebration())),this.showEventToasts&&this._showEventToast(t,a)}_triggerGoalCelebration(){const e=this.shadowRoot&&this.shadowRoot.querySelector("ha-card");if(!e)return;e.querySelectorAll(".confetti").forEach((e=>e.remove()));const t=["#ec4899","#6366f1","#06b6d4","#fbbf24","#10b981","#ef4444"],a=["⚽","🎉","✨","🔥","⭐"];for(let i=0;i<28;i++){const i=document.createElement("div");i.className="confetti",Math.random()>.55?(i.textContent=a[Math.floor(Math.random()*a.length)],i.style.fontSize=12+10*Math.random()+"px",i.style.background="transparent"):(i.style.background=t[Math.floor(Math.random()*t.length)],i.style.borderRadius=Math.random()>.5?"50%":"2px"),i.style.setProperty("--dx",380*(Math.random()-.5)+"px"),i.style.setProperty("--dy",200*Math.random()+80+"px"),i.style.animationDelay=.4*Math.random()+"s",e.appendChild(i),setTimeout((()=>i.remove()),2200)}}_showEventToast(e,t){let a="",i="goal";"soccer_live_goal"===e?(a=`<strong>${this._t("event.goal").toUpperCase()}!</strong> ${t.player} · ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="goal"):"soccer_live_yellow_card"===e?(a=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="yellow"):"soccer_live_red_card"===e&&(a=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="red"),a&&(this._toastMessage=a,this._toastVariant=i,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}getCardSize(){return 4}static getConfigElement(){return document.createElement("soccer-live-matches-editor")}static getStubConfig(){return{entity:"sensor.soccerlive",max_events_visible:5,max_events_total:50,hide_past_days:0,show_finished_matches:!0,hide_header:!1,show_event_toasts:!1}}_parseMatchDate(e){if(!e)return null;const[t,a]=e.split(" "),[i,s,n]=t.split(/[-\/]/).map(Number),[o,r]=a?a.split(":").map(Number):[0,0];return new Date(n,s-1,i,o,r)}_matchTimeLabel(e){if("in"===e.state)return e.clock&&"N/A"!==e.clock?e.clock:"LIVE";if("post"===e.state)return"FT";if(e.date){const t=e.date.split(" ");return t[1]||t[0]}return"—"}_matchScore(e,t){if("pre"===e.state)return"-";const a=e["home"===t?"home_score":"away_score"];return null==a||"N/A"===a?"-":a}_isWinner(e,t){if("pre"===e.state)return null;const a=parseInt(e.home_score),i=parseInt(e.away_score);return isNaN(a)||isNaN(i)||a===i?null:"home"===t?a>i:i>a}_dayKey(e){if(!e.date)return"—";const t=this._parseMatchDate(e.date);if(!t)return e.date.split(" ")[0]||"—";const a=new Date;a.setHours(0,0,0,0);const i=new Date(t);i.setHours(0,0,0,0);const s=Math.round((i-a)/864e5);if(0===s)return"⚡ "+this._t("time.today");if(-1===s)return this._t("time.yesterday");if(1===s)return this._t("time.tomorrow");const n=this._t("month."+(i.getMonth()+1));return`${i.getDate()} ${n}`}showDetails(e){this.activeMatch=e,this.showPopup=!0}closePopup(){this.showPopup=!1}separateEvents(e){const t=[],a=[],i=[];return e.forEach((e=>{const s=String(e||"");s.includes("Goal")||s.includes("Penalty - Scored")?t.push(this.formatMatchEvent(s)):s.includes("Yellow Card")?a.push(this.formatMatchEvent(s)):s.includes("Red Card")&&i.push(this.formatMatchEvent(s))})),{goals:t,yellowCards:a,redCards:i}}formatMatchEvent(e){const t=e=>this._t(e);let a=String(e||"").trim();a=a.replace(/^Goal\s*-\s*/i,"").replace(/^Yellow Card\s*-\s*/i,"").replace(/^Red Card\s*-\s*/i,"").replace(/^Penalty - Scored\s*-\s*/i,`${t("event.penalty")} - `).replace(/^Header\s*-\s*/i,`${t("event.header")} - `).replace(/^Shot\s*-\s*/i,`${t("event.shot")} - `).replace(/^Free-kick\s*-\s*/i,`${t("event.free_kick")} - `).replace(/^Penalty\s*-\s*/i,`${t("event.penalty")} - `),a=a.replace(/^([^:]+):\s*/,"$1 ");const i=[t("event.header"),t("event.shot"),t("event.penalty"),t("event.free_kick")].map((e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")));return a=a.replace(new RegExp(`^(${i.join("|")})\\s*-\\s*(.+)$`,"i"),((e,t,a)=>`${a} (${t.toLowerCase()})`)),a=a.replace(/\bN\/A\b/g,t("generic.unknown")),a}render(){if(!this.hass||!this._config)return q``;const e=this._config.entity,t=this.hass.states[e];if(!t)return q`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;let a=t.attributes.matches||[];const i=t.attributes.league_info?t.attributes.league_info[0]:null,s=t.attributes.team_logo||null;if(this.showFinishedMatches||(a=a.filter((e=>"Full Time"!==e.status))),a=a.slice().sort(((e,t)=>{const a=this._parseMatchDate(e.date)||new Date(0),i=this._parseMatchDate(t.date)||new Date(0);return this.reverseOrder?i-a:a-i})),this.hidePastDays>0){const e=new Date;e.setDate(e.getDate()-this.hidePastDays),a=a.filter((t=>{const a=this._parseMatchDate(t.date);return!a||a>=e}))}const n=a.slice(0,this.maxEventsTotal);if(0===n.length)return q`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const o=n.filter((e=>"in"===e.state)).length,r=new Set(n.map((e=>e.league_name)).filter((e=>e&&"N/A"!==e))),l=r.size>1,c=[];let d=null;n.forEach((e=>{const t=this._dayKey(e);if(t!==d){d=t;const a=this._parseMatchDate(e.date);let i=null;if(a){const e=new Date;e.setHours(0,0,0,0);const t=new Date(a);t.setHours(0,0,0,0),i=Math.round((t-e)/864e5)}c.push({key:t,dayDiff:i,matches:[e]})}else c[c.length-1].matches.push(e)}));const p=Math.max(80*this.maxEventsVisible,240),h=n.filter((e=>"in"===e.state)),g=h.map((e=>`${e.home_abbrev||e.home_team}  ${e.home_score??"-"} - ${e.away_score??"-"}  ${e.away_abbrev||e.away_team}`)).join("     ·     ");return q`
      <ha-card>
        ...
        ${this.showLiveTicker&&h.length>0?q`
        ...
        ${this.hideHeader?"":q`
          <div class="matches-header">
            ${i&&i.logo_href?q`<img class="league-logo" src="${i.logo_href}" alt="${i.abbreviation||""}" />`:s?q`<img class="league-logo" src="${s}" alt="" />`:""}
            <div class="league-info">
              <div class="league-name">${i&&i.abbreviation||t.state||"Soccer Live"}</div>
              <div class="league-dates">
                ${(()=>{const e=t.attributes.total_matches||t.attributes.matches?.length||0,a=t.attributes.finished_matches_count??(t.attributes.matches||[]).filter((e=>"post"===e.state)).length;return e>0&&a>=0?`${a} / ${e} gespeeld`:i&&i.startDate?`${i.startDate} → ${i.endDate}`:this._t("generic.matches_count",{n:n.length})})()}
              </div>
            </div>
        ...
        <div class="scroll-content" style="max-height: ${p}px;">
          ${c.map((e=>q`
            <div class="day-divider ${0===e.dayDiff?"today":-1===e.dayDiff?"yesterday":1===e.dayDiff?"tomorrow":""}">
              ${e.key}
              ${null!==e.dayDiff&&e.dayDiff>1?q`<span class="day-rel">· over ${e.dayDiff} d</span>`:""}
            </div>
            ${e.matches.map((e=>{const t=`${e.home_team}_${e.away_team}`,a="in"===e.state,i=this._recentEventMatches.get(t),s=this._isWinner(e,"home"),n=this._isWinner(e,"away"),o=e.broadcast&&""!==e.broadcast&&"N/A"!==e.broadcast?e.broadcast:"",r="pre"===e.state,c=this.myTeam&&e.home_team&&e.home_team.toLowerCase().includes(this.myTeam),d=this.myTeam&&e.away_team&&e.away_team.toLowerCase().includes(this.myTeam);return q`
                <div class="match-row ${a?"live":""} ${"goal"===i?"goal-pulse":""} ${"card"===i?"card-pulse":""}"
                  ...
                  <div class="match-teams">
                    <div class="match-team">
                      ...
                      <span class="name ${!0===s?"winner":!1===s?"loser":""} ${c?"my-team-name":""}">${e.home_team}</span>
                      <span class="score ${!0===s?"winner":!1===s?"loser":""}">${this._matchScore(e,"home")}</span>
                    </div>
                    <div class="match-team">
                      <img src="${e.away_logo}" alt="${e.away_team}" />
                      <span class="name ${!0===n?"winner":!1===n?"loser":""} ${d?"my-team-name":""}">${e.away_team}</span>
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-matches",name:"Soccer Live Matches Card",description:"Shows all matches for a competition or team"}),customElements.define("soccer-live-matches-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      .card-config {
        display: flex;
        flex-direction: column;
        gap: 16px;
    ...
    `}});const ve=new Map,be=new Map,_e={"Feyenoord Stadium":{lat:51.8896,lon:4.5219},"Stadion de Kuip":{lat:51.8896,lon:4.5219},"Ajax Stadium":{lat:52.3145,lon:4.9425},"Johan Cruijff Arena":{lat:52.3145,lon:4.9425},"Sanako Stadium":{lat:52.1601,lon:5.985},"Philips Stadion":{lat:51.3542,lon:5.2862},"Allianz Arena":{lat:48.2188,lon:11.6247},"Signal Iduna Park":{lat:51.4532,lon:7.4516},"Stamford Bridge":{lat:51.4821,lon:-.191},"Old Trafford":{lat:53.4632,lon:-2.291},"Camp Nou":{lat:41.3815,lon:2.1229},"Spotify Camp Nou":{lat:41.3815,lon:2.1229},"Santiago Bernabéu":{lat:40.453,lon:-3.6883},"San Mamés":{lat:43.2627,lon:-2.9385}};function xe(e){return{0:"Clear",1:"Mostly clear",2:"Partly cloudy",3:"Cloudy",45:"Foggy",48:"Foggy",51:"Light rain",53:"Moderate rain",55:"Heavy rain",61:"Rain",63:"Heavy rain",65:"Very heavy rain",71:"Light snow",73:"Moderate snow",75:"Heavy snow",80:"Showers",82:"Heavy showers",95:"Thunderstorm",96:"Thunderstorm + hail",99:"Thunderstorm + heavy hail"}[e]||"Unknown"}const ye=n`
  .weather-badge {
    display: inline-flex;
    align-items: center;
    gap: 6px;
...
`;async function we(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;if(!e||"N/A"===e)return q``;try{const i=await async function(e){if(!e||"N/A"===e)return null;if(ve.has(e))return ve.get(e);if(_e[e])return ve.set(e,_e[e]),_e[e];try{const t=await fetch(`https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(e+" stadium")}&format=json&limit=1`,{headers:{"Accept-Language":"en"}}),a=await t.json();if(a&&a.length>0){const t={lat:parseFloat(a[0].lat),lon:parseFloat(a[0].lon)};return ve.set(e,t),t}}catch(e){console.warn("Geocoding failed:",e)}return null}(e);if(!i)return q``;const s=await async function(e,t){const a=`${e},${t}`;if(be.has(a)){const e=be.get(a);if(Date.now()-e.timestamp<36e5)return e.data}try{const n=await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${e}&longitude=${t}&current=temperature_2m,weather_code,wind_speed_10m&timezone=auto`),o=await n.json();if(o.current){const e=o.current.wind_speed_10m,t={temp:Math.round(o.current.temperature_2m),code:o.current.weather_code,wind:(s=e,s<1?0:s<6?1:s<12?2:s<20?3:s<29?4:s<39?5:s<50?6:s<62?7:s<75?8:s<89?9:s<103?10:s<118?11:12),wind_unit:"BFT",icon:(i=o.current.weather_code,i&&0!==i&&1!==i?2===i?"⛅":3===i?"☁️":45===i||48===i?"🌫️":51===i||53===i||55===i||61===i||63===i||65===i?"🌧️":71===i||73===i||75===i||77===i?"🌨️":80===i||81===i||82===i?"🌧️":85===i||86===i?"🌨️":95===i||96===i||99===i?"⛈️":"🌤️":"☀️"),description:xe(o.current.weather_code),timestamp:Date.now()};return be.set(a,{data:t,timestamp:Date.now()}),t}}catch(e){console.warn("Weather fetch failed:",e)}var i,s;return null}(i.lat,i.lon);if(!s)return q``;const n=t?pe("weather.wind",de(t,a)):"Wind speed (Beaufort)";return q`
    ...
    `}render(){if(!this.hass||!this._config)return q``;const e=this._config.entity,t=this.hass.states[e];if(!t)return q`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;if(!t.attributes.matches||0===t.attributes.matches.length)return q`
        ...
        </ha-card>`;const a=t.attributes.matches[0],i=t.attributes.league_info?t.attributes.league_info[0]:null,s=i&&i.logo_href&&"N/A"!==i.logo_href?i.logo_href:null,n="in"===a.state,o="post"===a.state,r=n||o,l=i&&i.abbreviation&&"N/A"!==i.abbreviation?i.abbreviation:a.league_name&&"N/A"!==a.league_name?a.league_name:a.season_info&&"N/A"!==a.season_info&&this._shouldShowPhase(a.season_info)?this._translatePhase(a.season_info):"",c=a.venue&&"N/A"!==a.venue?a.venue:"",d=a.venue_city&&"N/A"!==a.venue_city?a.venue_city:"",p=c?d?`${c}, ${d}`:c:"—",h=a.broadcast&&""!==a.broadcast&&"N/A"!==a.broadcast?a.broadcast:"",g=parseInt(a.attendance,10),u=!isNaN(g)&&g>0,m=this._hexToRgb(a.home_color),f=this._hexToRgb(a.away_color),v=m||f?`background:\n      radial-gradient(ellipse at 0% 0%, rgba(${m||"99,102,241"},0.18), transparent 55%),\n      radial-gradient(ellipse at 100% 100%, rgba(${f||"236,72,153"},0.18), transparent 55%)`:"",b=this.myTeam||(t.attributes.team_name||"").toLowerCase(),_=b&&a.home_team&&a.home_team.toLowerCase().includes(b),x=b&&a.away_team&&a.away_team.toLowerCase().includes(b);return q`
      <ha-card class="${n?"live":""}">
        <div class="bg-logos">
        ...
        <div class="scoreboard">
          <div class="team-side home">
            ...
            ${n?"":this._renderTopScorer(a.home_top_scorer)}
          </div>
          ...
          <div class="team-side away">
            ...
            ${n?"":this._renderTopScorer(a.away_top_scorer)}
          </div>
        </div>

        ${n?this._renderStatsRow(a):""}
    ...
    `}_relativeDate(e){if(!e)return"";const t=e.split(" "),[a,i,s]=(t[0]||"").split(/[-\/]/).map(Number);if(!a||!i||!s)return t[0]||"";const n=new Date(s,i-1,a),o=new Date;o.setHours(0,0,0,0);const r=Math.round((n-o)/864e5);if(1===r)return this._t("time.tomorrow");if(r<=6&&r>1)return this._t("time.in_n_d",{n:r});de(this.hass,this._config);const l=`month.${i}`;return`${a} ${this._t(l)}`}_teamBadge(e,t){const a=t&&"N/A"!==t?`#${t.replace("#","")}`:"rgba(var(--cl-accent-rgb),0.25)";return q`<span class="abbrev-badge" style="background:${a}">${e}</span>`}_renderFormTrend(e,t,a){const i=(a||"").toLowerCase(),s=e&&e.length>0?e:(t||[]).filter((e=>"post"===e.state)).slice(-10).reverse();if(0===s.length)return"";const n=s.map((e=>{const t=e.home_team&&e.home_team.toLowerCase().includes(i),a=parseInt(e.home_score),s=parseInt(e.away_score);return isNaN(a)||isNaN(s)?null:a===s?"D":t&&a>s||!t&&s>a?"W":"L"})).filter(Boolean).reverse();if(0===n.length)return"";const o=n.filter((e=>"W"===e)).length,r=n.filter((e=>"D"===e)).length,l=n.filter((e=>"L"===e)).length;return q`
      <div class="form-trend-section">
        ...
        <div class="form-trend-row">
          <div class="form-trend-dots">
            ${n.map((e=>q`<span class="ft-dot ${e.toLowerCase()}">${e}</span>`))}
          </div>
          <span class="form-trend-summary">${o}W ${r}G ${l}V</span>
        </div>
      </div>
    `}_renderPreviousMatches(e,t,a){const i=e&&e.length>0?e:t?t.filter((e=>"post"===e.state)).slice(-3).reverse():[];if(0===i.length)return"";const s=(a||"").toLowerCase();return q`
      <div class="upcoming-list">
        <div class="upcoming-list-title">${this._t("team.previous_matches")}</div>
        ${i.map((e=>{const t=s&&e.home_team&&e.home_team.toLowerCase().includes(s),a=s&&e.away_team&&e.away_team.toLowerCase().includes(s),i=parseInt(e.home_score),n=parseInt(e.away_score),o=!isNaN(i)&&!isNaN(n)&&i>n,r=!isNaN(i)&&!isNaN(n)&&n>i;return q`
    ...
    `}_renderUpcomingList(e,t,a){const i=e&&e.length>0?e:t&&t.length>1?t.slice(1).filter((e=>"pre"===e.state||"in"===e.state)).slice(0,4):[];if(0===i.length)return"";const s=(a||"").toLowerCase();return q`
      <div class="upcoming-list">
        <div class="upcoming-list-title">${this._t("team.upcoming_matches")}</div>
        ${i.map((e=>{const t=s&&e.home_team&&e.home_team.toLowerCase().includes(s),a=s&&e.away_team&&e.away_team.toLowerCase().includes(s),i="in"===e.state,n=e.head_to_head&&e.head_to_head.length>0;return q`
    ...
    `}_renderH2H(e){if(!e||0===e.length)return"";const t=e.slice(0,3);return q`
      <div class="h2h-section">
        ...
        ${t.map((e=>{const t=e.date?e.date.split("T")[0].split("-"):[],a=3===t.length?`${t[2]}/${t[1]}/${t[0].slice(2)}`:"",i=parseInt(e.home_score)>parseInt(e.away_score),s=parseInt(e.away_score)>parseInt(e.home_score);return q`
            <div class="h2h-row">
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-team",name:"Soccer Live Team Card",description:"Shows the next or current match for your team"}),customElements.define("soccer-live-team-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      .card-config {
        display: flex;
        flex-direction: column;
        gap: 16px;
    ...
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.target.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.checked;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.value;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_next"))).sort())}render(){if(!this._config||!this.hass)return q``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return q`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
          <label class="field-label">Entity</label>
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-news",name:"Soccer Live News Card",description:"Shows the latest football news for a competition"}),customElements.define("soccer-live-news-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
    ...
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.target.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.checked;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.value;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_numberChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=parseInt(t.value,10);isNaN(i)||this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_news"))).sort())}render(){if(!this._config||!this.hass)return q``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return q`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
    ...
    `}render(){if(!this.hass||!this._config)return q``;const e=this.hass.states[this._config.entity];if(!e)return q`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(0===t.length)return q`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const a=t[0],i=a.lineup_home||e.attributes.lineup_home||[],s=a.lineup_away||e.attributes.lineup_away||[],n=a.formation_home||e.attributes.formation_home||"",o=a.formation_away||e.attributes.formation_away||"";if(0===i.length&&0===s.length)return q`
      ...
      `;const r=this._starters(i),l=this._bench(i),c=this._starters(s),d=this._bench(s);return q`
      <ha-card>
        <div class="hero-bg"></div>
        ${this.hideHeader?"":q`
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-lineup",name:"Soccer Live Lineup Card",description:"Shows the lineups of both teams for the current or upcoming match"}),customElements.define("soccer-live-lineup-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      .card-config { display: flex; flex-direction: column; gap: 16px; }
      .option { display: flex; align-items: center; justify-content: space-between; gap: 12px; }
      label { font-size: 14px; color: var(--primary-text-color); }
      .field-label { display: block; font-size: 12px; color: var(--secondary-text-color); margin-bottom: 4px; font-weight: 600; }
    ...
    `}}),customElements.define("soccer-live-timeline",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.reverseOrder=!0===e.reverse_order}_t(e,t){return pe(e,de(this.hass,this._config),t)}getCardSize(){return 5}static getConfigElement(){return document.createElement("soccer-live-timeline-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_next",hide_header:!1,reverse_order:!0}}_eventMeta(e){const t=(e.type||"").toLowerCase(),a=(e.type_text||"").toLowerCase();return a.includes("kickoff")||"kickoff"===t?{icon:"⚽",label:this._t("status.kickoff"),cls:"meta"}:a.includes("halftime")||a.includes("intervallo")?{icon:"⏸",label:this._t("status.halftime"),cls:"meta"}:a.includes("start 2nd")||a.includes("secondo tempo")?{icon:"▶",label:this._t("status.second_half"),cls:"meta"}:a.includes("end regular")||a.includes("full time")?{icon:"🏁",label:this._t("status.end"),cls:"meta"}:"goal"===t||e.scoring_play?{icon:"⚽",label:this._t("event.goal"),cls:"goal"}:a.includes("penalty")?{icon:"⚽",label:this._t("timeline.penalty"),cls:"goal"}:a.includes("yellow card")?{icon:"🟨",label:this._t("event.yellow_card"),cls:"yellow"}:a.includes("red card")?{icon:"🟥",label:this._t("event.red_card"),cls:"red"}:"substitution"===t||a.includes("substitution")?{icon:"🔄",label:this._t("event.substitution"),cls:"sub"}:a.includes("var")?{icon:"📺",label:this._t("event.var"),cls:"meta"}:{icon:"·",label:e.type_text||this._t("timeline.event"),cls:"meta"}}render(){if(!this.hass||!this._config)return q``;const e=this.hass.states[this._config.entity];if(!e)return q`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${this._config.entity}</ha-card>`;const t=e.attributes.matches||[];if(0===t.length)return q`<ha-card class="empty">${this._t("generic.no_match")}</ha-card>`;const a=t[0],i=a.key_events||e.attributes.key_events||[];if(0===i.length)return q`
      ...
      `;const s=this.reverseOrder?[...i].reverse():i;return q`
      <ha-card>
        <div class="hero-bg"></div>
        ${this.hideHeader?"":q`
          <div class="tl-header">
        ...
        <div class="tl-body">
          ${s.map((e=>{const t=this._eventMeta(e),i=a.home_team&&e.team===a.home_team,s=a.away_team&&e.team===a.away_team,n=i?"home":s?"away":"meta",o=(e.athletes||[]).filter(Boolean);return q`
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-timeline",name:"Soccer Live Timeline Card",description:"Minute-by-minute timeline of match events"}),customElements.define("soccer-live-timeline-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      .card-config { display: flex; flex-direction: column; gap: 16px; }
      .option { display: flex; align-items: center; justify-content: space-between; gap: 12px; }
      label { font-size: 14px; color: var(--primary-text-color); }
      .field-label { display: block; font-size: 12px; color: var(--secondary-text-color); margin-bottom: 4px; font-weight: 600; }
    ...
    `}}),customElements.define("soccer-live-bracket",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.hideHeader=!0===e.hide_header,this.compactMode=!0===e.compact,this._cardStyle="tree"===e.style?"tree":"list",this.treeShowPlayoffs=!0===e.tree_show_playoffs}_t(e,t){return pe(e,de(this.hass,this._config),t)}_formatDate(e){if(!e)return"";try{const t=new Date(e),a=this._t("month."+(t.getMonth()+1));return`${t.getDate()} ${a}`}catch(e){return""}}_localizeRoundName(e){const t={Final:"round.final",Semifinals:"round.semifinals",Quarterfinals:"round.quarterfinals","Round of 16":"round.r16","Round of 32":"round.r32","Knockout Playoffs":"round.knockout_playoffs","Preliminary Round":"round.preliminary"}[e.name];return t?this._t(t):e.name}getCardSize(){return 6}static getConfigElement(){return document.createElement("soccer-live-bracket-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_bracket",hide_header:!1,compact:!1,style:"list"}}_formatScore(e){return null==e?"-":String(e)}_renderTie(e){const t=e.team_a||{},a=e.team_b||{},i=e.leg1,s=e.leg2,n=e.single,o=e.winner_team,r=o&&t.name&&o===t.name,l=o&&a.name&&o===a.name,c=(e,t)=>e&&t&&t.name?e.home_team===t.name?e.home_score:e.away_team===t.name?e.away_score:null:null,d=c(i,t),p=c(i,a),h=c(s,t),g=c(s,a),u=c(n,t),m=c(n,a),f=i&&"in"===i.state||s&&"in"===s.state||n&&"in"===n.state,v=!i&&!n;return q`
      <div class="tie ${f?"live":""} ${e.completed?"done":""}">
        ...
        <div class="tie-row ${l?"winner":""} ${r?"loser":""}">
          ...
          <span class="legs">
            ${n?q`<span class="leg">${this._formatScore(m)}</span>`:q`
    ...
    `}_renderArrows(e,t){if(e<=0)return"";const a=2*e,i=[],s="left"===t,n=`arrow-${t}`;for(let t=0;t<e;t++){const o=(2*t+.5)/a*100,r=(2*t+1.5)/a*100,l=(t+.5)/e*100;s?(i.push(U`<line x1="0" y1="${o}%" x2="50%" y2="${o}%" stroke-linecap="round" />`),i.push(U`<line x1="0" y1="${r}%" x2="50%" y2="${r}%" stroke-linecap="round" />`),i.push(U`<line x1="50%" y1="${o}%" x2="50%" y2="${r}%" />`),i.push(U`<line x1="50%" y1="${l}%" x2="100%" y2="${l}%" marker-end="url(#${n})" />`)):(i.push(U`<line x1="100%" y1="${o}%" x2="50%" y2="${o}%" stroke-linecap="round" />`),i.push(U`<line x1="100%" y1="${r}%" x2="50%" y2="${r}%" stroke-linecap="round" />`),i.push(U`<line x1="50%" y1="${o}%" x2="50%" y2="${r}%" />`),i.push(U`<line x1="50%" y1="${l}%" x2="0" y2="${l}%" marker-end="url(#${n})" />`))}const o=s?U`<marker id="${n}" viewBox="0 0 10 10" refX="10" refY="5" markerWidth="7" markerHeight="7" markerUnits="strokeWidth" overflow="visible"><path d="M0,0 L10,5 L0,10 z" fill="var(--cl-accent)" /></marker>`:U`<marker id="${n}" viewBox="0 0 10 10" refX="0" refY="5" markerWidth="7" markerHeight="7" markerUnits="strokeWidth" overflow="visible"><path d="M10,0 L0,5 L10,10 z" fill="var(--cl-accent)" /></marker>`;return q`
    ...
    `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-bracket",name:"Soccer Live Bracket Card",description:"Knockout bracket for Champions League, Europa League, and other cup competitions"}),customElements.define("soccer-live-bracket-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      .card-config { display: flex; flex-direction: column; gap: 16px; }
      .option { display: flex; align-items: center; justify-content: space-between; gap: 12px; }
      label { font-size: 14px; color: var(--primary-text-color); }
      .field-label { display: block; font-size: 12px; color: var(--secondary-text-color); margin-bottom: 4px; font-weight: 600; }
      ...
      h3 { margin: 8px 0 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--secondary-text-color); }
      .hint { font-size: 12px; color: var(--secondary-text-color); }
    `}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}get config(){return this._config}updated(e){e.has("hass")&&this._fetchEntities()}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){if(!this._config)return;const t=e.target.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_switchChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.checked;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_selectChanged(e){if(!this._config)return;const t=e.target;if(!t.dataset||!t.dataset.configValue)return;const a=t.dataset.configValue,i=t.value;this._config[a]!==i&&this._fireConfigChanged({...this._config,[a]:i})}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_bracket"))).sort())}render(){if(!this._config||!this.hass)return q``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return q`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
          ...
          <div class="list">
            ${t.map(((e,t)=>q`
              <div class="scorer-row ${t%2==0?"even":""}">
                ...
                ${e.headshot?q`<img class="headshot" src="${e.headshot}" alt="${e.player}" @error=${e=>e.target.style.display="none"}>`:q`<div class="headshot-placeholder"></div>`}
                <div class="player-info">
                  <span class="player-name">${e.player}</span>
                  <span class="team-name">${e.team_name}</span>
                </div>
                ${e.team_logo?q`<img class="team-logo" src="${e.team_logo}" alt="${e.team_name}" @error=${e=>e.target.style.display="none"}>`:q`<div class="team-logo-placeholder"></div>`}
    ...
    `]}render(){if(!this.hass||!this._config)return q``;const e=this.hass.states[this._config.entity];if(!e)return q`<ha-card><div class="empty">Unknown entity: ${this._config.entity}</div></ha-card>`;const t=e.attributes.standings_groups||[];if(!t.length)return q`<ha-card><div class="empty">No standings data</div></ha-card>`;const a=t.find((e=>e.name===this._selectedGroup))||t[0],i=a&&a.standings||[],s=this._config.max_rows||i.length,n=(this._config.highlight_team||"").toLowerCase(),o=e.attributes.league_name||e.attributes.league_abbreviation||"",r=e.attributes.league_logo||"",l=i.slice(0,s),c=t.length>1;return q`
      <ha-card>
        ${this._config.hide_header?"":q`
          <div class="header">
            ${r?q`<img class="league-logo" src="${r}" alt="">`:""}
        ...
        <table>
          <tr>
            ...
            <th>P</th>
            ${this._config.hide_stats?"":q`<th>W</th><th>D</th><th>L</th><th>GD</th>`}
            <th>Pts</th>
          </tr>
          ${l.map((e=>{const t=n&&e.team_name&&e.team_name.toLowerCase().includes(n),a=(parseInt(e.wins)||0)+(parseInt(e.draws)||0)+(parseInt(e.losses)||0),i=parseInt(e.goal_difference)||0,s=i>0?`+${i}`:`${i}`;return q`
              <tr class="${t?"hl":""}">
                <td class="pos">${e.rank??""}</td>
                <td class="left">
                  <div class="team-row">
                    ${e.team_logo?q`<img class="team-logo" src="${e.team_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
                    <span class="team-name">${e.team_name||""}</span>
                  </div>
                </td>
                <td>${a||0}</td>
                ${this._config.hide_stats?"":q`<td>${e.wins??0}</td><td>${e.draws??0}</td><td>${e.losses??0}</td><td>${null!=e.goal_difference?s:0}</td>`}
                <td class="pts">${e.points??0}</td>
              </tr>
            `}))}
        </table>
      </ha-card>
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-mini-standings",name:"Soccer Live Mini Standings",description:"Compact standings table with group selector"});const Ce=["dark","light","red-white","classic","neon","gold"],ze=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-mini-standings-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      .card-config { display: flex; flex-direction: column; gap: 16px; }
      .option { display: flex; align-items: center; justify-content: space-between; gap: 12px; }
      label { font-size: 14px; color: var(--primary-text-color); }
      .field-label { display: block; font-size: 12px; color: var(--secondary-text-color); margin-bottom: 4px; font-weight: 600; }
      ...
      h3 { margin: 8px 0 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--secondary-text-color); }
    `}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_classifica"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_numberChanged(e){const t=parseInt(e.target.value,10);isNaN(t)||this._fire({...this._config,[e.target.dataset.configValue]:t})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}_textChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}render(){if(!this._config||!this.hass)return q``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return q`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${Ce.map((e=>q`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${ze.map((e=>q`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    `}}),customElements.define("soccer-live-countdown",class extends oe{static get properties(){return{hass:{},_config:{},_now:{},_weatherBadge:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e)}connectedCallback(){super.connectedCallback(),this._now=new Date,this._timer=setInterval((()=>{this._now=new Date,this.requestUpdate()}),1e3),this._loadWeather()}updated(e){(e.has("hass")||e.has("_config"))&&this._loadWeather()}async _loadWeather(){if(!this.hass||!this._config)return;const e=this.hass.states[this._config.entity];if(!e||!e.attributes.matches)return;const t=e.attributes.matches[0];if(t&&t.venue)try{this._weatherBadge=await we(t.venue,this.hass,this._config),this.requestUpdate()}catch(e){console.warn("Weather load failed:",e)}}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this._timer)}getCardSize(){return 3}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-countdown-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_next_"}}_parseDate(e){if(!e||"N/A"===e)return null;try{const[t,a]=e.split(" "),i=t.split(/[-\/]/).map(Number),[s,n]=(a||"00:00").split(":").map(Number);if(3===i.length){const[e,t,a]=i;return new Date(a,t-1,e,s,n)}}catch(e){}return null}_getNextMatch(e){const t=e.attributes.matches||[];return t.find((e=>"pre"===e.state))||t.find((e=>"in"===e.state))||t.find((e=>"post"===e.state))||t[0]||null}_countdown(e){const t=this._parseDate(e);if(!t)return null;const a=t-(this._now||new Date);return a<=0?null:{days:Math.floor(a/864e5),hours:Math.floor(a%864e5/36e5),mins:Math.floor(a%36e5/6e4),secs:Math.floor(a%6e4/1e3)}}static get styles(){return[he,ye,n`
      ha-card {
        background: var(--cl-bg);
        color: var(--cl-text);
        padding: 16px;
    ...
    `]}render(){if(!this.hass||!this._config)return q``;const e=this.hass.states[this._config.entity];if(!e)return q`<ha-card><div class="empty">Unknown entity: ${this._config.entity}</div></ha-card>`;const t=this._getNextMatch(e);if(!t)return q`<ha-card><div class="empty">No match data</div></ha-card>`;const a="in"===t.state,i="post"===t.state,s=a||i?null:this._countdown(t.date),n=t.competition_name||e.attributes.league_name||"",o=t.competition_logo||e.attributes.league_logo||"",r=t.venue&&"N/A"!==t.venue?t.venue:"",l=t.venue_city&&"N/A"!==t.venue_city?t.venue_city:"",c=this._t("cd.days")||"days",d=this._t("cd.hrs")||"hrs",p=this._t("cd.min")||"min",h=this._t("cd.sec")||"sec";return q`
      <ha-card>
        ${!this._config.hide_header&&n?q`
          <div class="header">
            ${o?q`<img class="comp-logo" src="${o}" alt="">`:""}
        ...
        <div class="teams">
          <div class="team">
            ${t.home_logo?q`<img class="team-logo" src="${t.home_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
          ...
          <div class="center">
            ${a?q`
              ...
              ${t.clock?q`<div class="minute">${t.clock}</div>`:""}
            `:i?q`
              <div class="ft-badge">FT</div>
              <div class="score">${t.home_score??0} - ${t.away_score??0}</div>
            `:s?q`
              ${t.date?q`<div class="sched-date">${t.date}</div>`:""}
              <div class="countdown">
                ${s.days>0?q`
                  <div class="cd-block"><span class="cd-num">${s.days}</span><span class="cd-label">${c}</span></div>
                  <span class="cd-sep">:</span>
                `:""}
                <div class="cd-block"><span class="cd-num">${String(s.hours).padStart(2,"0")}</span><span class="cd-label">${d}</span></div>
                <span class="cd-sep">:</span>
                <div class="cd-block"><span class="cd-num">${String(s.mins).padStart(2,"0")}</span><span class="cd-label">${p}</span></div>
                <span class="cd-sep">:</span>
                <div class="cd-block"><span class="cd-num">${String(s.secs).padStart(2,"0")}</span><span class="cd-label">${h}</span></div>
              </div>
            `:q`
              ${t.date?q`<div class="sched-date">${t.date}</div>`:""}
          ...
          <div class="team">
            ${t.away_logo?q`<img class="team-logo" src="${t.away_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-countdown",name:"Soccer Live Match Countdown",description:"Countdown to next match with live score"});const Ee=["dark","light","red-white","classic","neon","gold"],Se=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-countdown-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      ...
      select, input { width: 100%; padding: 10px 12px; font-size: 14px; border-radius: 8px; border: 1px solid var(--divider-color, rgba(0,0,0,0.12)); background: var(--card-background-color, #fff); color: var(--primary-text-color, #000); box-sizing: border-box; }
      h3 { margin: 8px 0 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--secondary-text-color); }
    `}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_next"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}render(){if(!this._config||!this.hass)return q``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return q`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${Ee.map((e=>q`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${Se.map((e=>q`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    `}});const Ae=n`
...
`,function(e,t,a){let i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return q`
  <ha-card style="padding: 16px; text-align: center; color: var(--error-color, #ef5350);">
    ...
    ${i?q`<div style="font-size: 11px; color: var(--text-primary-color); background: rgba(0,0,0,0.1); padding: 8px; border-radius: 4px; margin-top: 8px;">${i}</div>`:""}
  </ha-card>
`});customElements.define("soccer-live-live-match",class extends oe{static get properties(){return{hass:{},_config:{},_isLoading:{type:Boolean}}}constructor(){super(),this._isLoading=!0}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e)}getCardSize(){return 5}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-live-match-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_next_"}}_getMatch(e){const t=e.attributes.matches||[];return t.find((e=>"in"===e.state||"live"===e.status))||t.find((e=>"pre"===e.state||"scheduled"===e.status))||t.find((e=>"post"===e.state))||t[0]||null}_eventIcon(e){if(!e)return"📋";const t=(e||"").toLowerCase();return t.includes("goal")||t.includes("score")?"⚽":t.includes("yellow")?"🟨":t.includes("red")?"🟥":t.includes("sub")||t.includes("substitut")?"🔄":t.includes("pen")?"⚽🎯":"📋"}static get styles(){return[he,Ae,n`
    ...
    `]}updated(e){if(e.has("hass")){const e=this.hass?.states[this._config?.entity];e&&"unavailable"!==e.state&&(this._isLoading=!1)}}render(){if(!this.hass||!this._config)return Te("Loading...");const e=this.hass.states[this._config.entity];if(!e)return je("⚠️","Entity not found",`Unable to find: ${this._config.entity}`,"Check the entity configuration");if("unavailable"===e.state)return je("📡","Sensor unavailable","The integration may not be running","Restart Home Assistant or check the integration");if(this._isLoading)return Te("Fetching match data...");const t=this._getMatch(e);if(!t)return je("⚽","No match data","Unable to find match information","Check if the sensor has data");const a="in"===t.state||"live"===t.status,i="post"===t.state,s=("pre"===t.state||t.status,t.key_events||t.events||t.match_events||[]),n=t.competition_name||e.attributes.league_name||"",o=t.competition_logo||e.attributes.league_logo||"",r=t.venue&&"N/A"!==t.venue?t.venue:"",l=t.venue_city&&"N/A"!==t.venue_city?t.venue_city:"",c=t.stats||t.statistics||[];return q`
      <ha-card>
        <div class="hero">
          ${t.home_logo?q`<img class="bg-logo home" src="${t.home_logo}" alt="">`:""}
          ${t.away_logo?q`<img class="bg-logo away" src="${t.away_logo}" alt="">`:""}
          ...
          <div class="teams-row">
            ...
            <div class="score-center">
              ${a?q`<div class="live-badge">LIVE</div>`:i?q`<div class="sched-info">FT</div>`:q`<div class="sched-info">${t.date||this._t("match.vs")}</div>`}
              ${a||i?q`<div class="score">${t.home_score??0} - ${t.away_score??0}</div>`:q`<div class="vs-text">${this._t("match.vs")}</div>`}
              ${a&&t.clock?q`<div class="minute">${t.clock}</div>`:""}
            </div>
            ...
            ${s.map((e=>q`
              <div class="event-row">
                ...
                <div class="event-text">
                  ...
                  ${e.team?q`<div class="event-team">${e.team}</div>`:""}
                </div>
              </div>
            `))}
          </div>
        ...
        ${c.length>0?q`
          <div class="divider"></div>
          ${c.slice(0,this._config.max_stats||4).map((e=>{const t=parseFloat(e.home??e.homeValue??0)||0,a=t+(parseFloat(e.away??e.awayValue??0)||0);return a>0&&Math.round(t/a*100),q`
              <div class="stats-row">
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-live-match",name:"Soccer Live Match Card",description:"Live match details with events and stats"});const Ne=["dark","light","red-white","classic","neon","gold"],Me=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-live-match-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      ...
      select, input { width: 100%; padding: 10px 12px; font-size: 14px; border-radius: 8px; border: 1px solid var(--divider-color, rgba(0,0,0,0.12)); background: var(--card-background-color, #fff); color: var(--primary-text-color, #000); box-sizing: border-box; }
      h3 { margin: 8px 0 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--secondary-text-color); }
    `}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_next")||e.includes("soccerlive_all"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_numberChanged(e){const t=parseInt(e.target.value,10);isNaN(t)||this._fire({...this._config,[e.target.dataset.configValue]:t})}render(){if(!this._config||!this.hass)return q``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return q`
      <div class="card-config">
        <h3>Sensor</h3>
        <div>
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${Ne.map((e=>q`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${Me.map((e=>q`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    `}}),customElements.define("soccer-live-multi-team",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entities||!e.entities.length)throw new Error("At least one entity required");this._config=e,ue(this,e)}getCardSize(){return Math.max(2,(this._config.entities||[]).length+1)}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-multi-team-editor")}static getStubConfig(){return{entities:[]}}_getMatch(e){const t=e.attributes.matches||[];return t.find((e=>"in"===e.state))||t.find((e=>"pre"===e.state))||t.find((e=>"post"===e.state))||t[0]||null}static get styles(){return[he,n`
      ...
      .empty { padding: 16px; text-align: center; color: var(--cl-text-2); }
    `]}_renderMatch(e){const t=this.hass.states[e];if(!t)return q`<div class="match-row"><div class="no-match">Unknown: ${e}</div></div>`;const a=this._getMatch(t);if(!a)return q`<div class="match-row"><div class="no-match">No data for ${e}</div></div>`;const i="in"===a.state,s="post"===a.state,n=i||s,o=a.date||"";return q`
      <div class="match-row">
        <div class="team-block">
          ${a.home_logo?q`<img class="team-logo" src="${a.home_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
          <span class="team-name">${a.home_team||"?"}</span>
        </div>

        <div class="score-block">
          ${i?q`<div><span class="live-dot"></span><span class="status">${a.clock||"LIVE"}</span></div>`:""}
          ${n?q`<div class="score">${a.home_score??0} - ${a.away_score??0}</div>`:q`<div class="status">${o||this._t("match.vs")}</div>`}
          ${s?q`<div class="status">FT</div>`:""}
        </div>

        <div class="team-block right">
          <span class="team-name">${a.away_team||"?"}</span>
          ${a.away_logo?q`<img class="team-logo" src="${a.away_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
        </div>
      </div>
    `}render(){if(!this.hass||!this._config)return q``;const e=this._config.entities||[];return e.length?q`
      <ha-card>
        ${this._config.hide_header?"":q`<div class="title">${this._config.title||this._t("card.my_teams")}</div>`}
        ${e.map((e=>this._renderMatch(e)))}
      </ha-card>
    `:q`<ha-card><div class="empty">No entities configured</div></ha-card>`}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-multi-team",name:"Soccer Live Multi Team",description:"Shows multiple teams' matches in one card"});const Le=["dark","light","red-white","classic","neon","gold"],Pe=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-multi-team-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},_allEntities:{type:Array}}}constructor(){super(),this._allEntities=[]}static get styles(){return n`
      .card-config { display: flex; flex-direction: column; gap: 16px; }
      .option { display: flex; align-items: center; justify-content: space-between; gap: 12px; }
      label { font-size: 14px; color: var(--primary-text-color); }
      .field-label { display: block; font-size: 12px; color: var(--secondary-text-color); margin-bottom: 4px; font-weight: 600; }
    ...
    `}setConfig(e){this._config={...e,entities:[...e.entities||[]]}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this._allEntities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_next")||e.includes("all_mixed"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}_textChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_entityChanged(e,t){const a=[...this._config.entities||[]];a[t]=e.target.value,this._fire({...this._config,entities:a})}_removeEntity(e){const t=[...this._config.entities||[]];t.splice(e,1),this._fire({...this._config,entities:t})}_addEntity(){const e=[...this._config.entities||[],""];this._fire({...this._config,entities:e})}render(){if(!this._config||!this.hass)return q``;const e=this._config.entities||[];return q`
      <div class="card-config">
        <h3>Teams</h3>
          ...
          ${e.map(((e,t)=>q`
            <div class="entity-row">
              <select @change=${e=>this._entityChanged(e,t)}>
                ${e&&this._allEntities.includes(e)?"":q`<option value="${e}" selected>${e||"— select —"}</option>`}
                ${this._allEntities.map((t=>q`<option value="${t}" ?selected=${t===e}>${t}</option>`))}
              </select>
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${Le.map((e=>q`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${Pe.map((e=>q`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    ...
    `]}render(){if(!this.hass||!this._config)return q``;const e=this.hass.states[this._config.entity];if(!e)return q`<ha-card><div class="empty">Unknown entity: ${this._config.entity}</div></ha-card>`;const t=e.attributes.matches||[];if(!t.length)return q`<ha-card><div class="empty">No match data</div></ha-card>`;const a=this._groupByCompetition(t),i=a.find((e=>e.key===this._selectedComp))||a[0],s=this._config.team_name||e.attributes.team_name||"",n=e.attributes.team_logo||"",o=i.featured;return q`
      <ha-card>
        ${this._config.hide_header?"":q`
          <div class="card-header">
            ${n?q`<img class="team-logo" src="${n}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
        ...
        ${i&&o?q`
          <div class="match-display">
            ${i.logo?q`<img class="comp-logo" src="${i.logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}

            <div class="match-block">
              <div class="team-block">
                ${o.home_logo?q`<img class="team-logo" src="${o.home_logo}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-team-competitions",name:"Soccer Live Team Competitions",description:"All team competitions with tab selector"});const De=["dark","light","red-white","classic","neon","gold"],Ve=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-team-competitions-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      ...
      h3 { margin: 8px 0 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--secondary-text-color); }
      .hint { font-size: 11px; color: var(--secondary-text-color); }
    `}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("all_mixed"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_numberChanged(e){const t=parseInt(e.target.value,10);isNaN(t)||this._fire({...this._config,[e.target.dataset.configValue]:t})}_textChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}render(){if(!this._config||!this.hass)return q``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return q`
      <div class="card-config">
        <h3>Sensor</h3>
    ...
    `}}),customElements.define("soccer-live-live-commentary",class extends oe{static get properties(){return{hass:{},_config:{}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e)}getCardSize(){return 5}_t(e,t){return pe(e,de(this.hass,this._config),t)}static getConfigElement(){return document.createElement("soccer-live-live-commentary-editor")}static getStubConfig(){return{entity:"sensor.soccerlive_commentary_"}}static get styles(){return[he,n`
      ...
      .empty { padding: 20px; text-align: center; color: var(--cl-text-2); }
    `]}_getEventIcon(e){if(!e)return"📋";const t=e.toLowerCase();return t.includes("goal")?"⚽":t.includes("yellow")?"🟨":t.includes("red")?"🟥":t.includes("substitut")||t.includes("sub")?"🔄":t.includes("penaalty")||t.includes("pen")?"⚽":t.includes("own goal")?"🔴":"📋"}render(){if(!this.hass||!this._config)return q``;const e=this.hass.states[this._config.entity];if(!e)return q`<ha-card><div class="empty">Unknown entity: ${this._config.entity}</div></ha-card>`;const t=e.attributes.commentary||[],a=(e.attributes.matches||[]).find((e=>"in"===e.state)),i=a?.home_team||e.attributes.home_team||"?",s=a?.away_team||e.attributes.away_team||"?",n=a?.home_score??e.attributes.home_score??0,o=a?.away_score??e.attributes.away_score??0,r=e.attributes.match_status||"",l=(e.attributes.league_info||[{}])[0].abbreviation||"",c="in"===r||a&&"in"===a.state,d=a?a.clock:"",p=a?a.home_logo:"",h=a?a.away_logo:"";return q`
      <ha-card>
        <div class="header">
          ${l?q`<div class="comp-name">${l}</div>`:""}
          <div class="match-header">
            <div class="team-block">
              ${p?q`<img class="team-logo" src="${p}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
            ...
            <div class="score-block">
              ...
              <div class="clock">
                ${c?q`<span class="live-badge"></span>`:""}
                ${d||"—"}
              </div>
            </div>
            ...
            <div class="team-block right">
              ...
              ${h?q`<img class="team-logo" src="${h}" alt="" @error=${e=>e.target.style.display="none"}>`:""}
            </div>
          </div>
        </div>
            ...
            ${t.map((e=>q`
              <div class="event">
                ...
                <div class="event-content">
                  ...
                  ${void 0!==e.home_score&&void 0!==e.away_score?q`
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"soccer-live-live-commentary",name:"Soccer Live Commentary",description:"Live match commentary and events"});const Oe=["dark","light","red-white","classic","neon","gold"],He=["auto","en","nl","de","pt","fr","es","it"];customElements.define("soccer-live-live-commentary-editor",class extends oe{static get properties(){return{_config:{type:Object},hass:{type:Object},entities:{type:Array}}}constructor(){super(),this.entities=[]}static get styles(){return n`
      .card-config { display: flex; flex-direction: column; gap: 16px; }
      .option { display: flex; align-items: center; justify-content: space-between; gap: 12px; }
      label { font-size: 14px; color: var(--primary-text-color); }
      .field-label { display: block; font-size: 12px; color: var(--secondary-text-color); margin-bottom: 4px; font-weight: 600; }
    ...
    `}setConfig(e){this._config={...e}}updated(e){e.has("hass")&&this._fetchEntities()}_fetchEntities(){this.hass&&(this.entities=Object.keys(this.hass.states).filter((e=>e.includes("soccerlive_commentary"))).sort())}_fire(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this.requestUpdate()}_entityChanged(e){this._fire({...this._config,entity:e.target.value})}_selectChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.value})}_switchChanged(e){this._fire({...this._config,[e.target.dataset.configValue]:e.target.checked})}render(){if(!this._config||!this.hass)return q``;const e=this._config.entity||"",t=e&&this.entities.includes(e);return q`
      <div class="card-config">
        ...
        <div>
          <label class="field-label">Theme</label>
          <select data-config-value="skin" @change=${this._selectChanged}>
            ${Oe.map((e=>q`<option value="${e}" ?selected=${(this._config.skin||"dark")===e}>${e}</option>`))}
          </select>
        </div>
        <div>
          <label class="field-label">Language</label>
          <select data-config-value="language" @change=${this._selectChanged}>
            ${He.map((e=>q`<option value="${"auto"===e?"":e}" ?selected=${(this._config.language||"")===("auto"===e?"":e)}>${e}</option>`))}
          </select>
        </div>
      </div>
    `}})})();